...
${LLVMDIR}clang $1.ll -Os -c -o $1.o -fno-vectorize -fno-slp-vectorize -fno-unroll-loops  ${ARCHOPT}
#../release/bin/clang $1.bl.ll -Os -c -o $1.bl.o -fno-vectorize -fno-slp-vectorize
${LLVMDIR}clang $1.opt.ll -Os -c -o $1.opt.o -fno-vectorize -fno-slp-vectorize -fno-unroll-loops ${ARCHOPT}
