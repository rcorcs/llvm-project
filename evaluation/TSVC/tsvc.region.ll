...
@2 = private constant [8 x i64] [i64 0, i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 6]
@3 = private constant [8 x i64] [i64 0, i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 6]
@4 = private constant [8 x i64] [i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 0, i64 8]
@5 = private constant [8 x i64] [i64 0, i64 0, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7]
...
for.cond.cleanup4:                                ; preds = %rolled.exit
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %9, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %7, %rolled.loop ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %4 = load float, float* %3, align 1
  %5 = fadd float %4, 1.000000e+00
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  store float %5, float* %6, align 1
  %7 = add i8 %0, 1
  %8 = icmp ne i8 %7, 8
  br i1 %8, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %9 = add nuw nsw i64 %indvars.iv, 8
  %10 = icmp eq i64 %9, 32000
  br i1 %10, label %for.cond.cleanup4, label %for.body5, !llvm.loop !2
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 1, %for.cond2.preheader ], [ %16, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %14, %rolled.loop ]
  %1 = zext i8 %0 to i64
  %2 = mul i64 %1, 2
  %3 = add i64 %2, -1
  %4 = add nsw i64 %indvars.iv, %3
  %5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %4
  ...
  %12 = fadd float %6, %11
  %13 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %9
  store float %12, float* %13, align 1
  %14 = add i8 %0, 1
  %15 = icmp ne i8 %14, 8
  br i1 %15, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %16 = add nuw nsw i64 %indvars.iv, 16
  %17 = icmp ult i64 %indvars.iv, 31984
  br i1 %17, label %for.body5, label %for.cond.cleanup4, !llvm.loop !4
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %21, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %19, %rolled.loop ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %4 = load float, float* %3, align 1
  %5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %6 = load float, float* %5, align 1
  %7 = fmul float %4, %6
  %8 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  ...
  store float %16, float* %18, align 1
  %19 = add i8 %0, 1
  %20 = icmp ne i8 %19, 8
  br i1 %20, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %21 = add nuw nsw i64 %indvars.iv, 8
  %22 = icmp eq i64 %21, 16000
  br i1 %22, label %for.cond.cleanup4, label %for.body5, !llvm.loop !5
}

; Function Attrs: nounwind optsize uwtable
define dso_local float @s112(%struct.args_t* nocapture %func_args) #0 {
entry:
  %0 = alloca float*, i8 7, align 8
  %1 = alloca i64, i8 7, align 8
  %call = tail call i32 @initialise_arrays(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.s112, i64 0, i64 0)) #11
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  %2 = getelementptr i64, i64* %1, i8 6
  %3 = getelementptr float*, float** %0, i8 6
  br label %for.cond2.preheader
...
for.body5.7:                                      ; preds = %rolled.exit
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %26
  %4 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %26
  %5 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %add.7 = fadd float %4, %5
  store float %add.7, float* %25, align 8, !tbaa !6
  %indvars.iv.next.7 = add nsw i64 %indvars.iv, -8
  br label %for.body5, !llvm.loop !10

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %6 = phi i8 [ 0, %for.body5 ], [ %22, %rolled.loop ]
  %7 = zext i8 %6 to i64
  %8 = mul i64 %7, -1
  %9 = add i64 %8, 0
  %10 = add nsw i64 %indvars.iv, %9
  %11 = getelementptr i64, i64* %1, i8 %6
  store i64 %10, i64* %11, align 8
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %10
  %13 = getelementptr float*, float** %0, i8 %6
  store float* %12, float** %13, align 8
  %14 = load float, float* %12, align 1
  %15 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %10
  %16 = load float, float* %15, align 1
  %17 = fadd float %14, %16
  %18 = mul i64 %7, -1
  %19 = add i64 %18, 1
  %20 = add nsw i64 %indvars.iv, %19
  %21 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %20
  store float %17, float* %21, align 1
  %22 = add i8 %6, 1
  %23 = icmp ne i8 %22, 7
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %26 = add nsw i64 %indvars.iv, -7
  %27 = icmp eq i64 %24, 0
  br i1 %27, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !11
}
...
entry:
  ...
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  %1 = getelementptr i64, i64* %0, i8 7
  br label %for.cond2.preheader
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 31999, %for.cond2.preheader ], [ %15, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %2 = phi i8 [ 0, %for.body5 ], [ %12, %rolled.loop ]
  %3 = zext i8 %2 to i64
  %4 = mul i64 %3, -1
  %5 = add i64 %4, 0
  %6 = add nsw i64 %indvars.iv, %5
  %7 = getelementptr i64, i64* %0, i8 %2
  store i64 %6, i64* %7, align 8
  %8 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %6
  %9 = load float, float* %8, align 1
  %10 = fadd float %9, 1.000000e+00
  %11 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %6
  store float %10, float* %11, align 1
  %12 = add i8 %2, 1
  %13 = icmp ne i8 %12, 8
  br i1 %13, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %14 = load i64, i64* %1, align 8
  %15 = add nsw i64 %indvars.iv, -8
  %16 = icmp eq i64 %14, 0
  br i1 %16, label %for.cond.cleanup4, label %for.body5, !llvm.loop !13
}
...
for.body5.7:                                      ; preds = %rolled.exit
  %0 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !6
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %12
  %1 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %add.7 = fadd float %0, %1
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %12
  store float %add.7, float* %arrayidx7.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !14

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %2 = phi i8 [ 0, %for.body5 ], [ %10, %rolled.loop ]
  %3 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 1
  %4 = zext i8 %2 to i64
  %5 = add nuw nsw i64 %indvars.iv, %4
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %5
  %7 = load float, float* %6, align 1
  %8 = fadd float %3, %7
  %9 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %5
  store float %8, float* %9, align 1
  %10 = add i8 %2, 1
  %11 = icmp ne i8 %10, 7
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  br i1 %13, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !15
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %10, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %8, %rolled.loop ]
  %1 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 16000), align 1
  %2 = zext i8 %0 to i64
  %3 = or i64 %indvars.iv, %2
  %4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %3
  %5 = load float, float* %4, align 1
  %6 = fadd float %1, %5
  %7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %3
  store float %6, float* %7, align 1
  %8 = add i8 %0, 1
  %9 = icmp ne i8 %8, 8
  br i1 %9, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %10 = add nuw nsw i64 %indvars.iv, 8
  %11 = icmp eq i64 %10, 32000
  br i1 %11, label %for.cond.cleanup4, label %for.body5, !llvm.loop !16
}
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond51.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.cond.cleanup8:                                ; preds = %for.cond.cleanup8.loopexit, %for.cond6.preheader
  ...
  br i1 %exitcond50.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.cond2.loopexit.loopexit:                      ; preds = %rolled.exit
...
for.cond.cleanup4:                                ; preds = %for.cond2.loopexit
  ...
  br i1 %exitcond45.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body9.prol:                                   ; preds = %for.body9.prol.preheader, %for.body9.prol
  ...
  %2 = load float, float* %arrayidx11.prol, align 4, !tbaa !6
  %3 = load float, float* %arrayidx13, align 4, !tbaa !6
  %mul.prol = fmul float %2, %3
  %arrayidx15.prol = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv41.prol
  %4 = load float, float* %arrayidx15.prol, align 4, !tbaa !6
  %sub.prol = fsub float %4, %mul.prol
  store float %sub.prol, float* %arrayidx15.prol, align 4, !tbaa !6
  %indvars.iv.next42.prol = add nuw nsw i64 %indvars.iv41.prol, 1
  %prol.iter.sub = add i32 %prol.iter, -1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.sub, 0
  br i1 %prol.iter.cmp.not, label %for.body9.prol.loopexit.loopexit, label %for.body9.prol, !llvm.loop !17
...
for.body9:                                        ; preds = %for.body9.preheader, %rolled.exit
  %indvars.iv41 = phi i64 [ %20, %rolled.exit ], [ %indvars.iv41.unr, %for.body9.preheader ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %8 = phi i8 [ 0, %for.body9 ], [ %18, %rolled.loop ]
  %9 = zext i8 %8 to i64
  %10 = add nuw nsw i64 %indvars.iv41, %9
  %11 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv43, i64 %10
  %12 = load float, float* %11, align 1
  %13 = load float, float* %arrayidx13, align 1
  %14 = fmul float %12, %13
  %15 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %10
  %16 = load float, float* %15, align 1
  %17 = fsub float %16, %14
  store float %17, float* %15, align 1
  %18 = add i8 %8, 1
  %19 = icmp ne i8 %18, 8
  br i1 %19, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %20 = add nuw nsw i64 %indvars.iv41, 8
  %21 = icmp eq i64 %20, 256
  br i1 %21, label %for.cond2.loopexit.loopexit, label %for.body9, !llvm.loop !18
}
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond53.not, label %for.cond.cleanup, label %for.cond2.preheader

for.cond.cleanup8:                                ; preds = %rolled.exit
  %indvars.iv.next52 = add nuw nsw i64 %indvars.iv51, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next52, 256
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.cond6.preheader

for.body9:                                        ; preds = %rolled.exit, %for.cond6.preheader
  %indvars.iv = phi i64 [ 0, %for.cond6.preheader ], [ %13, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %0 = phi i8 [ 0, %for.body9 ], [ %11, %rolled.loop ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv51, i64 %2
  %4 = load float, float* %3, align 1
  %5 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %2, i64 %indvars.iv51
  %6 = load float, float* %5, align 1
  %7 = fmul float %4, %6
  %8 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv51, i64 %2
  %9 = load float, float* %8, align 1
  %10 = fadd float %7, %9
  store float %10, float* %3, align 1
  %11 = add i8 %0, 1
  %12 = icmp ne i8 %11, 8
  br i1 %12, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %13 = add nuw nsw i64 %indvars.iv, 8
  %14 = icmp eq i64 %13, 256
  br i1 %14, label %for.cond.cleanup8, label %for.body9, !llvm.loop !19
}
...
for.cond2.preheader:                              ; preds = %for.cond.cleanup4, %entry
  ...
  %.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !6
  br label %for.body5
...
for.body5:                                        ; preds = %for.body5, %for.cond2.preheader
  ...
  %mul = fmul float %2, %0
  store float %mul, float* %arrayidx7, align 4, !tbaa !6
  %3 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx12 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %3
  %4 = load float, float* %arrayidx12, align 4, !tbaa !6
  %mul16 = fmul float %2, %4
  store float %mul16, float* %arrayidx, align 4, !tbaa !6
  ...
  store float %mul26, float* %arrayidx12, align 4, !tbaa !6
  %7 = add nuw nsw i64 %indvars.iv, 4
  %arrayidx32 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %7
  %8 = load float, float* %arrayidx32, align 4, !tbaa !6
  %mul36 = fmul float %6, %8
  store float %mul36, float* %arrayidx22, align 4, !tbaa !6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 5
  %arrayidx42 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  %9 = load float, float* %arrayidx42, align 4, !tbaa !6
  %mul46 = fmul float %8, %9
  store float %mul46, float* %arrayidx32, align 4, !tbaa !6
  %cmp3 = icmp ult i64 %indvars.iv, 31990
  br i1 %cmp3, label %for.body5, label %for.cond.cleanup4, !llvm.loop !20
}
...
for.cond6.preheader:                              ; preds = %for.cond.cleanup8, %for.cond2.preheader
  ...
  %.pre = load float, float* %arrayidx17, align 4, !tbaa !6
  br label %for.body9
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond47.not, label %for.cond.cleanup, label %for.cond2.preheader

for.cond.cleanup8:                                ; preds = %for.body9
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %exitcond46.not = icmp eq i64 %indvars.iv.next45, 256
  br i1 %exitcond46.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.body9:                                        ; preds = %for.body9, %for.cond6.preheader
  ...
  %1 = load float, float* %arrayidx11, align 4, !tbaa !6
  ...
  %4 = load float, float* %arrayidx15, align 4, !tbaa !6
  %mul = fmul float %1, %4
  %add = fadd float %0, %mul
  store float %add, float* %arrayidx17, align 4, !tbaa !6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond50.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body9.7:                                      ; preds = %rolled.exit
  %arrayidx12.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %2, i64 %19
  %3 = load float, float* %arrayidx12.7, align 4, !tbaa !6
  %arrayidx16.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv47, i64 %20
  %4 = load float, float* %arrayidx16.7, align 4, !tbaa !6
  %add.7 = fadd float %3, %4
  %arrayidx20.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv47, i64 %20
  store float %add.7, float* %arrayidx20.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body9, !llvm.loop !21

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %5 = phi i8 [ 0, %for.body9 ], [ %17, %rolled.loop ]
  %6 = zext i8 %5 to i64
  %7 = add i64 %6, -1
  %8 = add nsw i64 %indvars.iv, %7
  %9 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %2, i64 %8
  %10 = load float, float* %9, align 1
  %11 = add nuw nsw i64 %indvars.iv, %6
  %12 = getelementptr i64, i64* %0, i8 %5
  store i64 %11, i64* %12, align 8
  %13 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv47, i64 %11
  %14 = load float, float* %13, align 1
  %15 = fadd float %10, %14
  %16 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv47, i64 %11
  store float %15, float* %16, align 1
  %17 = add i8 %5, 1
  %18 = icmp ne i8 %17, 7
  br i1 %18, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %19 = load i64, i64* %1, align 8
  %20 = add nuw nsw i64 %indvars.iv, 7
  %21 = icmp eq i64 %20, 256
  br i1 %21, label %for.cond.cleanup8, label %for.body9.7, !llvm.loop !22
}
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond48.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body9:                                        ; preds = %rolled.exit, %for.cond6.preheader
  %indvars.iv = phi i64 [ 0, %for.cond6.preheader ], [ %12, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %1 = phi i8 [ 0, %for.body9 ], [ %10, %rolled.loop ]
  %2 = zext i8 %1 to i64
  %3 = or i64 %indvars.iv, %2
  %4 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %0, i64 %3
  %5 = load float, float* %4, align 1
  %6 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv45, i64 %3
  %7 = load float, float* %6, align 1
  %8 = fadd float %5, %7
  %9 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv45, i64 %3
  store float %8, float* %9, align 1
  %10 = add i8 %1, 1
  %11 = icmp ne i8 %10, 8
  br i1 %11, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %12 = add nuw nsw i64 %indvars.iv, 8
  %13 = icmp eq i64 %12, 256
  br i1 %13, label %for.cond.cleanup8, label %for.body9, !llvm.loop !23
}
...
for.body5.7:                                      ; preds = %rolled.exit
  ...
  %4 = load float, float* %arrayidx.7, align 32, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %21
  %5 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %add8.7 = fadd float %4, %5
  store float %add8.7, float* %22, align 4, !tbaa !6
  br label %for.body5, !llvm.loop !24

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %6 = phi i8 [ 0, %for.body5 ], [ %19, %rolled.loop ]
  %7 = zext i8 %6 to i64
  %8 = add i64 %7, 1
  %9 = or i64 %indvars.iv, %8
  %10 = getelementptr i64, i64* %1, i8 %6
  store i64 %9, i64* %10, align 8
  %11 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %9
  %12 = getelementptr float*, float** %0, i8 %6
  store float* %11, float** %12, align 8
  %13 = load float, float* %11, align 1
  %14 = or i64 %indvars.iv, %7
  %15 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %14
  %16 = load float, float* %15, align 1
  %17 = fadd float %13, %16
  %18 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %14
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %23 = icmp eq i64 %21, 31999
  br i1 %23, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !25
}
...
entry:
  ...
  %2 = bitcast i8** %arg_info to %struct.anon**
  %3 = load %struct.anon*, %struct.anon** %2, align 8, !tbaa !26
  %a = getelementptr inbounds %struct.anon, %struct.anon* %3, i64 0, i32 0
  %4 = load i32, i32* %a, align 4, !tbaa !31
  %b = getelementptr inbounds %struct.anon, %struct.anon* %3, i64 0, i32 1
  %5 = load i32, i32* %b, align 4, !tbaa !34
  %call = tail call i32 @initialise_arrays(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.s122, i64 0, i64 0)) #11
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  %cmp330 = icmp slt i32 %4, 32001
  %6 = add i32 %4, -1
  %7 = sext i32 %6 to i64
  %8 = sext i32 %5 to i64
  %9 = add i32 %4, %5
  %10 = add i32 %9, -1
  %11 = icmp sgt i32 %10, 32000
  %smax = select i1 %11, i32 %10, i32 32000
  %12 = sub i32 %smax, %4
  br label %for.body
...
for.body5.preheader:                              ; preds = %for.body
  %13 = udiv i32 %12, %5
  %14 = add i32 %13, 1
  %xtraiter = and i32 %14, 7
  %15 = icmp ult i32 %13, 7
  br i1 %15, label %for.cond.cleanup4.loopexit.unr-lcssa, label %for.body5.preheader.new

for.body5.preheader.new:                          ; preds = %for.body5.preheader
  %unroll_iter = and i32 %14, -8
  br label %for.body5
...
for.cond.cleanup4.loopexit.unr-lcssa:             ; preds = %for.cond.cleanup4.loopexit.unr-lcssa.loopexit, %for.body5.preheader
  ...
  %indvars.iv.unr = phi i64 [ %7, %for.body5.preheader ], [ %indvars.iv.next.7.lcssa, %for.cond.cleanup4.loopexit.unr-lcssa.loopexit ]
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
...
for.body5.epil:                                   ; preds = %for.body5.epil.preheader, %for.body5.epil
  ...
  %16 = sub nsw i64 31999, %indvars.iv34.epil
  %arrayidx.epil = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %16
  %17 = load float, float* %arrayidx.epil, align 4, !tbaa !6
  ...
  %add9.epil = fadd float %17, %18
  store float %add9.epil, float* %arrayidx8.epil, align 4, !tbaa !6
  %indvars.iv.next.epil = add i64 %indvars.iv.epil, %8
  %epil.iter.sub = add i32 %epil.iter, -1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.sub, 0
  br i1 %epil.iter.cmp.not, label %for.cond.cleanup4.loopexit, label %for.body5.epil, !llvm.loop !35
...
for.body5:                                        ; preds = %for.body5, %for.body5.preheader.new
  ...
  %19 = sub nsw i64 31999, %indvars.iv34
  %arrayidx = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %19
  %20 = load float, float* %arrayidx, align 4, !tbaa !6
  ...
  %22 = sub nsw i64 31998, %indvars.iv34
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %22
  %23 = load float, float* %arrayidx.1, align 8, !tbaa !6
  %arrayidx8.1 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  %24 = load float, float* %arrayidx8.1, align 4, !tbaa !6
  %add9.1 = fadd float %23, %24
  store float %add9.1, float* %arrayidx8.1, align 4, !tbaa !6
  %indvars.iv.next.1 = add i64 %indvars.iv.next, %8
  %25 = sub nsw i64 31997, %indvars.iv34
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %25
  %26 = load float, float* %arrayidx.2, align 4, !tbaa !6
  %arrayidx8.2 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.1
  %27 = load float, float* %arrayidx8.2, align 4, !tbaa !6
  %add9.2 = fadd float %26, %27
  store float %add9.2, float* %arrayidx8.2, align 4, !tbaa !6
  %indvars.iv.next.2 = add i64 %indvars.iv.next.1, %8
  %28 = sub nsw i64 31996, %indvars.iv34
  %arrayidx.3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %28
  %29 = load float, float* %arrayidx.3, align 16, !tbaa !6
  %arrayidx8.3 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.2
  %30 = load float, float* %arrayidx8.3, align 4, !tbaa !6
  %add9.3 = fadd float %29, %30
  store float %add9.3, float* %arrayidx8.3, align 4, !tbaa !6
  %indvars.iv.next.3 = add i64 %indvars.iv.next.2, %8
  %31 = sub nsw i64 31995, %indvars.iv34
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %31
  %32 = load float, float* %arrayidx.4, align 4, !tbaa !6
  %arrayidx8.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.3
  %33 = load float, float* %arrayidx8.4, align 4, !tbaa !6
  %add9.4 = fadd float %32, %33
  store float %add9.4, float* %arrayidx8.4, align 4, !tbaa !6
  %indvars.iv.next.4 = add i64 %indvars.iv.next.3, %8
  %34 = sub nsw i64 31994, %indvars.iv34
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %34
  %35 = load float, float* %arrayidx.5, align 8, !tbaa !6
  %arrayidx8.5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.4
  %36 = load float, float* %arrayidx8.5, align 4, !tbaa !6
  %add9.5 = fadd float %35, %36
  store float %add9.5, float* %arrayidx8.5, align 4, !tbaa !6
  %indvars.iv.next.5 = add i64 %indvars.iv.next.4, %8
  %indvars.iv.next35.6 = or i64 %indvars.iv34, 7
  %37 = sub nsw i64 31993, %indvars.iv34
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %37
  %38 = load float, float* %arrayidx.6, align 4, !tbaa !6
  %arrayidx8.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.5
  %39 = load float, float* %arrayidx8.6, align 4, !tbaa !6
  %add9.6 = fadd float %38, %39
  store float %add9.6, float* %arrayidx8.6, align 4, !tbaa !6
  %indvars.iv.next.6 = add i64 %indvars.iv.next.5, %8
  %indvars.iv.next35.7 = add nuw nsw i64 %indvars.iv34, 8
  %40 = sub nsw i64 31999, %indvars.iv.next35.6
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %40
  %41 = load float, float* %arrayidx.7, align 32, !tbaa !6
  %arrayidx8.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6
  %42 = load float, float* %arrayidx8.7, align 4, !tbaa !6
  %add9.7 = fadd float %41, %42
  store float %add9.7, float* %arrayidx8.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add i64 %indvars.iv.next.6, %8
  %niter.nsub.7 = add i32 %niter, -8
  %niter.ncmp.7.not = icmp eq i32 %niter.nsub.7, 0
  br i1 %niter.ncmp.7.not, label %for.cond.cleanup4.loopexit.unr-lcssa.loopexit, label %for.body5, !llvm.loop !36
}
...
if.then:                                          ; preds = %for.body5
  ...
  store float %add23, float* %arrayidx25, align 4, !tbaa !6
  br label %for.inc
...
for.inc:                                          ; preds = %if.then, %for.body5
  ...
  store float %add.1, float* %arrayidx11.1, align 4, !tbaa !6
  %arrayidx13.1 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next
  %7 = load float, float* %arrayidx13.1, align 4, !tbaa !6
...
if.then.1:                                        ; preds = %for.inc
  ...
  store float %add23.1, float* %arrayidx25.1, align 4, !tbaa !6
  br label %for.inc.1
...
for.inc.1:                                        ; preds = %if.then.1, %for.inc
  ...
  store float %add.2, float* %arrayidx11.2, align 4, !tbaa !6
  %arrayidx13.2 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.1
  %11 = load float, float* %arrayidx13.2, align 8, !tbaa !6
...
if.then.2:                                        ; preds = %for.inc.1
  ...
  store float %add23.2, float* %arrayidx25.2, align 4, !tbaa !6
  br label %for.inc.2
...
for.inc.2:                                        ; preds = %if.then.2, %for.inc.1
  ...
  store float %add.3, float* %arrayidx11.3, align 4, !tbaa !6
  %arrayidx13.3 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.2
  %15 = load float, float* %arrayidx13.3, align 4, !tbaa !6
...
if.then.3:                                        ; preds = %for.inc.2
  ...
  store float %add23.3, float* %arrayidx25.3, align 4, !tbaa !6
  br label %for.inc.3
...
for.inc.3:                                        ; preds = %if.then.3, %for.inc.2
  ...
  store float %add.4, float* %arrayidx11.4, align 4, !tbaa !6
  %arrayidx13.4 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.3
  %19 = load float, float* %arrayidx13.4, align 16, !tbaa !6
...
if.then.4:                                        ; preds = %for.inc.3
  ...
  store float %add23.4, float* %arrayidx25.4, align 4, !tbaa !6
  br label %for.inc.4
...
for.inc.4:                                        ; preds = %if.then.4, %for.inc.3
  ...
  store float %add.5, float* %arrayidx11.5, align 4, !tbaa !6
  %arrayidx13.5 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.4
  %23 = load float, float* %arrayidx13.5, align 4, !tbaa !6
...
if.then.5:                                        ; preds = %for.inc.4
  ...
  store float %add23.5, float* %arrayidx25.5, align 4, !tbaa !6
  br label %for.inc.5
...
for.inc.5:                                        ; preds = %if.then.5, %for.inc.4
  ...
  store float %add.6, float* %arrayidx11.6, align 4, !tbaa !6
  %arrayidx13.6 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.5
  %27 = load float, float* %arrayidx13.6, align 8, !tbaa !6
...
if.then.6:                                        ; preds = %for.inc.5
  ...
  store float %add23.6, float* %arrayidx25.6, align 4, !tbaa !6
  br label %for.inc.6
...
for.inc.6:                                        ; preds = %if.then.6, %for.inc.5
  ...
  store float %add.7, float* %arrayidx11.7, align 4, !tbaa !6
  %arrayidx13.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.6
  %31 = load float, float* %arrayidx13.7, align 4, !tbaa !6
...
if.then.7:                                        ; preds = %for.inc.6
  ...
  store float %add23.7, float* %arrayidx25.7, align 4, !tbaa !6
  br label %for.inc.7
...
for.inc.7:                                        ; preds = %if.then.7, %for.inc.6
  ...
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !37
}
...
if.else:                                          ; preds = %for.body5
  ...
  %1 = load float, float* %arrayidx17, align 32, !tbaa !6
  br label %for.inc
...
for.inc:                                          ; preds = %if.else, %for.body5
  ...
  %2 = load float, float* %arrayidx10, align 32, !tbaa !6
  %arrayidx12 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv
  %3 = load float, float* %arrayidx12, align 32, !tbaa !6
  %mul = fmul float %2, %3
  ...
  store float %add, float* %arrayidx14, align 4, !tbaa !6
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next
  %4 = load float, float* %arrayidx.1, align 4, !tbaa !6
...
if.else.1:                                        ; preds = %for.inc
  ...
  %5 = load float, float* %arrayidx17.1, align 4, !tbaa !6
  br label %for.inc.1
...
for.inc.1:                                        ; preds = %if.else.1, %for.inc
  ...
  %6 = load float, float* %arrayidx10.1, align 4, !tbaa !6
  %arrayidx12.1 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next
  %7 = load float, float* %arrayidx12.1, align 4, !tbaa !6
  ...
  store float %add.1, float* %arrayidx14.1, align 4, !tbaa !6
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.1
  %8 = load float, float* %arrayidx.2, align 8, !tbaa !6
...
if.else.2:                                        ; preds = %for.inc.1
  ...
  %9 = load float, float* %arrayidx17.2, align 8, !tbaa !6
  br label %for.inc.2
...
for.inc.2:                                        ; preds = %if.else.2, %for.inc.1
  ...
  %10 = load float, float* %arrayidx10.2, align 8, !tbaa !6
  %arrayidx12.2 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.1
  %11 = load float, float* %arrayidx12.2, align 8, !tbaa !6
  ...
  store float %add.2, float* %arrayidx14.2, align 4, !tbaa !6
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  %arrayidx.3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.2
  %12 = load float, float* %arrayidx.3, align 4, !tbaa !6
...
if.else.3:                                        ; preds = %for.inc.2
  ...
  %13 = load float, float* %arrayidx17.3, align 4, !tbaa !6
  br label %for.inc.3
...
for.inc.3:                                        ; preds = %if.else.3, %for.inc.2
  ...
  %14 = load float, float* %arrayidx10.3, align 4, !tbaa !6
  %arrayidx12.3 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.2
  %15 = load float, float* %arrayidx12.3, align 4, !tbaa !6
  ...
  store float %add.3, float* %arrayidx14.3, align 4, !tbaa !6
  %indvars.iv.next.3 = or i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.3
  %16 = load float, float* %arrayidx.4, align 16, !tbaa !6
...
if.else.4:                                        ; preds = %for.inc.3
  ...
  %17 = load float, float* %arrayidx17.4, align 16, !tbaa !6
  br label %for.inc.4
...
for.inc.4:                                        ; preds = %if.else.4, %for.inc.3
  ...
  %18 = load float, float* %arrayidx10.4, align 16, !tbaa !6
  %arrayidx12.4 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.3
  %19 = load float, float* %arrayidx12.4, align 16, !tbaa !6
  ...
  store float %add.4, float* %arrayidx14.4, align 4, !tbaa !6
  %indvars.iv.next.4 = or i64 %indvars.iv, 5
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.4
  %20 = load float, float* %arrayidx.5, align 4, !tbaa !6
...
if.else.5:                                        ; preds = %for.inc.4
  ...
  %21 = load float, float* %arrayidx17.5, align 4, !tbaa !6
  br label %for.inc.5
...
for.inc.5:                                        ; preds = %if.else.5, %for.inc.4
  ...
  %22 = load float, float* %arrayidx10.5, align 4, !tbaa !6
  %arrayidx12.5 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.4
  %23 = load float, float* %arrayidx12.5, align 4, !tbaa !6
  ...
  store float %add.5, float* %arrayidx14.5, align 4, !tbaa !6
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.5
  %24 = load float, float* %arrayidx.6, align 8, !tbaa !6
...
if.else.6:                                        ; preds = %for.inc.5
  ...
  %25 = load float, float* %arrayidx17.6, align 8, !tbaa !6
  br label %for.inc.6
...
for.inc.6:                                        ; preds = %if.else.6, %for.inc.5
  ...
  %26 = load float, float* %arrayidx10.6, align 8, !tbaa !6
  %arrayidx12.6 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.5
  %27 = load float, float* %arrayidx12.6, align 8, !tbaa !6
  ...
  store float %add.6, float* %arrayidx14.6, align 4, !tbaa !6
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  %28 = load float, float* %arrayidx.7, align 4, !tbaa !6
...
if.else.7:                                        ; preds = %for.inc.6
  ...
  %29 = load float, float* %arrayidx17.7, align 4, !tbaa !6
  br label %for.inc.7
...
for.inc.7:                                        ; preds = %if.else.7, %for.inc.6
  ...
  %30 = load float, float* %arrayidx10.7, align 4, !tbaa !6
  %arrayidx12.7 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.6
  %31 = load float, float* %arrayidx12.7, align 4, !tbaa !6
  ...
  store float %add.7, float* %arrayidx14.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !38
}
...
for.cond6.preheader:                              ; preds = %for.cond.cleanup8, %for.cond2.preheader
  ...
  %k.049 = phi i64 [ -1, %for.cond2.preheader ], [ %.lcssa, %for.cond.cleanup8 ]
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond56.not, label %for.cond.cleanup, label %for.cond2.preheader

for.cond.cleanup8:                                ; preds = %rolled.exit
  %.lcssa = phi i64 [ %20, %rolled.exit ]
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next55, 256
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.cond6.preheader

for.body9:                                        ; preds = %rolled.exit, %for.cond6.preheader
  %indvars.iv52 = phi i64 [ %2, %for.cond6.preheader ], [ %20, %rolled.exit ]
  %indvars.iv = phi i64 [ 0, %for.cond6.preheader ], [ %21, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %3 = phi i8 [ 0, %for.body9 ], [ %18, %rolled.loop ]
  %4 = zext i8 %3 to i64
  %5 = add i64 %4, 1
  %6 = add nsw i64 %indvars.iv52, %5
  %7 = getelementptr i64, i64* %0, i8 %3
  store i64 %6, i64* %7, align 8
  %8 = or i64 %indvars.iv, %4
  %9 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv54, i64 %8
  %10 = load float, float* %9, align 1
  %11 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv54, i64 %8
  %12 = load float, float* %11, align 1
  %13 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %indvars.iv54, i64 %8
  %14 = load float, float* %13, align 1
  %15 = fmul float %12, %14
  %16 = fadd float %10, %15
  %17 = getelementptr inbounds [65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 %6
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond61.not, label %for.cond.cleanup, label %for.cond2.preheader

for.cond.cleanup8:                                ; preds = %rolled.exit
  %.lcssa = phi i64 [ %25, %rolled.exit ]
  %4 = trunc i64 %.lcssa to i32
  %inc24 = add nsw i32 %4, 2
  %indvars.iv.next60 = add nuw nsw i64 %indvars.iv59, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next60, 256
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.cond6.preheader

for.body9:                                        ; preds = %for.body9.7, %for.cond6.preheader
  %5 = phi float [ %.pre, %for.cond6.preheader ], [ %add.7, %for.body9.7 ]
  %indvars.iv56 = phi i64 [ %2, %for.cond6.preheader ], [ %indvars.iv.next57.7, %for.body9.7 ]
  %indvars.iv = phi i64 [ 1, %for.cond6.preheader ], [ %indvars.iv.next.7, %for.body9.7 ]
  br label %rolled.loop

for.body9.7:                                      ; preds = %rolled.exit
  %arrayidx14.7 = getelementptr inbounds [65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 %25
  %6 = load float, float* %arrayidx14.7, align 4, !tbaa !6
  %arrayidx18.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %26, i64 %indvars.iv59
  %7 = load float, float* %arrayidx18.7, align 4, !tbaa !6
  %mul.7 = fmul float %6, %7
  %add.7 = fadd float %24, %mul.7
  %arrayidx22.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %26, i64 %indvars.iv59
  store float %add.7, float* %arrayidx22.7, align 4, !tbaa !6
  %indvars.iv.next57.7 = add nsw i64 %indvars.iv56, 8
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body9, !llvm.loop !40

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %8 = phi i8 [ 0, %for.body9 ], [ %22, %rolled.loop ]
  %9 = phi float [ %5, %for.body9 ], [ %19, %rolled.loop ]
  %10 = zext i8 %8 to i64
  %11 = add i64 %10, -1
  %12 = add nsw i64 %indvars.iv56, %11
  %13 = getelementptr inbounds [65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 %12
  %14 = load float, float* %13, align 1
  %15 = add nuw nsw i64 %indvars.iv, %10
  %16 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %15, i64 %indvars.iv59
  %17 = load float, float* %16, align 1
  %18 = fmul float %14, %17
  %19 = fadd float %9, %18
  %20 = getelementptr float, float* %0, i8 %8
  store float %19, float* %20, align 4
  %21 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %15, i64 %indvars.iv59
  store float %19, float* %21, align 1
  %22 = add i8 %8, 1
  %23 = icmp ne i8 %22, 7
  br i1 %23, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %25 = add nsw i64 %indvars.iv56, 6
  %26 = add nuw nsw i64 %indvars.iv, 7
  %27 = trunc i64 %indvars.iv56 to i32
  %28 = icmp eq i32 %3, %27
  br i1 %28, label %for.cond.cleanup8, label %for.body9.7, !llvm.loop !41
}
...
for.body5:                                        ; preds = %for.body5, %for.cond2.preheader
  ...
  %4 = load float, float* %arrayidx18, align 32, !tbaa !6
  ...
  store float %add20, float* %arrayidx22, align 4, !tbaa !6
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  %7 = load float, float* %arrayidx7.1, align 4, !tbaa !6
  %arrayidx9.1 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next
  %8 = load float, float* %arrayidx9.1, align 4, !tbaa !6
  ...
  %9 = load float, float* %arrayidx18.1, align 4, !tbaa !6
  ...
  %14 = load float, float* %arrayidx18.2, align 8, !tbaa !6
  ...
  %19 = load float, float* %arrayidx18.3, align 4, !tbaa !6
  ...
  %24 = load float, float* %arrayidx18.4, align 16, !tbaa !6
  ...
  %29 = load float, float* %arrayidx18.5, align 4, !tbaa !6
  ...
  %34 = load float, float* %arrayidx18.6, align 8, !tbaa !6
  ...
  %39 = load float, float* %arrayidx18.7, align 4, !tbaa !6
  ...
  store float %add20.7, float* %arrayidx22.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 16000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !42
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv40 = phi i64 [ -1, %for.cond2.preheader ], [ %17, %rolled.exit ]
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %18, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %15, %rolled.loop ]
  %1 = zext i8 %0 to i64
  %2 = mul i64 %1, 2
  %3 = add i64 %2, 1
  %4 = add nsw i64 %indvars.iv40, %3
  %5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %4
  %6 = load float, float* %5, align 1
  %7 = or i64 %indvars.iv, %1
  %8 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %7
  %9 = load float, float* %8, align 1
  %10 = fsub float %6, %9
  %11 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %7
  store float %10, float* %11, align 1
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %4
  %13 = load float, float* %12, align 1
  %14 = fadd float %10, %13
  store float %14, float* %5, align 1
  %15 = add i8 %0, 1
  %16 = icmp ne i8 %15, 8
  br i1 %16, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %17 = add nsw i64 %indvars.iv40, 16
  %18 = add nuw nsw i64 %indvars.iv, 8
  %19 = icmp eq i64 %18, 16000
  br i1 %19, label %for.cond.cleanup4, label %for.body5, !llvm.loop !43
}
...
for.body5.7:                                      ; preds = %rolled.exit
  ...
  %add8.7 = fadd float %4, %5
  store float %add8.7, float* %22, align 4, !tbaa !6
  br label %for.body5, !llvm.loop !44
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %22 = load float*, float** %3, align 8
  %23 = icmp eq i64 %21, 31999
  br i1 %23, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !45
}
...
for.cond2.preheader:                              ; preds = %for.cond.cleanup4, %entry
  ...
  %2 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 1), align 4, !tbaa !6
  br label %for.body5
...
for.body5.7:                                      ; preds = %rolled.exit
  %arrayidx7.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 1, i64 %20
  %3 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %arrayidx9.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %21
  %4 = load float, float* %arrayidx9.7, align 4, !tbaa !6
  %mul.7 = fmul float %4, %2
  %add10.7 = fadd float %3, %mul.7
  %arrayidx14.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0, i64 %21
  store float %add10.7, float* %arrayidx14.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !46

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %5 = phi i8 [ 0, %for.body5 ], [ %18, %rolled.loop ]
  %6 = zext i8 %5 to i64
  %7 = add i64 %6, -1
  %8 = add nsw i64 %indvars.iv, %7
  %9 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 1, i64 %8
  %10 = load float, float* %9, align 1
  %11 = add nuw nsw i64 %indvars.iv, %6
  %12 = getelementptr i64, i64* %0, i8 %5
  store i64 %11, i64* %12, align 8
  %13 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %11
  %14 = load float, float* %13, align 1
  %15 = fmul float %14, %2
  %16 = fadd float %10, %15
  %17 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0, i64 %11
  store float %16, float* %17, align 1
  %18 = add i8 %5, 1
  %19 = icmp ne i8 %18, 7
  br i1 %19, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %22 = icmp eq i64 %21, 256
  br i1 %22, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !47
}
...
for.cond2.loopexit:                               ; preds = %for.cond2.loopexit.loopexit, %for.body13.prol.loopexit
  ...
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body13.lr.ph

for.cond.cleanup4:                                ; preds = %for.cond2.loopexit
  %call24 = tail call i32 @dummy(float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @d, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @e, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 0), float 0.000000e+00) #11
  %inc26 = add nuw nsw i32 %nl.050, 1
  %exitcond54.not = icmp eq i32 %inc26, 78000
  br i1 %exitcond54.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body13.prol:                                  ; preds = %for.body13.prol.preheader, %for.body13.prol
  ...
  %6 = load float, float* %arrayidx15.prol, align 4, !tbaa !6
  ...
  %7 = load float, float* %arrayidx17.prol, align 4, !tbaa !6
  %add18.prol = fadd float %6, %7
  store float %add18.prol, float* %arrayidx17.prol, align 4, !tbaa !6
  ...
  %prol.iter.sub = add i32 %prol.iter, -1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.sub, 0
  br i1 %prol.iter.cmp.not, label %for.body13.prol.loopexit.loopexit, label %for.body13.prol, !llvm.loop !48
...
for.body13:                                       ; preds = %for.body13.preheader, %for.body13
  ...
  %10 = load float, float* %arrayidx15, align 4, !tbaa !6
  ...
  %11 = load float, float* %arrayidx17, align 4, !tbaa !6
  ...
  %13 = load float, float* %arrayidx15.1, align 4, !tbaa !6
  ...
  %14 = load float, float* %arrayidx17.1, align 4, !tbaa !6
  %add18.1 = fadd float %13, %14
  store float %add18.1, float* %arrayidx17.1, align 4, !tbaa !6
  ...
  %16 = load float, float* %arrayidx15.2, align 4, !tbaa !6
  ...
  %17 = load float, float* %arrayidx17.2, align 4, !tbaa !6
  %add18.2 = fadd float %16, %17
  store float %add18.2, float* %arrayidx17.2, align 4, !tbaa !6
  ...
  %19 = load float, float* %arrayidx15.3, align 4, !tbaa !6
  ...
  %20 = load float, float* %arrayidx17.3, align 4, !tbaa !6
  %add18.3 = fadd float %19, %20
  store float %add18.3, float* %arrayidx17.3, align 4, !tbaa !6
  ...
  %22 = load float, float* %arrayidx15.4, align 4, !tbaa !6
  ...
  %23 = load float, float* %arrayidx17.4, align 4, !tbaa !6
  %add18.4 = fadd float %22, %23
  store float %add18.4, float* %arrayidx17.4, align 4, !tbaa !6
  ...
  %25 = load float, float* %arrayidx15.5, align 4, !tbaa !6
  ...
  %26 = load float, float* %arrayidx17.5, align 4, !tbaa !6
  %add18.5 = fadd float %25, %26
  store float %add18.5, float* %arrayidx17.5, align 4, !tbaa !6
  ...
  %28 = load float, float* %arrayidx15.6, align 4, !tbaa !6
  ...
  %29 = load float, float* %arrayidx17.6, align 4, !tbaa !6
  %add18.6 = fadd float %28, %29
  store float %add18.6, float* %arrayidx17.6, align 4, !tbaa !6
  ...
  %31 = load float, float* %arrayidx15.7, align 4, !tbaa !6
  ...
  %32 = load float, float* %arrayidx17.7, align 4, !tbaa !6
  %add18.7 = fadd float %31, %32
  store float %add18.7, float* %arrayidx17.7, align 4, !tbaa !6
  ...
  br i1 %exitcond.7.not, label %for.cond2.loopexit.loopexit, label %for.body13, !llvm.loop !49
}
...
for.cond.cleanup:                                 ; preds = %rolled.exit
  ret void
...
for.body.7:                                       ; preds = %rolled.exit
  %1 = add nsw i64 %16, %0
  %arrayidx.7 = getelementptr inbounds float, float* %a, i64 %1
  %2 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx2.7 = getelementptr inbounds float, float* %b, i64 %16
  %3 = load float, float* %arrayidx2.7, align 4, !tbaa !6
  %add3.7 = fadd float %2, %3
  %arrayidx5.7 = getelementptr inbounds float, float* %a, i64 %16
  store float %add3.7, float* %arrayidx5.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body, !llvm.loop !50

rolled.loop:                                      ; preds = %for.body, %rolled.loop
  %4 = phi i8 [ 0, %for.body ], [ %14, %rolled.loop ]
  %5 = zext i8 %4 to i64
  %6 = or i64 %indvars.iv, %5
  %7 = add nsw i64 %6, %0
  %8 = getelementptr inbounds float, float* %a, i64 %7
  %9 = load float, float* %8, align 1
  %10 = getelementptr inbounds float, float* %b, i64 %6
  %11 = load float, float* %10, align 1
  %12 = fadd float %9, %11
  %13 = getelementptr inbounds float, float* %a, i64 %6
  store float %12, float* %13, align 1
  %14 = add i8 %4, 1
  %15 = icmp ne i8 %14, 7
  br i1 %15, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %16 = or i64 %indvars.iv, 7
  %17 = icmp eq i64 %16, 31999
  br i1 %17, label %for.cond.cleanup, label %for.body.7, !llvm.loop !51
}
...
entry:
  ...
  store float %add, float* %arrayidx4, align 4, !tbaa !6
  ret void
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %17, %rolled.exit ]
  br label %rolled.loop
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  ...
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %4 = load float, float* %3, align 1
  %5 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %2
  %6 = load float, float* %5, align 1
  %7 = fmul float %4, %6
  %8 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  store float %7, float* %8, align 1
  %9 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %10 = load float, float* %9, align 1
  %11 = fmul float %7, %10
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  %13 = load float, float* %12, align 1
  %14 = fadd float %13, %11
...
rolled.exit:                                      ; preds = %rolled.loop
  %17 = add nuw nsw i64 %indvars.iv, 8
  %18 = icmp eq i64 %17, 32000
  br i1 %18, label %for.cond.cleanup4, label %for.body5, !llvm.loop !52
}
...
if.end:                                           ; preds = %for.body5
  ...
  %1 = load float, float* %arrayidx8, align 4, !tbaa !6
  %arrayidx10 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv
  %2 = load float, float* %arrayidx10, align 4, !tbaa !6
  %arrayidx12 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv
  %3 = load float, float* %arrayidx12, align 4, !tbaa !6
  %mul = fmul float %2, %3
  %add = fadd float %1, %mul
...
L20:                                              ; preds = %for.body5
  ...
  %4 = load float, float* %arrayidx16, align 4, !tbaa !6
  %arrayidx18 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv
  %5 = load float, float* %arrayidx18, align 4, !tbaa !6
  ...
  store float %add22, float* %arrayidx25, align 4, !tbaa !6
  br label %for.inc
...
for.inc:                                          ; preds = %L20, %if.end
  ...
  %7 = load float, float* %arrayidx.1, align 4, !tbaa !6
...
L20.1:                                            ; preds = %for.inc
  ...
  store float %add22.1, float* %arrayidx25.1, align 4, !tbaa !6
  br label %for.inc.1
...
for.inc.1:                                        ; preds = %L20.1, %if.end.1
  ...
  %14 = load float, float* %arrayidx.2, align 4, !tbaa !6
...
L20.2:                                            ; preds = %for.inc.1
  ...
  store float %add22.2, float* %arrayidx25.2, align 4, !tbaa !6
  br label %for.inc.2
...
for.inc.2:                                        ; preds = %L20.2, %if.end.2
  ...
  %21 = load float, float* %arrayidx.3, align 4, !tbaa !6
...
L20.3:                                            ; preds = %for.inc.2
  ...
  store float %add22.3, float* %arrayidx25.3, align 4, !tbaa !6
  br label %for.inc.3
...
for.inc.3:                                        ; preds = %L20.3, %if.end.3
  ...
  %28 = load float, float* %arrayidx.4, align 4, !tbaa !6
...
L20.4:                                            ; preds = %for.inc.3
  ...
  store float %add22.4, float* %arrayidx25.4, align 4, !tbaa !6
  br label %for.inc.4
...
for.inc.4:                                        ; preds = %L20.4, %if.end.4
  ...
  %35 = load float, float* %arrayidx.5, align 4, !tbaa !6
...
L20.5:                                            ; preds = %for.inc.4
  ...
  store float %add22.5, float* %arrayidx25.5, align 4, !tbaa !6
  br label %for.inc.5
...
for.inc.5:                                        ; preds = %L20.5, %if.end.5
  ...
  %42 = load float, float* %arrayidx.6, align 4, !tbaa !6
...
L20.6:                                            ; preds = %for.inc.5
  ...
  store float %add22.6, float* %arrayidx25.6, align 4, !tbaa !6
  br label %for.inc.6
...
for.inc.6:                                        ; preds = %L20.6, %if.end.6
  ...
  br i1 %exitcond.6.not, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !53
...
for.body5.7:                                      ; preds = %for.inc.6
  ...
  %49 = load float, float* %arrayidx.7, align 4, !tbaa !6
...
L20.7:                                            ; preds = %for.body5.7
  ...
  store float %add22.7, float* %arrayidx25.7, align 4, !tbaa !6
  br label %for.body5.backedge

for.body5.backedge:                               ; preds = %L20.7, %if.end.7
  %indvars.iv.be = phi i64 [ %55, %L20.7 ], [ %.pre56, %if.end.7 ]
  br label %for.body5, !llvm.loop !54
}
...
for.cond.cleanup4:                                ; preds = %rolled.reg.exit
  %call25 = tail call i32 @dummy(float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @d, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @e, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 0), float 0.000000e+00) #11
...
for.body5.7:                                      ; preds = %rolled.reg.exit
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.6
  %0 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %cmp6.7 = fcmp olt float %0, 0.000000e+00
  br i1 %cmp6.7, label %L20.7, label %if.end.7

if.end.7:                                         ; preds = %for.body5.7
  %arrayidx10.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.6
  %1 = load float, float* %arrayidx10.7, align 4, !tbaa !6
  %arrayidx12.7 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.6
  %2 = load float, float* %arrayidx12.7, align 4, !tbaa !6
  %mul.7 = fmul float %1, %2
  br label %for.inc.7

L20.7:                                            ; preds = %for.body5.7
  %arrayidx16.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6
  %3 = load float, float* %arrayidx16.7, align 4, !tbaa !6
  %arrayidx18.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.6
  %4 = load float, float* %arrayidx18.7, align 4, !tbaa !6
  %mul21.7 = fmul float %4, %4
  br label %for.inc.7

for.inc.7:                                        ; preds = %L20.7, %if.end.7
  %mul21.7.sink = phi float [ %mul21.7, %L20.7 ], [ %mul.7, %if.end.7 ]
  %.sink59 = phi float [ %3, %L20.7 ], [ %0, %if.end.7 ]
  ...
  store float %add22.7, float* %arrayidx24.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !55

rolled.reg.loop:                                  ; preds = %for.body5, %rolled.reg.bb2
  %5 = phi i8 [ 0, %for.body5 ], [ %21, %rolled.reg.bb2 ]
  %6 = zext i8 %5 to i64
  %7 = or i64 %indvars.iv, %6
  %8 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %7
  %9 = load float, float* %8, align 32
  %10 = fcmp olt float %9, 0.000000e+00
  br i1 %10, label %rolled.reg.bb1, label %rolled.reg.bb3

rolled.reg.bb1:                                   ; preds = %rolled.reg.loop
  %11 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %7
  %12 = load float, float* %11, align 32
  %13 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %7
  %14 = load float, float* %13, align 32
  %15 = fmul float %14, %14
  br label %rolled.reg.bb2

rolled.reg.bb2:                                   ; preds = %rolled.reg.bb3, %rolled.reg.bb1
  %16 = phi float [ %9, %rolled.reg.bb3 ], [ %12, %rolled.reg.bb1 ]
  %17 = phi float [ %27, %rolled.reg.bb3 ], [ %15, %rolled.reg.bb1 ]
  %18 = phi [32000 x float]* [ @a, %rolled.reg.bb3 ], [ @b, %rolled.reg.bb1 ]
  %19 = fadd float %16, %17
  %20 = getelementptr inbounds [32000 x float], [32000 x float]* %18, i64 0, i64 %7
  store float %19, float* %20, align 32
  %21 = add i8 %5, 1
  %22 = icmp ne i8 %21, 5
  br i1 %22, label %rolled.reg.loop, label %rolled.reg.exit

rolled.reg.bb3:                                   ; preds = %rolled.reg.loop
  %23 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %7
  %24 = load float, float* %23, align 32
  %25 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %7
  %26 = load float, float* %25, align 32
  %27 = fmul float %24, %26
  br label %rolled.reg.bb2

rolled.reg.exit:                                  ; preds = %rolled.reg.bb2
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
  %exitcond.6.not = icmp eq i64 %indvars.iv.next.6, 31999
  br i1 %exitcond.6.not, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !56
}
...
entry:
  ...
  %1 = load i32*, i32** %0, align 8, !tbaa !26
...
if.end.loopexit:                                  ; preds = %rolled.exit
  br label %if.end
...
for.body6.7:                                      ; preds = %rolled.exit
  %4 = add nsw i64 %23, %3
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %4
  %5 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx8.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %23
  %6 = load float, float* %arrayidx8.7, align 4, !tbaa !6
  %arrayidx10.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %23
  %7 = load float, float* %arrayidx10.7, align 4, !tbaa !6
  %mul.7 = fmul float %6, %7
  %add11.7 = fadd float %5, %mul.7
  %arrayidx13.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %23
  store float %add11.7, float* %arrayidx13.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body6, !llvm.loop !58

rolled.loop:                                      ; preds = %for.body6, %rolled.loop
  %8 = phi i8 [ 0, %for.body6 ], [ %21, %rolled.loop ]
  %9 = zext i8 %8 to i64
  %10 = or i64 %indvars.iv, %9
  %11 = add nsw i64 %10, %3
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %11
  %13 = load float, float* %12, align 1
  %14 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %10
  %15 = load float, float* %14, align 1
  %16 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %10
  %17 = load float, float* %16, align 1
  %18 = fmul float %15, %17
  %19 = fadd float %13, %18
  %20 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %10
  store float %19, float* %20, align 1
  %21 = add i8 %8, 1
  %22 = icmp ne i8 %21, 7
  br i1 %22, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %23 = or i64 %indvars.iv, 7
  %24 = icmp eq i64 %23, 31999
  br i1 %24, label %if.end.loopexit, label %for.body6.7, !llvm.loop !59
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %15, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %4 = phi i8 [ 0, %for.body5 ], [ %13, %rolled.loop ]
  %5 = zext i8 %4 to i64
  %6 = or i64 %indvars.iv, %5
  ...
  %13 = add i8 %4, 1
  %14 = icmp ne i8 %13, 8
  br i1 %14, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %15 = add nuw nsw i64 %indvars.iv, 8
  %16 = icmp eq i64 %15, 32000
  br i1 %16, label %for.cond.cleanup4, label %for.body5, !llvm.loop !60
}
...
entry:
  ...
  %1 = alloca i64, i8 8, align 8
  %arg_info = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 2
  %2 = bitcast i8** %arg_info to %struct.anon.0**
  %3 = load %struct.anon.0*, %struct.anon.0** %2, align 8, !tbaa !26
  %a = getelementptr inbounds %struct.anon.0, %struct.anon.0* %3, i64 0, i32 0
  %4 = load i32, i32* %a, align 4, !tbaa !31
  %b = getelementptr inbounds %struct.anon.0, %struct.anon.0* %3, i64 0, i32 1
  %5 = load i32, i32* %b, align 4, !tbaa !34
  %call = tail call i32 @initialise_arrays(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.s172, i64 0, i64 0)) #11
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  %cmp326 = icmp slt i32 %4, 32001
  %6 = add i32 %4, -1
  %7 = sext i32 %6 to i64
  %8 = sext i32 %5 to i64
  %9 = add i32 %4, %5
...
for.body5.prol:                                   ; preds = %for.body5.prol.preheader, %for.body5.prol
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %for.body5.prol ], [ %7, %for.body5.prol.preheader ]
  ...
  %15 = load float, float* %arrayidx.prol, align 4, !tbaa !6
  %arrayidx7.prol = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.prol
  %16 = load float, float* %arrayidx7.prol, align 4, !tbaa !6
  %add.prol = fadd float %15, %16
  store float %add.prol, float* %arrayidx7.prol, align 4, !tbaa !6
  %indvars.iv.next.prol = add i64 %indvars.iv.prol, %8
  %prol.iter.sub = add i32 %prol.iter, -1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.sub, 0
  br i1 %prol.iter.cmp.not, label %for.body5.prol.loopexit.loopexit, label %for.body5.prol, !llvm.loop !61
...
for.body5.prol.loopexit:                          ; preds = %for.body5.prol.loopexit.loopexit, %for.body5.preheader
  %indvars.iv.unr = phi i64 [ %7, %for.body5.preheader ], [ %indvars.iv.next.prol.lcssa, %for.body5.prol.loopexit.loopexit ]
  %17 = icmp ult i32 %13, 7
  br i1 %17, label %for.cond.cleanup4, label %for.body5.preheader1
...
for.body5:                                        ; preds = %for.body5.preheader1, %for.body5
  ...
  %arrayidx = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  %18 = load float, float* %arrayidx, align 4, !tbaa !6
  %arrayidx7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  %19 = load float, float* %arrayidx7, align 4, !tbaa !6
  %add = fadd float %18, %19
  store float %add, float* %arrayidx7, align 4, !tbaa !6
  %indvars.iv.next = add i64 %indvars.iv, %8
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next
  %20 = load float, float* %arrayidx.1, align 4, !tbaa !6
  %arrayidx7.1 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  %21 = load float, float* %arrayidx7.1, align 4, !tbaa !6
  %add.1 = fadd float %20, %21
  store float %add.1, float* %arrayidx7.1, align 4, !tbaa !6
  %indvars.iv.next.1 = add i64 %indvars.iv.next, %8
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.1
  %22 = load float, float* %arrayidx.2, align 4, !tbaa !6
  %arrayidx7.2 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.1
  %23 = load float, float* %arrayidx7.2, align 4, !tbaa !6
  %add.2 = fadd float %22, %23
  store float %add.2, float* %arrayidx7.2, align 4, !tbaa !6
  %indvars.iv.next.2 = add i64 %indvars.iv.next.1, %8
  %arrayidx.3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.2
  %24 = load float, float* %arrayidx.3, align 4, !tbaa !6
  %arrayidx7.3 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.2
  %25 = load float, float* %arrayidx7.3, align 4, !tbaa !6
  %add.3 = fadd float %24, %25
  store float %add.3, float* %arrayidx7.3, align 4, !tbaa !6
  %indvars.iv.next.3 = add i64 %indvars.iv.next.2, %8
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.3
  %26 = load float, float* %arrayidx.4, align 4, !tbaa !6
  %arrayidx7.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.3
  %27 = load float, float* %arrayidx7.4, align 4, !tbaa !6
  %add.4 = fadd float %26, %27
  store float %add.4, float* %arrayidx7.4, align 4, !tbaa !6
  %indvars.iv.next.4 = add i64 %indvars.iv.next.3, %8
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.4
  %28 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %arrayidx7.5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.4
  %29 = load float, float* %arrayidx7.5, align 4, !tbaa !6
  %add.5 = fadd float %28, %29
  store float %add.5, float* %arrayidx7.5, align 4, !tbaa !6
  %indvars.iv.next.5 = add i64 %indvars.iv.next.4, %8
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.5
  %30 = load float, float* %arrayidx.6, align 4, !tbaa !6
  %arrayidx7.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.5
  %31 = load float, float* %arrayidx7.6, align 4, !tbaa !6
  %add.6 = fadd float %30, %31
  store float %add.6, float* %arrayidx7.6, align 4, !tbaa !6
  %indvars.iv.next.6 = add i64 %indvars.iv.next.5, %8
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  %32 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6
  %33 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %add.7 = fadd float %32, %33
  store float %add.7, float* %arrayidx7.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add i64 %indvars.iv.next.6, %8
  %cmp3.7 = icmp slt i64 %indvars.iv.next.7, 32000
  br i1 %cmp3.7, label %for.body5, label %for.cond.cleanup4.loopexit, !llvm.loop !62
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %13, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %11, %rolled.loop ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  %4 = load float, float* %3, align 1
  %5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %6 = load float, float* %5, align 1
  %7 = fadd float %4, %6
  ...
  %9 = add nuw nsw i64 %indvars.iv, %8
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %9
  store float %7, float* %10, align 1
  %11 = add i8 %0, 1
  %12 = icmp ne i8 %11, 8
  br i1 %12, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %13 = add nuw nsw i64 %indvars.iv, 8
  %14 = icmp eq i64 %13, 16000
  br i1 %14, label %for.cond.cleanup4, label %for.body5, !llvm.loop !63
}
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup4.loopexit, %for.cond2.preheader
  ...
  br i1 %exitcond32.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.body5.preheader, %for.body5
  ...
  store float %add, float* %arrayidx10, align 4, !tbaa !6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.cond.cleanup4.loopexit, label %for.body5
}
...
entry:
  ...
  %8 = icmp ugt i32 %4, 4571
  %unroll_iter = and i32 %7, 65528
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br label %for.cond2.preheader

for.cond2.preheader:                              ; preds = %for.cond.cleanup4, %entry
  %nl.030 = phi i32 [ 0, %entry ], [ %inc14, %for.cond.cleanup4 ]
  br i1 %8, label %for.cond.cleanup4.unr-lcssa, label %for.body5.preheader
...
for.body5.epil:                                   ; preds = %for.body5.epil.preheader, %for.body5.epil
  %indvars.iv.epil = phi i64 [ %indvars.iv.next.epil, %for.body5.epil ], [ %indvars.iv.unr, %for.body5.epil.preheader ]
  %epil.iter = phi i32 [ %epil.iter.sub, %for.body5.epil ], [ %xtraiter, %for.body5.epil.preheader ]
  %indvars.iv.next.epil = add nsw i64 %indvars.iv.epil, %5
  %arrayidx.epil = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.epil
  %9 = load float, float* %arrayidx.epil, align 4, !tbaa !6
  %arrayidx7.epil = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.epil
  %10 = load float, float* %arrayidx7.epil, align 4, !tbaa !6
  %add8.epil = fadd float %9, %10
  %arrayidx10.epil = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.epil
  store float %add8.epil, float* %arrayidx10.epil, align 4, !tbaa !6
  %epil.iter.sub = add i32 %epil.iter, -1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.sub, 0
  br i1 %epil.iter.cmp.not, label %for.cond.cleanup4.loopexit, label %for.body5.epil, !llvm.loop !64
...
for.body5:                                        ; preds = %for.body5.preheader, %for.body5
  ...
  %11 = load float, float* %arrayidx, align 4, !tbaa !6
  %arrayidx7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  ...
  store float %add8, float* %arrayidx10, align 4, !tbaa !6
  ...
  %13 = load float, float* %arrayidx.1, align 4, !tbaa !6
  %arrayidx7.1 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next
  %14 = load float, float* %arrayidx7.1, align 4, !tbaa !6
  %add8.1 = fadd float %13, %14
  store float %add8.1, float* %arrayidx, align 4, !tbaa !6
  ...
  %15 = load float, float* %arrayidx.2, align 4, !tbaa !6
  %arrayidx7.2 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.1
  %16 = load float, float* %arrayidx7.2, align 4, !tbaa !6
  %add8.2 = fadd float %15, %16
  store float %add8.2, float* %arrayidx.1, align 4, !tbaa !6
  ...
  %17 = load float, float* %arrayidx.3, align 4, !tbaa !6
  %arrayidx7.3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.2
  %18 = load float, float* %arrayidx7.3, align 4, !tbaa !6
  %add8.3 = fadd float %17, %18
  store float %add8.3, float* %arrayidx.2, align 4, !tbaa !6
  ...
  %19 = load float, float* %arrayidx.4, align 4, !tbaa !6
  %arrayidx7.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.3
  %20 = load float, float* %arrayidx7.4, align 4, !tbaa !6
  %add8.4 = fadd float %19, %20
  store float %add8.4, float* %arrayidx.3, align 4, !tbaa !6
  ...
  %21 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %arrayidx7.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.4
  %22 = load float, float* %arrayidx7.5, align 4, !tbaa !6
  %add8.5 = fadd float %21, %22
  store float %add8.5, float* %arrayidx.4, align 4, !tbaa !6
  ...
  %23 = load float, float* %arrayidx.6, align 4, !tbaa !6
  %arrayidx7.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.5
  %24 = load float, float* %arrayidx7.6, align 4, !tbaa !6
  %add8.6 = fadd float %23, %24
  store float %add8.6, float* %arrayidx.5, align 4, !tbaa !6
  %indvars.iv.next.7 = add nsw i64 %indvars.iv.next.6, %5
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.7
  %25 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  %26 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %add8.7 = fadd float %25, %26
  store float %add8.7, float* %arrayidx.6, align 4, !tbaa !6
  %niter.nsub.7 = add i32 %niter, -8
  %niter.ncmp.7.not = icmp eq i32 %niter.nsub.7, 0
  br i1 %niter.ncmp.7.not, label %for.cond.cleanup4.unr-lcssa.loopexit, label %for.body5, !llvm.loop !65
}
...
for.cond6.preheader:                              ; preds = %for.cond.cleanup8, %for.cond2.preheader
  ...
  %1 = load float, float* %arrayidx12, align 4, !tbaa !6
  br label %for.body9
...
for.body9:                                        ; preds = %rolled.exit, %for.cond6.preheader
  %indvars.iv = phi i64 [ 0, %for.cond6.preheader ], [ %14, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %2 = phi i8 [ 0, %for.body9 ], [ %12, %rolled.loop ]
  %3 = zext i8 %2 to i64
  ...
  %7 = load float, float* %6, align 1
  %8 = fmul float %7, %1
  %9 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %4
  %10 = load float, float* %9, align 1
  %11 = fadd float %10, %8
  store float %11, float* %9, align 1
  %12 = add i8 %2, 1
  %13 = icmp ne i8 %12, 8
  br i1 %13, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %15 = icmp eq i64 %14, 16000
  br i1 %15, label %for.cond.cleanup8, label %for.body9, !llvm.loop !66
}
...
for.cond2.preheader:                              ; preds = %for.cond.cleanup4, %entry
  ...
  %.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 0), align 64, !tbaa !6
  br label %for.body5
...
for.body5:                                        ; preds = %for.body5.6, %for.cond2.preheader
  ...
  %arrayidx7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv
  %1 = load float, float* %arrayidx7, align 4, !tbaa !6
  %arrayidx9 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv
  %2 = load float, float* %arrayidx9, align 4, !tbaa !6
  %mul = fmul float %1, %2
  %add = fadd float %0, %mul
  ...
  %3 = load float, float* %arrayidx14, align 4, !tbaa !6
  ...
  store float %sub20, float* %arrayidx22, align 4, !tbaa !6
  %arrayidx7.1 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next
  %5 = load float, float* %arrayidx7.1, align 4, !tbaa !6
  %arrayidx9.1 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next
  %6 = load float, float* %arrayidx9.1, align 4, !tbaa !6
  ...
  %7 = load float, float* %arrayidx14.1, align 4, !tbaa !6
  %arrayidx16.1 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next
  %8 = load float, float* %arrayidx16.1, align 4, !tbaa !6
  %mul19.1 = fmul float %6, %8
  %sub20.1 = fsub float %7, %mul19.1
  store float %sub20.1, float* %arrayidx14, align 4, !tbaa !6
  %arrayidx7.2 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.1
  %9 = load float, float* %arrayidx7.2, align 4, !tbaa !6
  %arrayidx9.2 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.1
  %10 = load float, float* %arrayidx9.2, align 4, !tbaa !6
  %mul.2 = fmul float %9, %10
  ...
  %11 = load float, float* %arrayidx14.2, align 4, !tbaa !6
  %arrayidx16.2 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.1
  %12 = load float, float* %arrayidx16.2, align 4, !tbaa !6
  %mul19.2 = fmul float %10, %12
  %sub20.2 = fsub float %11, %mul19.2
  store float %sub20.2, float* %arrayidx14.1, align 4, !tbaa !6
  %arrayidx7.3 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.2
  %13 = load float, float* %arrayidx7.3, align 4, !tbaa !6
  %arrayidx9.3 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.2
  %14 = load float, float* %arrayidx9.3, align 4, !tbaa !6
  ...
  %15 = load float, float* %arrayidx14.3, align 4, !tbaa !6
  %arrayidx16.3 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.2
  %16 = load float, float* %arrayidx16.3, align 4, !tbaa !6
  %mul19.3 = fmul float %14, %16
  %sub20.3 = fsub float %15, %mul19.3
  store float %sub20.3, float* %arrayidx14.2, align 4, !tbaa !6
  %arrayidx7.4 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.3
  %17 = load float, float* %arrayidx7.4, align 4, !tbaa !6
  %arrayidx9.4 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.3
  %18 = load float, float* %arrayidx9.4, align 4, !tbaa !6
  %mul.4 = fmul float %17, %18
  ...
  %19 = load float, float* %arrayidx14.4, align 4, !tbaa !6
  %arrayidx16.4 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.3
  %20 = load float, float* %arrayidx16.4, align 4, !tbaa !6
  %mul19.4 = fmul float %18, %20
  %sub20.4 = fsub float %19, %mul19.4
  store float %sub20.4, float* %arrayidx14.3, align 4, !tbaa !6
  %arrayidx7.5 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.4
  %21 = load float, float* %arrayidx7.5, align 4, !tbaa !6
  %arrayidx9.5 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.4
  %22 = load float, float* %arrayidx9.5, align 4, !tbaa !6
  ...
  %23 = load float, float* %arrayidx14.5, align 4, !tbaa !6
  %arrayidx16.5 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.4
  %24 = load float, float* %arrayidx16.5, align 4, !tbaa !6
  %mul19.5 = fmul float %22, %24
  %sub20.5 = fsub float %23, %mul19.5
  store float %sub20.5, float* %arrayidx14.4, align 4, !tbaa !6
  %exitcond.5.not = icmp eq i64 %indvars.iv.next.5, 31999
  br i1 %exitcond.5.not, label %for.cond.cleanup4, label %for.body5.6, !llvm.loop !67

for.body5.6:                                      ; preds = %for.body5
  %arrayidx7.6 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.5
  %25 = load float, float* %arrayidx7.6, align 4, !tbaa !6
  %arrayidx9.6 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.5
  %26 = load float, float* %arrayidx9.6, align 4, !tbaa !6
  %mul.6 = fmul float %25, %26
  ...
  %27 = load float, float* %arrayidx14.6, align 4, !tbaa !6
  %arrayidx16.6 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.5
  %28 = load float, float* %arrayidx16.6, align 4, !tbaa !6
  %mul19.6 = fmul float %26, %28
  %sub20.6 = fsub float %27, %mul19.6
  store float %sub20.6, float* %arrayidx14.5, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.6
  %29 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %arrayidx9.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.6
  %30 = load float, float* %arrayidx9.7, align 4, !tbaa !6
  ...
  %31 = load float, float* %arrayidx14.7, align 4, !tbaa !6
  %arrayidx16.7 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.6
  %32 = load float, float* %arrayidx16.7, align 4, !tbaa !6
  %mul19.7 = fmul float %30, %32
  %sub20.7 = fsub float %31, %mul19.7
  store float %sub20.7, float* %arrayidx14.6, align 4, !tbaa !6
  br label %for.body5, !llvm.loop !68
}
...
for.body5:                                        ; preds = %for.body5.7, %for.cond2.preheader
  ...
  %arrayidx7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  %mul = fmul float %1, %0
  store float %mul, float* %arrayidx7, align 32, !tbaa !6
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  %27 = load float, float* %arrayidx11.6, align 8, !tbaa !6
  %mul12.6 = fmul float %26, %27
  %arrayidx14.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.5
  %28 = load float, float* %arrayidx14.6, align 8, !tbaa !6
  %add15.6 = fadd float %28, %mul12.6
  store float %add15.6, float* %arrayidx14.6, align 8, !tbaa !6
  %exitcond.6.not = icmp eq i64 %indvars.iv.next.6, 31999
  br i1 %exitcond.6.not, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !69

for.body5.7:                                      ; preds = %for.body5
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.6
  %29 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %mul.7 = fmul float %29, %26
  store float %mul.7, float* %arrayidx9.6, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %arrayidx9.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.7
  %30 = load float, float* %arrayidx9.7, align 32, !tbaa !6
  %arrayidx11.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.6
  %31 = load float, float* %arrayidx11.7, align 4, !tbaa !6
  %mul12.7 = fmul float %30, %31
  %arrayidx14.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  %32 = load float, float* %arrayidx14.7, align 4, !tbaa !6
  %add15.7 = fadd float %32, %mul12.7
  store float %add15.7, float* %arrayidx14.7, align 4, !tbaa !6
  br label %for.body5, !llvm.loop !70
}
...
for.body5:                                        ; preds = %for.body5.6, %for.cond2.preheader
  ...
  store float %add, float* %arrayidx9, align 4, !tbaa !6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx12 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  %2 = load float, float* %arrayidx12, align 4, !tbaa !6
...
for.body5:                                        ; preds = %for.body5.7, %for.cond2.preheader
  %2 = phi float [ %.pre, %for.cond2.preheader ], [ %add17.7, %for.body5.7 ]
  %indvars.iv = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next.7, %for.body5.7 ]
  br label %rolled.loop

for.body5.7:                                      ; preds = %rolled.exit
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %25
  %3 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %25
  %4 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %mul.7 = fmul float %3, %4
  %arrayidx9.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %25
  %5 = load float, float* %arrayidx9.7, align 4, !tbaa !6
  %add.7 = fadd float %5, %mul.7
  store float %add.7, float* %arrayidx9.7, align 4, !tbaa !6
  %add14.7 = fadd float %add.7, %24
  %add17.7 = fadd float %4, %add14.7
  %arrayidx19.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %25
  store float %add17.7, float* %arrayidx19.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !73

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %6 = phi i8 [ 0, %for.body5 ], [ %22, %rolled.loop ]
  %7 = phi float [ %2, %for.body5 ], [ %19, %rolled.loop ]
  %8 = zext i8 %6 to i64
  %9 = add nuw nsw i64 %indvars.iv, %8
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %9
  %11 = load float, float* %10, align 1
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %9
  %13 = load float, float* %12, align 1
  %14 = fmul float %11, %13
  %15 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %9
  %16 = load float, float* %15, align 1
  %17 = fadd float %16, %14
  store float %17, float* %15, align 1
  %18 = fadd float %17, %7
  %19 = fadd float %13, %18
  %20 = getelementptr float, float* %0, i8 %6
  store float %19, float* %20, align 4
  %21 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %9
  store float %19, float* %21, align 1
  %22 = add i8 %6, 1
  %23 = icmp ne i8 %22, 7
  br i1 %23, label %rolled.loop, label %rolled.exit
...
for.body5.4:                                      ; preds = %rolled.exit
  %arrayidx7.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %27
  %2 = load float, float* %arrayidx7.4, align 16, !tbaa !6
  %add.4 = fadd float %26, %2
  %arrayidx9.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %27
  store float %add.4, float* %arrayidx9.4, align 16, !tbaa !6
  %indvars.iv.next.4 = add nuw nsw i64 %indvars.iv, 5
  %3 = or i64 %indvars.iv, 1
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %3
  %4 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %arrayidx7.5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.4
  %5 = load float, float* %arrayidx7.5, align 4, !tbaa !6
  %add.5 = fadd float %4, %5
  %arrayidx9.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.4
  store float %add.5, float* %arrayidx9.5, align 4, !tbaa !6
  %indvars.iv.next.5 = add nuw nsw i64 %indvars.iv, 6
  %6 = or i64 %indvars.iv, 2
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %6
  %7 = load float, float* %arrayidx.6, align 8, !tbaa !6
  %arrayidx7.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.5
  %8 = load float, float* %arrayidx7.6, align 8, !tbaa !6
  %add.6 = fadd float %7, %8
  %arrayidx9.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.5
  store float %add.6, float* %arrayidx9.6, align 8, !tbaa !6
  %indvars.iv.next.6 = add nuw nsw i64 %indvars.iv, 7
  %9 = or i64 %indvars.iv, 3
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %9
  %10 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6
  %11 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %add.7 = fadd float %10, %11
  %arrayidx9.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  store float %add.7, float* %arrayidx9.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !75

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %12 = phi i8 [ 0, %for.body5 ], [ %24, %rolled.loop ]
  %13 = zext i8 %12 to i64
  %14 = add i64 %13, -4
  %15 = add nsw i64 %indvars.iv, %14
  %16 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %15
  %17 = load float, float* %16, align 1
  %18 = or i64 %indvars.iv, %13
  %19 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %18
  %20 = load float, float* %19, align 1
  %21 = fadd float %17, %20
  %22 = getelementptr float, float* %0, i8 %12
  store float %21, float* %22, align 4
  %23 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %18
  store float %21, float* %23, align 1
  %24 = add i8 %12, 1
  %25 = icmp ne i8 %24, 4
  br i1 %25, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %26 = load float, float* %1, align 4
  %27 = add nuw nsw i64 %indvars.iv, 4
  %28 = icmp eq i64 %27, 32000
  br i1 %28, label %for.cond.cleanup4, label %for.body5.4, !llvm.loop !76
}
...
for.cond2.preheader:                              ; preds = %for.cond.cleanup4, %entry
  ...
  %.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @e, i64 0, i64 0), align 64, !tbaa !6
  br label %for.body5
...
for.body5:                                        ; preds = %for.body5.7, %for.cond2.preheader
  %2 = phi float [ %.pre, %for.cond2.preheader ], [ %mul15.7, %for.body5.7 ]
  %indvars.iv = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next.7, %for.body5.7 ]
  br label %rolled.loop

for.body5.7:                                      ; preds = %rolled.exit
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %25
  %3 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %25
  %4 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %mul.7 = fmul float %3, %4
  %arrayidx9.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %25
  %5 = load float, float* %arrayidx9.7, align 4, !tbaa !6
  %add.7 = fadd float %5, %mul.7
  %mul15.7 = fmul float %24, %24
  %arrayidx17.7 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %25
  store float %mul15.7, float* %arrayidx17.7, align 4, !tbaa !6
  %sub25.7 = fsub float %add.7, %mul.7
  store float %sub25.7, float* %arrayidx9.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !77

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %6 = phi i8 [ 0, %for.body5 ], [ %22, %rolled.loop ]
  %7 = phi float [ %2, %for.body5 ], [ %18, %rolled.loop ]
  %8 = zext i8 %6 to i64
  %9 = add nuw nsw i64 %indvars.iv, %8
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %9
  %11 = load float, float* %10, align 1
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %9
  %13 = load float, float* %12, align 1
  %14 = fmul float %11, %13
  %15 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %9
  %16 = load float, float* %15, align 1
  %17 = fadd float %16, %14
  %18 = fmul float %7, %7
  %19 = getelementptr float, float* %0, i8 %6
  store float %18, float* %19, align 4
  %20 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %9
  store float %18, float* %20, align 1
  %21 = fsub float %17, %14
  store float %21, float* %15, align 1
  %22 = add i8 %6, 1
  %23 = icmp ne i8 %22, 7
  br i1 %23, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %25 = add nuw nsw i64 %indvars.iv, 7
  %26 = icmp eq i64 %25, 32000
  br i1 %26, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !78
}
...
for.body9:                                        ; preds = %for.body9.7, %for.cond6.preheader
  %2 = phi float [ %.pre, %for.cond6.preheader ], [ %add.7, %for.body9.7 ]
  %indvars.iv = phi i64 [ 1, %for.cond6.preheader ], [ %indvars.iv.next.7, %for.body9.7 ]
  br label %rolled.loop

for.body9.7:                                      ; preds = %rolled.exit
  %arrayidx15.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %16, i64 %indvars.iv46
  %3 = load float, float* %arrayidx15.7, align 4, !tbaa !6
  %add.7 = fadd float %15, %3
  %arrayidx19.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %16, i64 %indvars.iv46
  store float %add.7, float* %arrayidx19.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body9, !llvm.loop !79

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %4 = phi i8 [ 0, %for.body9 ], [ %13, %rolled.loop ]
  %5 = phi float [ %2, %for.body9 ], [ %10, %rolled.loop ]
  %6 = zext i8 %4 to i64
  %7 = add nuw nsw i64 %indvars.iv, %6
  %8 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %7, i64 %indvars.iv46
  %9 = load float, float* %8, align 1
  %10 = fadd float %5, %9
  %11 = getelementptr float, float* %0, i8 %4
  store float %10, float* %11, align 4
  %12 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %7, i64 %indvars.iv46
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %16 = add nuw nsw i64 %indvars.iv, 7
  %17 = icmp eq i64 %16, 256
  br i1 %17, label %for.cond.cleanup8, label %for.body9.7, !llvm.loop !80
}
...
for.cond6.preheader:                              ; preds = %for.cond.cleanup8, %for.cond2.preheader
  ...
  %.pre = load float, float* %arrayidx11.phi.trans.insert, align 64, !tbaa !6
  br label %for.body9
...
for.cond.cleanup8:                                ; preds = %for.body9
  ...
  br i1 %exitcond60.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.body9:                                        ; preds = %for.body9, %for.cond6.preheader
  ...
  %1 = load float, float* %arrayidx20, align 4, !tbaa !6
  ...
  store float %add, float* %arrayidx24, align 4, !tbaa !6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.body9.prol:                                   ; preds = %for.body9.prol.preheader, %for.body9.prol
  ...
  %3 = load float, float* %arrayidx11.prol, align 4, !tbaa !6
  ...
  store float %add.prol, float* %arrayidx19.prol, align 4, !tbaa !6
  %indvars.iv.next49.prol = add nuw nsw i64 %indvars.iv48.prol, 1
  %prol.iter.sub = add i32 %prol.iter, -1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.sub, 0
  br i1 %prol.iter.cmp.not, label %for.body9.prol.loopexit.loopexit, label %for.body9.prol, !llvm.loop !81
...
for.cond.cleanup8.loopexit:                       ; preds = %rolled.exit
  br label %for.cond.cleanup8

for.cond.cleanup8:                                ; preds = %for.cond.cleanup8.loopexit, %for.body9.prol.loopexit
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 256
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body9.lr.ph

for.body9:                                        ; preds = %for.body9.preheader, %rolled.exit
  %indvars.iv48 = phi i64 [ %17, %rolled.exit ], [ %indvars.iv48.unr, %for.body9.preheader ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %6 = phi i8 [ 0, %for.body9 ], [ %15, %rolled.loop ]
  %7 = zext i8 %6 to i64
  %8 = add nuw nsw i64 %indvars.iv48, %7
  %9 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %8, i64 %indvars.iv
  %10 = load float, float* %9, align 1
  %11 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %8, i64 %indvars.iv
  %12 = load float, float* %11, align 1
  %13 = fadd float %10, %12
  %14 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %8, i64 %indvars.iv
...
rolled.exit:                                      ; preds = %rolled.loop
  %17 = add nuw nsw i64 %indvars.iv48, 8
  %18 = icmp eq i64 %17, 256
  br i1 %18, label %for.cond.cleanup8.loopexit, label %for.body9, !llvm.loop !82
}
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup23
  ...
  br i1 %exitcond83.not, label %for.cond.cleanup, label %for.cond2.preheader

for.cond21.preheader:                             ; preds = %rolled.exit
  %2 = add nsw i64 %indvars.iv80, -1
  br label %for.body24
...
for.body24:                                       ; preds = %for.body24.7, %for.cond21.preheader
  ...
  %arrayidx29 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv77, i64 %2
  %4 = load float, float* %arrayidx29, align 4, !tbaa !6
  %arrayidx33 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %indvars.iv77, i64 %indvars.iv80
  %5 = load float, float* %arrayidx33, align 4, !tbaa !6
  ...
  store float %add34, float* %arrayidx38, align 4, !tbaa !6
  %indvars.iv.next78 = add nuw nsw i64 %indvars.iv77, 1
  %arrayidx29.1 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv.next78, i64 %2
  %6 = load float, float* %arrayidx29.1, align 4, !tbaa !6
  %arrayidx33.1 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %indvars.iv.next78, i64 %indvars.iv80
  %7 = load float, float* %arrayidx33.1, align 4, !tbaa !6
  %add34.1 = fadd float %6, %7
  %arrayidx38.1 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv.next78, i64 %indvars.iv80
  store float %add34.1, float* %arrayidx38.1, align 4, !tbaa !6
  %indvars.iv.next78.1 = add nuw nsw i64 %indvars.iv77, 2
  %arrayidx29.2 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv.next78.1, i64 %2
  %8 = load float, float* %arrayidx29.2, align 4, !tbaa !6
  ...
  %9 = load float, float* %arrayidx33.2, align 4, !tbaa !6
  %add34.2 = fadd float %8, %9
  ...
  store float %add34.2, float* %arrayidx38.2, align 4, !tbaa !6
  %indvars.iv.next78.2 = add nuw nsw i64 %indvars.iv77, 3
  %arrayidx29.3 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv.next78.2, i64 %2
  %10 = load float, float* %arrayidx29.3, align 4, !tbaa !6
  ...
  %11 = load float, float* %arrayidx33.3, align 4, !tbaa !6
  %add34.3 = fadd float %10, %11
  ...
  store float %add34.3, float* %arrayidx38.3, align 4, !tbaa !6
  %indvars.iv.next78.3 = add nuw nsw i64 %indvars.iv77, 4
  %arrayidx29.4 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv.next78.3, i64 %2
  %12 = load float, float* %arrayidx29.4, align 4, !tbaa !6
  ...
  %13 = load float, float* %arrayidx33.4, align 4, !tbaa !6
  %add34.4 = fadd float %12, %13
  ...
  store float %add34.4, float* %arrayidx38.4, align 4, !tbaa !6
  %indvars.iv.next78.4 = add nuw nsw i64 %indvars.iv77, 5
  %arrayidx29.5 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv.next78.4, i64 %2
  %14 = load float, float* %arrayidx29.5, align 4, !tbaa !6
  ...
  %15 = load float, float* %arrayidx33.5, align 4, !tbaa !6
  %add34.5 = fadd float %14, %15
  ...
  store float %add34.5, float* %arrayidx38.5, align 4, !tbaa !6
  %indvars.iv.next78.5 = add nuw nsw i64 %indvars.iv77, 6
  %arrayidx29.6 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv.next78.5, i64 %2
  %16 = load float, float* %arrayidx29.6, align 4, !tbaa !6
  ...
  %17 = load float, float* %arrayidx33.6, align 4, !tbaa !6
  %add34.6 = fadd float %16, %17
  ...
  store float %add34.6, float* %arrayidx38.6, align 4, !tbaa !6
  %indvars.iv.next78.6 = add nuw nsw i64 %indvars.iv77, 7
  %exitcond.679.not = icmp eq i64 %indvars.iv.next78.6, 256
  br i1 %exitcond.679.not, label %for.cond.cleanup23, label %for.body24.7, !llvm.loop !83

for.body9.7:                                      ; preds = %rolled.exit
  %arrayidx15.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %33, i64 %indvars.iv80
  %18 = load float, float* %arrayidx15.7, align 4, !tbaa !6
  %add.7 = fadd float %32, %18
  %arrayidx19.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %33, i64 %indvars.iv80
  store float %add.7, float* %arrayidx19.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body9, !llvm.loop !84

for.body24.7:                                     ; preds = %for.body24
  %arrayidx29.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %indvars.iv.next78.6, i64 %2
  %19 = load float, float* %arrayidx29.7, align 4, !tbaa !6
  ...
  %20 = load float, float* %arrayidx33.7, align 4, !tbaa !6
  %add34.7 = fadd float %19, %20
  ...
  store float %add34.7, float* %arrayidx38.7, align 4, !tbaa !6
  %indvars.iv.next78.7 = add nuw nsw i64 %indvars.iv77, 8
  br label %for.body24, !llvm.loop !85

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %21 = phi i8 [ 0, %for.body9 ], [ %30, %rolled.loop ]
  %22 = phi float [ %3, %for.body9 ], [ %27, %rolled.loop ]
  %23 = zext i8 %21 to i64
  %24 = add nuw nsw i64 %indvars.iv, %23
  %25 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %24, i64 %indvars.iv80
  %26 = load float, float* %25, align 1
  %27 = fadd float %22, %26
  %28 = getelementptr float, float* %0, i8 %21
  store float %27, float* %28, align 4
  %29 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %24, i64 %indvars.iv80
  store float %27, float* %29, align 1
  %30 = add i8 %21, 1
  %31 = icmp ne i8 %30, 7
  br i1 %31, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %32 = load float, float* %1, align 4
  %33 = add nuw nsw i64 %indvars.iv, 7
  %34 = icmp eq i64 %33, 256
  br i1 %34, label %for.cond21.preheader, label %for.body9.7, !llvm.loop !86
}
...
for.body24:                                       ; preds = %for.body24.7, %for.cond21.preheader
  %indvars.iv77 = phi i64 [ 1, %for.cond21.preheader ], [ %indvars.iv.next78.7, %for.body24.7 ]
  %arrayidx29 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %2, i64 %indvars.iv77
  %4 = load float, float* %arrayidx29, align 4, !tbaa !6
  ...
  store float %add34, float* %arrayidx38, align 4, !tbaa !6
  %indvars.iv.next78 = add nuw nsw i64 %indvars.iv77, 1
  %arrayidx29.1 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %2, i64 %indvars.iv.next78
  %6 = load float, float* %arrayidx29.1, align 4, !tbaa !6
  ...
  store float %add34.1, float* %arrayidx38.1, align 4, !tbaa !6
  %indvars.iv.next78.1 = add nuw nsw i64 %indvars.iv77, 2
  %arrayidx29.2 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %2, i64 %indvars.iv.next78.1
  %8 = load float, float* %arrayidx29.2, align 4, !tbaa !6
  ...
  store float %add34.2, float* %arrayidx38.2, align 4, !tbaa !6
  %indvars.iv.next78.2 = add nuw nsw i64 %indvars.iv77, 3
  %arrayidx29.3 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %2, i64 %indvars.iv.next78.2
  %10 = load float, float* %arrayidx29.3, align 4, !tbaa !6
  ...
  store float %add34.3, float* %arrayidx38.3, align 4, !tbaa !6
  %indvars.iv.next78.3 = add nuw nsw i64 %indvars.iv77, 4
  %arrayidx29.4 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %2, i64 %indvars.iv.next78.3
  %12 = load float, float* %arrayidx29.4, align 4, !tbaa !6
  ...
  store float %add34.4, float* %arrayidx38.4, align 4, !tbaa !6
  %indvars.iv.next78.4 = add nuw nsw i64 %indvars.iv77, 5
  %arrayidx29.5 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %2, i64 %indvars.iv.next78.4
  %14 = load float, float* %arrayidx29.5, align 4, !tbaa !6
  ...
  store float %add34.5, float* %arrayidx38.5, align 4, !tbaa !6
  %indvars.iv.next78.5 = add nuw nsw i64 %indvars.iv77, 6
  %arrayidx29.6 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %2, i64 %indvars.iv.next78.5
  %16 = load float, float* %arrayidx29.6, align 4, !tbaa !6
  ...
  %indvars.iv.next78.6 = add nuw nsw i64 %indvars.iv77, 7
  %exitcond.679.not = icmp eq i64 %indvars.iv.next78.6, 256
  br i1 %exitcond.679.not, label %for.cond.cleanup23, label %for.body24.7, !llvm.loop !87
...
for.body9.7:                                      ; preds = %rolled.exit
  ...
  store float %add.7, float* %arrayidx19.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body9, !llvm.loop !88

for.body24.7:                                     ; preds = %for.body24
  %arrayidx29.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %2, i64 %indvars.iv.next78.6
  %19 = load float, float* %arrayidx29.7, align 4, !tbaa !6
  ...
  store float %add34.7, float* %arrayidx38.7, align 4, !tbaa !6
  %indvars.iv.next78.7 = add nuw nsw i64 %indvars.iv77, 8
  br label %for.body24, !llvm.loop !89
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %33 = add nuw nsw i64 %indvars.iv, 7
  %34 = icmp eq i64 %33, 256
  br i1 %34, label %for.cond21.preheader, label %for.body9.7, !llvm.loop !90
}
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup12
  ...
  br i1 %exitcond62.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond.cleanup12, %for.cond2.preheader
  ...
  %4 = load float, float* %arrayidx9, align 4, !tbaa !6
  ...
  %.pre = load float, float* %arrayidx17.phi.trans.insert, align 4, !tbaa !6
  br label %for.body13

for.cond.cleanup12:                               ; preds = %rolled.exit
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next61, 256
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5

for.body13:                                       ; preds = %for.body13.7, %for.body5
  %5 = phi float [ %.pre, %for.body5 ], [ %add25.7, %for.body13.7 ]
  %indvars.iv = phi i64 [ 1, %for.body5 ], [ %indvars.iv.next.7, %for.body13.7 ]
  br label %rolled.loop

for.body13.7:                                     ; preds = %rolled.exit
  %arrayidx21.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %20, i64 %indvars.iv60
  %6 = load float, float* %arrayidx21.7, align 4, !tbaa !6
  %mul24.7 = fmul float %add, %6
  %add25.7 = fadd float %19, %mul24.7
  %arrayidx29.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %20, i64 %indvars.iv60
  store float %add25.7, float* %arrayidx29.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body13, !llvm.loop !91

rolled.loop:                                      ; preds = %for.body13, %rolled.loop
  %7 = phi i8 [ 0, %for.body13 ], [ %17, %rolled.loop ]
  %8 = phi float [ %5, %for.body13 ], [ %14, %rolled.loop ]
  %9 = zext i8 %7 to i64
  %10 = add nuw nsw i64 %indvars.iv, %9
  %11 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %10, i64 %indvars.iv60
  %12 = load float, float* %11, align 1
  %13 = fmul float %add, %12
  %14 = fadd float %8, %13
  %15 = getelementptr float, float* %0, i8 %7
  store float %14, float* %15, align 4
  %16 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %10, i64 %indvars.iv60
  store float %14, float* %16, align 1
  %17 = add i8 %7, 1
  %18 = icmp ne i8 %17, 7
  br i1 %18, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %20 = add nuw nsw i64 %indvars.iv, 7
  %21 = icmp eq i64 %20, 256
  br i1 %21, label %for.cond.cleanup12, label %for.body13.7, !llvm.loop !92
}
...
for.body5.7:                                      ; preds = %rolled.exit
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %30
  %4 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %30
  %5 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %mul.7 = fmul float %4, %5
  %arrayidx9.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %30
  %6 = load float, float* %arrayidx9.7, align 4, !tbaa !6
  %mul10.7 = fmul float %mul.7, %6
  store float %mul10.7, float* %31, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %arrayidx16.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.7
  %7 = load float, float* %arrayidx16.7, align 32, !tbaa !6
  %mul17.7 = fmul float %mul10.7, %7
  %mul20.7 = fmul float %6, %mul17.7
  store float %mul20.7, float* %arrayidx.7, align 4, !tbaa !6
  br label %for.body5, !llvm.loop !93

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %8 = phi i8 [ 0, %for.body5 ], [ %28, %rolled.loop ]
  %9 = zext i8 %8 to i64
  %10 = or i64 %indvars.iv, %9
  %11 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %10
  %12 = load float, float* %11, align 1
  %13 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %10
  %14 = load float, float* %13, align 1
  %15 = fmul float %12, %14
  %16 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %10
  %17 = load float, float* %16, align 1
  %18 = fmul float %15, %17
  %19 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %10
  store float %18, float* %19, align 1
  %20 = add i64 %9, 1
  %21 = or i64 %indvars.iv, %20
  %22 = getelementptr i64, i64* %1, i8 %8
  store i64 %21, i64* %22, align 8
  %23 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %21
  %24 = getelementptr float*, float** %0, i8 %8
  store float* %23, float** %24, align 8
  %25 = load float, float* %23, align 1
  %26 = fmul float %18, %25
  %27 = fmul float %17, %26
  store float %27, float* %11, align 1
  %28 = add i8 %8, 1
  %29 = icmp ne i8 %28, 7
  br i1 %29, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %30 = load i64, i64* %2, align 8
  %31 = load float*, float** %3, align 8
  %32 = icmp eq i64 %30, 31999
  br i1 %32, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !94
}
...
entry:
  %0 = alloca float, i8 7, align 4
  %arg_info = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 2
  %1 = bitcast i8** %arg_info to %struct.anon.1**
  %2 = load %struct.anon.1*, %struct.anon.1** %1, align 8, !tbaa !26
  %a = getelementptr inbounds %struct.anon.1, %struct.anon.1* %2, i64 0, i32 0
  %3 = load float, float* %a, align 4, !tbaa !95
  %b = getelementptr inbounds %struct.anon.1, %struct.anon.1* %2, i64 0, i32 1
  %4 = load float, float* %b, align 4, !tbaa !97
  %call = tail call i32 @initialise_arrays(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.s242, i64 0, i64 0)) #11
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  %5 = getelementptr float, float* %0, i8 6
  br label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.body5.7, %for.cond2.preheader
  %6 = phi float [ %.pre, %for.cond2.preheader ], [ %add15.7, %for.body5.7 ]
  %indvars.iv = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next.7, %for.body5.7 ]
  br label %rolled.loop

for.body5.7:                                      ; preds = %rolled.exit
  %add.7 = fadd float %3, %29
  %add6.7 = fadd float %4, %add.7
  %arrayidx8.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %30
  %7 = load float, float* %arrayidx8.7, align 4, !tbaa !6
  %add9.7 = fadd float %7, %add6.7
  %arrayidx11.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %30
  %8 = load float, float* %arrayidx11.7, align 4, !tbaa !6
  %add12.7 = fadd float %8, %add9.7
  %arrayidx14.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %30
  %9 = load float, float* %arrayidx14.7, align 4, !tbaa !6
  %add15.7 = fadd float %9, %add12.7
  %arrayidx17.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %30
  store float %add15.7, float* %arrayidx17.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !98

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %10 = phi i8 [ 0, %for.body5 ], [ %27, %rolled.loop ]
  %11 = phi float [ %6, %for.body5 ], [ %24, %rolled.loop ]
  %12 = fadd float %3, %11
  %13 = fadd float %4, %12
  ...
  %17 = load float, float* %16, align 1
  %18 = fadd float %17, %13
  %19 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %15
  %20 = load float, float* %19, align 1
  %21 = fadd float %20, %18
  %22 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %15
  %23 = load float, float* %22, align 1
  %24 = fadd float %23, %21
  %25 = getelementptr float, float* %0, i8 %10
  store float %24, float* %25, align 4
  %26 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %15
  store float %24, float* %26, align 1
  %27 = add i8 %10, 1
  %28 = icmp ne i8 %27, 7
  br i1 %28, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %29 = load float, float* %5, align 4
  %30 = add nuw nsw i64 %indvars.iv, 7
  %31 = icmp eq i64 %30, 32000
  br i1 %31, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !99
}
...
for.body5.7:                                      ; preds = %rolled.exit
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %35
  %4 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %35
  %5 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %arrayidx9.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %35
  %6 = load float, float* %arrayidx9.7, align 4, !tbaa !6
  %mul.7 = fmul float %5, %6
  %add.7 = fadd float %4, %mul.7
  %arrayidx17.7 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %35
  %7 = load float, float* %arrayidx17.7, align 4, !tbaa !6
  %mul18.7 = fmul float %6, %7
  %add19.7 = fadd float %add.7, %mul18.7
  store float %add19.7, float* %arrayidx.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %arrayidx26.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.7
  %8 = load float, float* %arrayidx26.7, align 32, !tbaa !6
  %mul29.7 = fmul float %6, %8
  %add30.7 = fadd float %add19.7, %mul29.7
  store float %add30.7, float* %36, align 4, !tbaa !6
  br label %for.body5, !llvm.loop !100

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %9 = phi i8 [ 0, %for.body5 ], [ %33, %rolled.loop ]
  %10 = zext i8 %9 to i64
  %11 = or i64 %indvars.iv, %10
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %11
  %13 = load float, float* %12, align 1
  %14 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %11
  %15 = load float, float* %14, align 1
  %16 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %11
  %17 = load float, float* %16, align 1
  %18 = fmul float %15, %17
  %19 = fadd float %13, %18
  %20 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %11
  %21 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %11
  %22 = load float, float* %21, align 1
  %23 = fmul float %17, %22
  %24 = fadd float %19, %23
  store float %24, float* %12, align 1
  %25 = add i64 %10, 1
  %26 = or i64 %indvars.iv, %25
  %27 = getelementptr i64, i64* %1, i8 %9
  store i64 %26, i64* %27, align 8
  %28 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %26
  %29 = getelementptr float*, float** %0, i8 %9
  store float* %28, float** %29, align 8
  %30 = load float, float* %28, align 1
  %31 = fmul float %17, %30
  %32 = fadd float %24, %31
  store float %32, float* %20, align 1
  %33 = add i8 %9, 1
  %34 = icmp ne i8 %33, 7
  br i1 %34, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %35 = load i64, i64* %2, align 8
  %36 = load float*, float** %3, align 8
  %37 = icmp eq i64 %35, 31999
  br i1 %37, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !101
}
...
for.body5:                                        ; preds = %for.body5.7, %for.cond2.preheader
  ...
  %add = fadd float %0, %mul
  %arrayidx11 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  store float %add, float* %arrayidx11, align 32, !tbaa !6
  %add16 = fadd float %0, %1
  store float %add16, float* %arrayidx, align 32, !tbaa !6
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx23 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next
  %3 = load float, float* %arrayidx.1, align 4, !tbaa !6
  %arrayidx7.1 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next
  %4 = load float, float* %arrayidx7.1, align 4, !tbaa !6
  %arrayidx9.1 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next
  %5 = load float, float* %arrayidx9.1, align 4, !tbaa !6
  %mul.1 = fmul float %4, %5
  %add.1 = fadd float %3, %mul.1
  store float %add.1, float* %arrayidx23, align 4, !tbaa !6
  %add16.1 = fadd float %3, %4
  store float %add16.1, float* %arrayidx.1, align 4, !tbaa !6
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  %arrayidx23.1 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.1
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.1
  %6 = load float, float* %arrayidx.2, align 8, !tbaa !6
  %arrayidx7.2 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.1
  %7 = load float, float* %arrayidx7.2, align 8, !tbaa !6
  %arrayidx9.2 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.1
  %8 = load float, float* %arrayidx9.2, align 8, !tbaa !6
  %mul.2 = fmul float %7, %8
  %add.2 = fadd float %6, %mul.2
  store float %add.2, float* %arrayidx23.1, align 8, !tbaa !6
  %add16.2 = fadd float %6, %7
  store float %add16.2, float* %arrayidx.2, align 8, !tbaa !6
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  %arrayidx23.2 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.2
  %arrayidx.3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.2
  %9 = load float, float* %arrayidx.3, align 4, !tbaa !6
  %arrayidx7.3 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.2
  %10 = load float, float* %arrayidx7.3, align 4, !tbaa !6
  %arrayidx9.3 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.2
  %11 = load float, float* %arrayidx9.3, align 4, !tbaa !6
  %mul.3 = fmul float %10, %11
  %add.3 = fadd float %9, %mul.3
  store float %add.3, float* %arrayidx23.2, align 4, !tbaa !6
  %add16.3 = fadd float %9, %10
  store float %add16.3, float* %arrayidx.3, align 4, !tbaa !6
  %indvars.iv.next.3 = or i64 %indvars.iv, 4
  %arrayidx23.3 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.3
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.3
  %12 = load float, float* %arrayidx.4, align 16, !tbaa !6
  %arrayidx7.4 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.3
  %13 = load float, float* %arrayidx7.4, align 16, !tbaa !6
  %arrayidx9.4 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.3
  %14 = load float, float* %arrayidx9.4, align 16, !tbaa !6
  %mul.4 = fmul float %13, %14
  %add.4 = fadd float %12, %mul.4
  store float %add.4, float* %arrayidx23.3, align 16, !tbaa !6
  %add16.4 = fadd float %12, %13
  store float %add16.4, float* %arrayidx.4, align 16, !tbaa !6
  %indvars.iv.next.4 = or i64 %indvars.iv, 5
  %arrayidx23.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.4
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.4
  %15 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %arrayidx7.5 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.4
  %16 = load float, float* %arrayidx7.5, align 4, !tbaa !6
  %arrayidx9.5 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.4
  %17 = load float, float* %arrayidx9.5, align 4, !tbaa !6
  %mul.5 = fmul float %16, %17
  %add.5 = fadd float %15, %mul.5
  store float %add.5, float* %arrayidx23.4, align 4, !tbaa !6
  %add16.5 = fadd float %15, %16
  store float %add16.5, float* %arrayidx.5, align 4, !tbaa !6
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
  %arrayidx23.5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.5
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.5
  %18 = load float, float* %arrayidx.6, align 8, !tbaa !6
  %arrayidx7.6 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.5
  %19 = load float, float* %arrayidx7.6, align 8, !tbaa !6
  %arrayidx9.6 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.5
  %20 = load float, float* %arrayidx9.6, align 8, !tbaa !6
  %mul.6 = fmul float %19, %20
  %add.6 = fadd float %18, %mul.6
  store float %add.6, float* %arrayidx23.5, align 8, !tbaa !6
  %add16.6 = fadd float %18, %19
  store float %add16.6, float* %arrayidx.6, align 8, !tbaa !6
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
  %arrayidx23.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6
  %21 = load float, float* %arrayidx23.6, align 4, !tbaa !6
  %mul26.6 = fmul float %20, %21
  %add27.6 = fadd float %add16.6, %mul26.6
  store float %add27.6, float* %arrayidx23.6, align 4, !tbaa !6
  %exitcond.6.not = icmp eq i64 %indvars.iv.next.6, 31999
  br i1 %exitcond.6.not, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !102

for.body5.7:                                      ; preds = %for.body5
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  %22 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.6
  %23 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %arrayidx9.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.6
  %24 = load float, float* %arrayidx9.7, align 4, !tbaa !6
  %mul.7 = fmul float %23, %24
  %add.7 = fadd float %22, %mul.7
  store float %add.7, float* %arrayidx23.6, align 4, !tbaa !6
  %add16.7 = fadd float %22, %23
  store float %add16.7, float* %arrayidx.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %arrayidx23.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.7
  %25 = load float, float* %arrayidx23.7, align 32, !tbaa !6
  %mul26.7 = fmul float %24, %25
  %add27.7 = fadd float %add16.7, %mul26.7
  store float %add27.7, float* %arrayidx23.7, align 32, !tbaa !6
  br label %for.body5, !llvm.loop !103
}
...
for.body5.7:                                      ; preds = %rolled.exit
  ...
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %30
  %5 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %mul.7 = fmul float %5, %5
  %add.7 = fadd float %4, %mul.7
  %mul14.7 = fmul float %4, %4
  %add15.7 = fadd float %mul14.7, %add.7
  %add18.7 = fadd float %5, %add15.7
  store float %add18.7, float* %31, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %arrayidx25.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.7
  %6 = load float, float* %arrayidx25.7, align 32, !tbaa !6
  %add26.7 = fadd float %6, %add18.7
  %arrayidx28.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %30
  store float %add26.7, float* %arrayidx28.7, align 4, !tbaa !6
  br label %for.body5, !llvm.loop !104

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %7 = phi i8 [ 0, %for.body5 ], [ %28, %rolled.loop ]
  %8 = zext i8 %7 to i64
  %9 = or i64 %indvars.iv, %8
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %9
  %11 = load float, float* %10, align 1
  ...
  %17 = fadd float %16, %15
  %18 = fadd float %13, %17
  %19 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %9
  store float %18, float* %19, align 1
  %20 = add i64 %8, 1
  %21 = or i64 %indvars.iv, %20
  %22 = getelementptr i64, i64* %1, i8 %7
  store i64 %21, i64* %22, align 8
  %23 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %21
  %24 = getelementptr float*, float** %0, i8 %7
  store float* %23, float** %24, align 8
  %25 = load float, float* %23, align 1
  %26 = fadd float %25, %18
  %27 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %9
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %31 = load float*, float** %3, align 8
  %32 = icmp eq i64 %30, 31999
  br i1 %32, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !105
}

; Function Attrs: nounwind optsize uwtable
define dso_local float @s2244(%struct.args_t* nocapture %func_args) #0 {
entry:
  %0 = alloca i64, i8 2, align 8
  %1 = alloca i64, i8 2, align 8
...
for.body5:                                        ; preds = %for.body5.7, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next.7, %for.body5.7 ]
  %arrayidx = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  %2 = load float, float* %arrayidx, align 32, !tbaa !6
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  %3 = load float, float* %arrayidx14, align 32, !tbaa !6
  %add15 = fadd float %2, %3
  %arrayidx17 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  store float %add15, float* %arrayidx17, align 32, !tbaa !6
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next
  %4 = load float, float* %arrayidx.1, align 4, !tbaa !6
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  ...
  %5 = load float, float* %arrayidx14.1, align 4, !tbaa !6
  %add15.1 = fadd float %4, %5
  store float %add15.1, float* %arrayidx10, align 4, !tbaa !6
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.1
  %6 = load float, float* %arrayidx.2, align 8, !tbaa !6
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  ...
  %7 = load float, float* %arrayidx14.2, align 8, !tbaa !6
  %add15.2 = fadd float %6, %7
  store float %add15.2, float* %arrayidx10.1, align 8, !tbaa !6
  %arrayidx.3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.2
  %8 = load float, float* %arrayidx.3, align 4, !tbaa !6
  %indvars.iv.next.3 = or i64 %indvars.iv, 4
  ...
  %9 = load float, float* %arrayidx14.3, align 4, !tbaa !6
  %add15.3 = fadd float %8, %9
  store float %add15.3, float* %arrayidx10.2, align 4, !tbaa !6
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.3
  %10 = load float, float* %arrayidx.4, align 16, !tbaa !6
  %indvars.iv.next.4 = or i64 %indvars.iv, 5
  ...
  %11 = load float, float* %arrayidx14.4, align 16, !tbaa !6
  %add15.4 = fadd float %10, %11
  store float %add15.4, float* %arrayidx10.3, align 16, !tbaa !6
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.4
  %12 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
  ...
  %13 = load float, float* %arrayidx14.5, align 4, !tbaa !6
  %add15.5 = fadd float %12, %13
  store float %add15.5, float* %arrayidx10.4, align 4, !tbaa !6
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.5
  %14 = load float, float* %arrayidx.6, align 8, !tbaa !6
  %arrayidx7.6 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.5
  %15 = load float, float* %arrayidx7.6, align 8, !tbaa !6
  %add.6 = fadd float %14, %15
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
  %arrayidx10.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6
  store float %add.6, float* %arrayidx10.6, align 4, !tbaa !6
  %arrayidx14.6 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.5
  %16 = load float, float* %arrayidx14.6, align 8, !tbaa !6
  %add15.6 = fadd float %14, %16
  store float %add15.6, float* %arrayidx10.5, align 8, !tbaa !6
  %exitcond.6.not = icmp eq i64 %indvars.iv.next.6, 31999
  br i1 %exitcond.6.not, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !106

for.body5.7:                                      ; preds = %for.body5
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  %17 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv.next.6
  %18 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %add.7 = fadd float %17, %18
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %arrayidx10.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.7
  store float %add.7, float* %arrayidx10.7, align 32, !tbaa !6
  %arrayidx14.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.6
  %19 = load float, float* %arrayidx14.7, align 4, !tbaa !6
  %add15.7 = fadd float %17, %19
  store float %add15.7, float* %arrayidx10.6, align 4, !tbaa !6
  br label %for.body5, !llvm.loop !107
}
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %13, %rolled.loop ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %4 = load float, float* %3, align 1
  %5 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %6 = load float, float* %5, align 1
  %7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %8 = load float, float* %7, align 1
  %9 = fmul float %6, %8
  %10 = fadd float %4, %9
  %11 = fmul float %10, %10
...
rolled.exit:                                      ; preds = %rolled.loop
  %15 = add nuw nsw i64 %indvars.iv, 8
  %16 = icmp eq i64 %15, 32000
  br i1 %16, label %for.cond.cleanup4, label %for.body5, !llvm.loop !108
}
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %16, %rolled.loop ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %4 = load float, float* %3, align 1
  ...
  %6 = load float, float* %5, align 1
  %7 = fadd float %4, %6
  %8 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  %9 = load float, float* %8, align 1
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %11 = load float, float* %10, align 1
  %12 = fadd float %9, %11
  store float %12, float* %3, align 1
  %13 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %2
  %14 = load float, float* %13, align 1
  %15 = fmul float %7, %14
  store float %15, float* %8, align 1
  %16 = add i8 %0, 1
  %17 = icmp ne i8 %16, 8
  br i1 %17, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %18 = add nuw nsw i64 %indvars.iv, 8
  %19 = icmp eq i64 %18, 32000
  br i1 %19, label %for.cond.cleanup4, label %for.body5, !llvm.loop !109
}
...
for.body5:                                        ; preds = %for.body5, %for.cond2.preheader
  ...
  store float %add16.7, float* %arrayidx9.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !110
}
...
for.body5:                                        ; preds = %for.body5.7, %for.cond2.preheader
  %4 = phi float [ %.pre, %for.cond2.preheader ], [ %add.7, %for.body5.7 ]
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next.7, %for.body5.7 ]
  br label %rolled.loop
...
for.body5.7:                                      ; preds = %rolled.exit
  ...
  %5 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %30
  %6 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %add.7 = fadd float %5, %6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %arrayidx10.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.7
  store float %add.7, float* %arrayidx10.7, align 32, !tbaa !6
  %arrayidx14.7 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %30
  %7 = load float, float* %arrayidx14.7, align 4, !tbaa !6
  %mul.7 = fmul float %6, %7
  store float %mul.7, float* %arrayidx.7, align 4, !tbaa !6
  %mul21.7 = fmul float %7, %29
  %arrayidx23.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %30
  store float %mul21.7, float* %arrayidx23.7, align 4, !tbaa !6
  br label %for.body5, !llvm.loop !111

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %8 = phi i8 [ 0, %for.body5 ], [ %27, %rolled.loop ]
  %9 = phi float [ %4, %for.body5 ], [ %16, %rolled.loop ]
  %10 = zext i8 %8 to i64
  %11 = or i64 %indvars.iv, %10
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %11
  %13 = load float, float* %12, align 1
  ...
  %15 = load float, float* %14, align 1
  %16 = fadd float %13, %15
  %17 = getelementptr float, float* %1, i8 %8
  store float %16, float* %17, align 4
  %18 = add i64 %10, 1
  %19 = or i64 %indvars.iv, %18
  %20 = getelementptr i64, i64* %0, i8 %8
  store i64 %19, i64* %20, align 8
  %21 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %19
  store float %16, float* %21, align 1
  %22 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %11
  %23 = load float, float* %22, align 1
  %24 = fmul float %15, %23
  store float %24, float* %12, align 1
  %25 = fmul float %23, %9
  %26 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %11
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  br i1 %31, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !112
}
...
for.body5:                                        ; preds = %for.body5, %for.cond2.preheader
  ...
  %arrayidx9 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  store float %add, float* %arrayidx9, align 32, !tbaa !6
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next
  %2 = load float, float* %arrayidx.1, align 4, !tbaa !6
  %arrayidx7.1 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next
  %3 = load float, float* %arrayidx7.1, align 4, !tbaa !6
  ...
  store float %add.1, float* %arrayidx9.1, align 4, !tbaa !6
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.1
  %4 = load float, float* %arrayidx.2, align 8, !tbaa !6
  %arrayidx7.2 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.1
  %5 = load float, float* %arrayidx7.2, align 8, !tbaa !6
  ...
  store float %add.2, float* %arrayidx9.2, align 8, !tbaa !6
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  %arrayidx.3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.2
  %6 = load float, float* %arrayidx.3, align 4, !tbaa !6
  %arrayidx7.3 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.2
  %7 = load float, float* %arrayidx7.3, align 4, !tbaa !6
  ...
  store float %add.3, float* %arrayidx9.3, align 4, !tbaa !6
  %indvars.iv.next.3 = or i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.3
  %8 = load float, float* %arrayidx.4, align 16, !tbaa !6
  %arrayidx7.4 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.3
  %9 = load float, float* %arrayidx7.4, align 16, !tbaa !6
  ...
  %indvars.iv.next.4 = or i64 %indvars.iv, 5
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.4
  %10 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %arrayidx7.5 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.4
  %11 = load float, float* %arrayidx7.5, align 4, !tbaa !6
  ...
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.5
  %12 = load float, float* %arrayidx.6, align 8, !tbaa !6
  %arrayidx7.6 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.5
  %13 = load float, float* %arrayidx7.6, align 8, !tbaa !6
  ...
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  %14 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.6
  %15 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  ...
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !113
}
...
for.body5:                                        ; preds = %rolled.reg.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next.7, %rolled.reg.exit ]
  br label %rolled.reg.loop

rolled.reg.loop:                                  ; preds = %for.body5, %rolled.reg.latch
  %0 = phi i8 [ 0, %for.body5 ], [ %15, %rolled.reg.latch ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  %4 = load float, float* %3, align 32
  %5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %6 = load float, float* %5, align 32
  %7 = fcmp ogt float %4, %6
  br i1 %7, label %rolled.reg.bb1, label %rolled.reg.latch
...
rolled.reg.bb1:                                   ; preds = %rolled.reg.loop
  ...
  %10 = fmul float %6, %9
  %11 = fsub float %4, %10
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %13 = load float, float* %12, align 32
  %14 = fadd float %13, %11
  store float %14, float* %12, align 32
  store float %11, float* %3, align 32
  br label %rolled.reg.latch

rolled.reg.latch:                                 ; preds = %rolled.reg.loop, %rolled.reg.bb1
  %15 = add i8 %0, 1
  %16 = icmp ne i8 %15, 4
  br i1 %16, label %rolled.reg.loop, label %rolled.reg.exit

rolled.reg.exit:                                  ; preds = %rolled.reg.latch
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !114
}
...
for.cond2.preheader:                              ; preds = %for.cond.cleanup4, %entry
  %nl.027 = phi i32 [ 0, %entry ], [ %inc12, %for.cond.cleanup4 ]
  %x.0.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 31999), align 4, !tbaa !6
  br label %for.body5
...
for.body5:                                        ; preds = %for.body5, %for.cond2.preheader
  ...
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next
  %1 = load float, float* %arrayidx.1, align 4, !tbaa !6
  ...
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.1
  %2 = load float, float* %arrayidx.2, align 8, !tbaa !6
  ...
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  %arrayidx.3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.2
  %3 = load float, float* %arrayidx.3, align 4, !tbaa !6
  ...
  %indvars.iv.next.3 = or i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.3
  %4 = load float, float* %arrayidx.4, align 16, !tbaa !6
  ...
  %indvars.iv.next.4 = or i64 %indvars.iv, 5
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.4
  %5 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %add.5 = fadd float %4, %5
  ...
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.5
  %6 = load float, float* %arrayidx.6, align 8, !tbaa !6
  ...
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  %7 = load float, float* %arrayidx.7, align 4, !tbaa !6
  ...
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !115
}
...
for.body:                                         ; preds = %for.cond.cleanup4, %entry
  ...
  %0 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 31998), align 8, !tbaa !6
  %x.031.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 31999), align 4, !tbaa !6
  br label %for.body5
...
for.body5:                                        ; preds = %for.body5, %for.body
  ...
  %arrayidx8 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  store float %mul, float* %arrayidx8, align 32, !tbaa !6
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next
  %2 = load float, float* %arrayidx.1, align 4, !tbaa !6
  ...
  %arrayidx8.1 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  store float %mul.1, float* %arrayidx8.1, align 4, !tbaa !6
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.1
  %3 = load float, float* %arrayidx.2, align 8, !tbaa !6
  %add.2 = fadd float %2, %3
  %add6.2 = fadd float %1, %add.2
  %mul.2 = fmul float %add6.2, 0x3FD54FDF40000000
  %arrayidx8.2 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.1
  store float %mul.2, float* %arrayidx8.2, align 8, !tbaa !6
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  %arrayidx.3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.2
  %4 = load float, float* %arrayidx.3, align 4, !tbaa !6
  %add.3 = fadd float %3, %4
  %add6.3 = fadd float %2, %add.3
  %mul.3 = fmul float %add6.3, 0x3FD54FDF40000000
  %arrayidx8.3 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.2
  store float %mul.3, float* %arrayidx8.3, align 4, !tbaa !6
  %indvars.iv.next.3 = or i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.3
  %5 = load float, float* %arrayidx.4, align 16, !tbaa !6
  %add.4 = fadd float %4, %5
  %add6.4 = fadd float %3, %add.4
  %mul.4 = fmul float %add6.4, 0x3FD54FDF40000000
  %arrayidx8.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.3
  store float %mul.4, float* %arrayidx8.4, align 16, !tbaa !6
  %indvars.iv.next.4 = or i64 %indvars.iv, 5
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.4
  %6 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %add.5 = fadd float %5, %6
  %add6.5 = fadd float %4, %add.5
  %mul.5 = fmul float %add6.5, 0x3FD54FDF40000000
  %arrayidx8.5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.4
  store float %mul.5, float* %arrayidx8.5, align 4, !tbaa !6
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.5
  %7 = load float, float* %arrayidx.6, align 8, !tbaa !6
  ...
  %arrayidx8.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.5
  store float %mul.6, float* %arrayidx8.6, align 8, !tbaa !6
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  %8 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %add.7 = fadd float %7, %8
  %add6.7 = fadd float %6, %add.7
  %mul.7 = fmul float %add6.7, 0x3FD54FDF40000000
  %arrayidx8.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6
  store float %mul.7, float* %arrayidx8.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !116
}
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond55.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body9:                                        ; preds = %for.body9.7, %for.cond6.preheader
  %2 = phi float [ %.pre, %for.cond6.preheader ], [ %sub10.7, %for.body9.7 ]
  %indvars.iv = phi i64 [ 1, %for.cond6.preheader ], [ %indvars.iv.next.7, %for.body9.7 ]
  br label %rolled.loop

for.body9.7:                                      ; preds = %rolled.exit
  %sub10.7 = fsub float 1.000000e+00, %21
  %arrayidx12.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %22
  store float %sub10.7, float* %arrayidx12.7, align 4, !tbaa !6
  %arrayidx18.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %22, i64 %indvars.iv53
  %3 = load float, float* %arrayidx18.7, align 4, !tbaa !6
  %arrayidx20.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %22
  %4 = load float, float* %arrayidx20.7, align 4, !tbaa !6
  %mul.7 = fmul float %3, %4
  %add.7 = fadd float %sub10.7, %mul.7
  %arrayidx24.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %22, i64 %indvars.iv53
  store float %add.7, float* %arrayidx24.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body9, !llvm.loop !117

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %5 = phi i8 [ 0, %for.body9 ], [ %19, %rolled.loop ]
  %6 = phi float [ %2, %for.body9 ], [ %7, %rolled.loop ]
  %7 = fsub float 1.000000e+00, %6
  %8 = getelementptr float, float* %0, i8 %5
  store float %7, float* %8, align 4
  %9 = zext i8 %5 to i64
  %10 = add nuw nsw i64 %indvars.iv, %9
  %11 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %10
  store float %7, float* %11, align 1
  %12 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %10, i64 %indvars.iv53
  %13 = load float, float* %12, align 1
  %14 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %10
  %15 = load float, float* %14, align 1
  %16 = fmul float %13, %15
  %17 = fadd float %7, %16
  %18 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %10, i64 %indvars.iv53
  store float %17, float* %18, align 1
  %19 = add i8 %5, 1
  %20 = icmp ne i8 %19, 7
  br i1 %20, label %rolled.loop, label %rolled.exit
...
for.cond6.preheader:                              ; preds = %for.cond.cleanup8, %for.cond2.preheader
  ...
  %arrayidx13 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  %arrayidx16 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv55
  %.pre = load float, float* %arrayidx13, align 4, !tbaa !6
  br label %for.body9
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond58.not, label %for.cond.cleanup, label %for.cond2.preheader

for.cond.cleanup8:                                ; preds = %rolled.exit
  %.lcssa = phi float [ %15, %rolled.exit ]
  store float %.lcssa, float* %arrayidx16, align 4, !tbaa !6
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next56, 256
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.cond6.preheader

for.body9:                                        ; preds = %rolled.exit, %for.cond6.preheader
  %indvars.iv = phi i64 [ 0, %for.cond6.preheader ], [ %16, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %3 = phi i8 [ 0, %for.body9 ], [ %13, %rolled.loop ]
  %4 = zext i8 %3 to i64
  %5 = or i64 %indvars.iv, %4
  %6 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %5, i64 %indvars.iv55
  %7 = load float, float* %6, align 1
  %8 = fsub float %7, %.pre
  %9 = getelementptr float, float* %0, i8 %3
  store float %8, float* %9, align 4
  %10 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %5, i64 %indvars.iv55
  %11 = load float, float* %10, align 1
  %12 = fadd float %8, %11
  store float %12, float* %6, align 1
  %13 = add i8 %3, 1
  %14 = icmp ne i8 %13, 8
  br i1 %14, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %15 = load float, float* %1, align 4
  %16 = add nuw nsw i64 %indvars.iv, 8
  %17 = icmp eq i64 %16, 256
  br i1 %17, label %for.cond.cleanup8, label %for.body9, !llvm.loop !119
}
...
for.body5:                                        ; preds = %for.body5, %for.cond2.preheader
  ...
  %arrayidx13 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv
  %2 = load float, float* %arrayidx13, align 32, !tbaa !6
  ...
  store float %add, float* %arrayidx18, align 32, !tbaa !6
  ...
  %arrayidx13.1 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next
  %6 = load float, float* %arrayidx13.1, align 4, !tbaa !6
  ...
  store float %mul22.1, float* %arrayidx24.1, align 4, !tbaa !6
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  ...
  %arrayidx13.2 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.1
  %10 = load float, float* %arrayidx13.2, align 8, !tbaa !6
  ...
  store float %mul22.2, float* %arrayidx24.2, align 8, !tbaa !6
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  ...
  %arrayidx13.3 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.2
  %14 = load float, float* %arrayidx13.3, align 4, !tbaa !6
  ...
  store float %mul22.3, float* %arrayidx24.3, align 4, !tbaa !6
  %indvars.iv.next.3 = or i64 %indvars.iv, 4
  ...
  %arrayidx13.4 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.3
  %18 = load float, float* %arrayidx13.4, align 16, !tbaa !6
  ...
  store float %mul22.4, float* %arrayidx24.4, align 16, !tbaa !6
  %indvars.iv.next.4 = or i64 %indvars.iv, 5
  ...
  %arrayidx13.5 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.4
  %22 = load float, float* %arrayidx13.5, align 4, !tbaa !6
  ...
  store float %mul22.5, float* %arrayidx24.5, align 4, !tbaa !6
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
  ...
  %arrayidx13.6 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.5
  %26 = load float, float* %arrayidx13.6, align 8, !tbaa !6
  ...
  store float %mul22.6, float* %arrayidx24.6, align 8, !tbaa !6
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
  ...
  %arrayidx13.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.6
  %30 = load float, float* %arrayidx13.7, align 4, !tbaa !6
  ...
  store float %mul22.7, float* %arrayidx24.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 256
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !120
}
...
for.cond2.preheader:                              ; preds = %for.cond.cleanup4, %entry
  %nl.040 = phi i32 [ 0, %entry ], [ %inc21, %for.cond.cleanup4 ]
  %.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), align 64, !tbaa !6
  br label %for.body5
...
for.body5:                                        ; preds = %for.body5.7, %for.cond2.preheader
  ...
  %arrayidx7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  %2 = load float, float* %arrayidx7, align 4, !tbaa !6
  %add = fadd float %1, %2
  %add10 = fadd float %add, %0
  store float %add10, float* %arrayidx, align 4, !tbaa !6
  %arrayidx14 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv
  %3 = load float, float* %arrayidx14, align 4, !tbaa !6
  %arrayidx16 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv
  %4 = load float, float* %arrayidx16, align 4, !tbaa !6
  %mul = fmul float %3, %4
  store float %mul, float* %arrayidx14, align 4, !tbaa !6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  %5 = load float, float* %arrayidx.1, align 4, !tbaa !6
  %arrayidx7.1 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next
  %6 = load float, float* %arrayidx7.1, align 4, !tbaa !6
  %add.1 = fadd float %5, %6
  %add10.1 = fadd float %add.1, %mul
  store float %add10.1, float* %arrayidx.1, align 4, !tbaa !6
  %arrayidx14.1 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next
  %7 = load float, float* %arrayidx14.1, align 4, !tbaa !6
  %arrayidx16.1 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next
  %8 = load float, float* %arrayidx16.1, align 4, !tbaa !6
  %mul.1 = fmul float %7, %8
  store float %mul.1, float* %arrayidx14.1, align 4, !tbaa !6
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.1
  %9 = load float, float* %arrayidx.2, align 4, !tbaa !6
  %arrayidx7.2 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.1
  %10 = load float, float* %arrayidx7.2, align 4, !tbaa !6
  %add.2 = fadd float %9, %10
  %add10.2 = fadd float %add.2, %mul.1
  store float %add10.2, float* %arrayidx.2, align 4, !tbaa !6
  %arrayidx14.2 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.1
  %11 = load float, float* %arrayidx14.2, align 4, !tbaa !6
  %arrayidx16.2 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.1
  %12 = load float, float* %arrayidx16.2, align 4, !tbaa !6
  %mul.2 = fmul float %11, %12
  store float %mul.2, float* %arrayidx14.2, align 4, !tbaa !6
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %arrayidx.3 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.2
  %13 = load float, float* %arrayidx.3, align 4, !tbaa !6
  %arrayidx7.3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.2
  %14 = load float, float* %arrayidx7.3, align 4, !tbaa !6
  %add.3 = fadd float %13, %14
  %add10.3 = fadd float %add.3, %mul.2
  store float %add10.3, float* %arrayidx.3, align 4, !tbaa !6
  %arrayidx14.3 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.2
  %15 = load float, float* %arrayidx14.3, align 4, !tbaa !6
  %arrayidx16.3 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.2
  %16 = load float, float* %arrayidx16.3, align 4, !tbaa !6
  %mul.3 = fmul float %15, %16
  store float %mul.3, float* %arrayidx14.3, align 4, !tbaa !6
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.3
  %17 = load float, float* %arrayidx.4, align 4, !tbaa !6
  %arrayidx7.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.3
  %18 = load float, float* %arrayidx7.4, align 4, !tbaa !6
  %add.4 = fadd float %17, %18
  %add10.4 = fadd float %add.4, %mul.3
  store float %add10.4, float* %arrayidx.4, align 4, !tbaa !6
  %arrayidx14.4 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.3
  %19 = load float, float* %arrayidx14.4, align 4, !tbaa !6
  %arrayidx16.4 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.3
  %20 = load float, float* %arrayidx16.4, align 4, !tbaa !6
  %mul.4 = fmul float %19, %20
  store float %mul.4, float* %arrayidx14.4, align 4, !tbaa !6
  %indvars.iv.next.4 = add nuw nsw i64 %indvars.iv, 5
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.4
  %21 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %arrayidx7.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.4
  ...
  store float %add10.5, float* %arrayidx.5, align 4, !tbaa !6
  %arrayidx14.5 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.4
  %23 = load float, float* %arrayidx14.5, align 4, !tbaa !6
  %arrayidx16.5 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.4
  %24 = load float, float* %arrayidx16.5, align 4, !tbaa !6
  %mul.5 = fmul float %23, %24
  store float %mul.5, float* %arrayidx14.5, align 4, !tbaa !6
  %indvars.iv.next.5 = add nuw nsw i64 %indvars.iv, 6
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.5
  %25 = load float, float* %arrayidx.6, align 4, !tbaa !6
  %arrayidx7.6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.5
  %26 = load float, float* %arrayidx7.6, align 4, !tbaa !6
  %add.6 = fadd float %25, %26
  %add10.6 = fadd float %add.6, %mul.5
  store float %add10.6, float* %arrayidx.6, align 4, !tbaa !6
  %arrayidx14.6 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.5
  %27 = load float, float* %arrayidx14.6, align 4, !tbaa !6
  %arrayidx16.6 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.5
  %28 = load float, float* %arrayidx16.6, align 4, !tbaa !6
  %mul.6 = fmul float %27, %28
  store float %mul.6, float* %arrayidx14.6, align 4, !tbaa !6
  %indvars.iv.next.6 = add nuw nsw i64 %indvars.iv, 7
  %exitcond.6.not = icmp eq i64 %indvars.iv.next.6, 32000
  br i1 %exitcond.6.not, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !121

for.body5.7:                                      ; preds = %for.body5
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6
  %29 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  %30 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %add.7 = fadd float %29, %30
  %add10.7 = fadd float %add.7, %mul.6
  store float %add10.7, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx14.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.6
  %31 = load float, float* %arrayidx14.7, align 4, !tbaa !6
  %arrayidx16.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.6
  %32 = load float, float* %arrayidx16.7, align 4, !tbaa !6
  %mul.7 = fmul float %31, %32
  store float %mul.7, float* %arrayidx14.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !122
}
...
rolled.reg.loop:                                  ; preds = %for.body5, %rolled.reg.latch
  %0 = phi i8 [ 0, %for.body5 ], [ %12, %rolled.reg.latch ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %4 = load float, float* %3, align 32
  %5 = fcmp ogt float %4, 0.000000e+00
  br i1 %5, label %rolled.reg.bb1, label %rolled.reg.latch

rolled.reg.bb1:                                   ; preds = %rolled.reg.loop
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %7 = load float, float* %6, align 32
  %8 = fmul float %4, %7
  %9 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  %10 = load float, float* %9, align 32
  %11 = fadd float %10, %8
  store float %11, float* %9, align 32
  br label %rolled.reg.latch

rolled.reg.latch:                                 ; preds = %rolled.reg.loop, %rolled.reg.bb1
  %12 = add i8 %0, 1
  %13 = icmp ne i8 %12, 4
  br i1 %13, label %rolled.reg.loop, label %rolled.reg.exit

rolled.reg.exit:                                  ; preds = %rolled.reg.latch
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !123
}
...
rolled.reg.loop:                                  ; preds = %for.body5, %rolled.reg.latch
  %3 = phi i8 [ 0, %for.body5 ], [ %21, %rolled.reg.latch ]
  %4 = zext i8 %3 to i64
  %5 = or i64 %indvars.iv, %4
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %5
  %7 = load float, float* %6, align 32
  %8 = fcmp ult float %7, %conv
  br i1 %8, label %rolled.reg.latch, label %rolled.reg.bb2

rolled.reg.bb2:                                   ; preds = %rolled.reg.loop
  %9 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %5
  %10 = load float, float* %9, align 32
  %11 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %5
  %12 = load float, float* %11, align 32
  %13 = fmul float %10, %12
  %14 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %5
  %15 = load float, float* %14, align 32
  %16 = fadd float %15, %13
  store float %16, float* %14, align 32
  %17 = fmul float %10, %10
  %18 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %5
  %19 = load float, float* %18, align 32
  %20 = fadd float %17, %19
  store float %20, float* %18, align 32
  br label %rolled.reg.latch

rolled.reg.latch:                                 ; preds = %rolled.reg.loop, %rolled.reg.bb2
  %21 = add i8 %3, 1
  %22 = icmp ne i8 %21, 4
  br i1 %22, label %rolled.reg.loop, label %rolled.reg.exit
...
rolled.reg.exit:                                  ; preds = %rolled.reg.latch
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !124
}
...
rolled.reg.loop:                                  ; preds = %for.body5, %rolled.reg.bb2
  %0 = phi i8 [ 0, %for.body5 ], [ %19, %rolled.reg.bb2 ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %4 = load float, float* %3, align 32
  ...
  %9 = load float, float* %8, align 32
  %10 = fadd float %9, %7
  store float %10, float* %8, align 32
  %11 = fcmp olt float %10, 0.000000e+00
  br i1 %11, label %rolled.reg.bb1, label %rolled.reg.bb2

rolled.reg.bb1:                                   ; preds = %rolled.reg.loop
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %13 = load float, float* %12, align 32
  %14 = fadd float %7, %13
  store float %14, float* %12, align 32
  br label %rolled.reg.bb2

rolled.reg.bb2:                                   ; preds = %rolled.reg.bb1, %rolled.reg.loop
  %15 = fmul float %4, %10
  %16 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %17 = load float, float* %16, align 32
  %18 = fadd float %15, %17
  store float %18, float* %16, align 32
  %19 = add i8 %0, 1
  %20 = icmp ne i8 %19, 4
  br i1 %20, label %rolled.reg.loop, label %rolled.reg.exit

rolled.reg.exit:                                  ; preds = %rolled.reg.bb2
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !125
}
...
rolled.reg.loop:                                  ; preds = %for.body5, %rolled.reg.latch
  %0 = phi i8 [ 0, %for.body5 ], [ %16, %rolled.reg.latch ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %4 = load float, float* %3, align 32
  ...
  %6 = load float, float* %5, align 32
  %7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %8 = load float, float* %7, align 32
  %9 = fmul float %6, %8
  %10 = fadd float %4, %9
  %11 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  store float %10, float* %11, align 32
  %12 = fcmp ogt float %10, 0.000000e+00
  br i1 %12, label %rolled.reg.bb1, label %rolled.reg.bb3

rolled.reg.bb1:                                   ; preds = %rolled.reg.loop
  %13 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %14 = load float, float* %13, align 32
  %15 = fadd float %10, %14
  store float %15, float* %13, align 32
  br label %rolled.reg.latch

rolled.reg.bb3:                                   ; preds = %rolled.reg.loop
  store float %9, float* %11, align 32
  br label %rolled.reg.latch

rolled.reg.latch:                                 ; preds = %rolled.reg.bb1, %rolled.reg.bb3
  %16 = add i8 %0, 1
  %17 = icmp ne i8 %16, 5
  br i1 %17, label %rolled.reg.loop, label %rolled.reg.exit

rolled.reg.exit:                                  ; preds = %rolled.reg.latch
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !126
}
...
for.body10:                                       ; preds = %for.body10.preheader, %for.body10.7
  %3 = phi float [ %add.7, %for.body10.7 ], [ %2, %for.body10.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next.7, %for.body10.7 ], [ 1, %for.body10.preheader ]
  br label %rolled.loop

for.inc27.loopexit:                               ; preds = %rolled.exit
  br label %for.inc27
...
for.body10.7:                                     ; preds = %rolled.exit
  %arrayidx18.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %21, i64 %indvars.iv56
  %4 = load float, float* %arrayidx18.7, align 4, !tbaa !6
  %arrayidx22.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %21, i64 %indvars.iv56
  %5 = load float, float* %arrayidx22.7, align 4, !tbaa !6
  %mul.7 = fmul float %4, %5
  %add.7 = fadd float %20, %mul.7
  %arrayidx26.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %21, i64 %indvars.iv56
  store float %add.7, float* %arrayidx26.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body10, !llvm.loop !127

rolled.loop:                                      ; preds = %for.body10, %rolled.loop
  %6 = phi i8 [ 0, %for.body10 ], [ %18, %rolled.loop ]
  %7 = phi float [ %3, %for.body10 ], [ %15, %rolled.loop ]
  %8 = zext i8 %6 to i64
  %9 = add nuw nsw i64 %indvars.iv, %8
  %10 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %9, i64 %indvars.iv56
  %11 = load float, float* %10, align 1
  %12 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %9, i64 %indvars.iv56
  %13 = load float, float* %12, align 1
  %14 = fmul float %11, %13
  %15 = fadd float %7, %14
  %16 = getelementptr float, float* %0, i8 %6
  store float %15, float* %16, align 4
  %17 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %9, i64 %indvars.iv56
  store float %15, float* %17, align 1
  %18 = add i8 %6, 1
  %19 = icmp ne i8 %18, 7
  br i1 %19, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %21 = add nuw nsw i64 %indvars.iv, 7
  %22 = icmp eq i64 %21, 256
  br i1 %22, label %for.inc27.loopexit, label %for.body10.7, !llvm.loop !128
}
...
for.cond.cleanup8:                                ; preds = %rolled.exit
  ...
  store float %add31, float* %arrayidx33, align 4, !tbaa !6
...
rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %3 = phi i8 [ 0, %for.body9 ], [ %14, %rolled.loop ]
  %4 = zext i8 %3 to i64
  %5 = or i64 %indvars.iv, %4
  %6 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %5, i64 %indvars.iv65
  %7 = load float, float* %6, align 1
  %8 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %5, i64 %indvars.iv65
  %9 = load float, float* %8, align 1
  %10 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %5, i64 %indvars.iv65
  %11 = load float, float* %10, align 1
  %12 = fmul float %9, %11
  %13 = fadd float %7, %12
  store float %13, float* %6, align 1
  %14 = add i8 %3, 1
  %15 = icmp ne i8 %14, 8
  br i1 %15, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %16 = add nuw nsw i64 %indvars.iv, 8
  %17 = icmp eq i64 %16, 256
  br i1 %17, label %for.cond.cleanup8, label %for.body9, !llvm.loop !129
}
...
for.inc.thread:                                   ; preds = %for.body5
  %arrayidx15 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv
  %1 = load float, float* %arrayidx15, align 32, !tbaa !6
  %mul16 = fmul float %0, %1
  %arrayidx18 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  %2 = load float, float* %arrayidx18, align 32, !tbaa !6
  %add19 = fadd float %2, %mul16
  store float %add19, float* %arrayidx18, align 32, !tbaa !6
...
for.inc.4.thread:                                 ; preds = %for.inc.2, %rolled.exit
  ...
  %17 = load float, float* %arrayidx13.4, align 16, !tbaa !6
  %arrayidx15.4 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.35560
  %18 = load float, float* %arrayidx15.4, align 16, !tbaa !6
  %mul16.4 = fmul float %17, %18
  %arrayidx18.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.35560
  %19 = load float, float* %arrayidx18.4, align 16, !tbaa !6
  %add19.4 = fadd float %19, %mul16.4
  store float %add19.4, float* %arrayidx18.4, align 16, !tbaa !6
  ...
  %20 = load float, float* %arrayidx13.5, align 4, !tbaa !6
  %arrayidx15.5 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.462
  %21 = load float, float* %arrayidx15.5, align 4, !tbaa !6
  %mul16.5 = fmul float %20, %21
  %arrayidx18.5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.462
  %22 = load float, float* %arrayidx18.5, align 4, !tbaa !6
  %add19.5 = fadd float %22, %mul16.5
  store float %add19.5, float* %arrayidx18.5, align 4, !tbaa !6
  %indvars.iv.next.670 = or i64 %indvars.iv, 7
  br label %if.else.6

for.inc.4:                                        ; preds = %for.inc.2
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.3
  %23 = load float, float* %arrayidx.4, align 16, !tbaa !6
  %arrayidx8.4 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.3
  %24 = load float, float* %arrayidx8.4, align 16, !tbaa !6
  %mul.4 = fmul float %23, %24
  %arrayidx10.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.3
  %25 = load float, float* %arrayidx10.4, align 16, !tbaa !6
  %add11.4 = fadd float %25, %mul.4
  store float %add11.4, float* %arrayidx10.4, align 16, !tbaa !6
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.4
  %26 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %arrayidx8.5 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.4
  %27 = load float, float* %arrayidx8.5, align 4, !tbaa !6
  %mul.5 = fmul float %26, %27
  %arrayidx10.5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.4
  %28 = load float, float* %arrayidx10.5, align 4, !tbaa !6
  %add11.5 = fadd float %28, %mul.5
  store float %add11.5, float* %arrayidx10.5, align 4, !tbaa !6
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
...
for.inc.6:                                        ; preds = %if.then.6, %if.else.6
  ...
  %.sink = load float, float* %.sink.in, align 8, !tbaa !6
  %29 = load float, float* %arrayidx8.6.sink, align 8, !tbaa !6
  %mul.6 = fmul float %.sink, %29
  %arrayidx10.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.5.sink
  %30 = load float, float* %arrayidx10.6, align 8, !tbaa !6
  %add11.6 = fadd float %30, %mul.6
  store float %add11.6, float* %arrayidx10.6, align 8, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  ...
  %31 = load float, float* %arrayidx.7, align 4, !tbaa !6
  ...
  %32 = load float, float* %arrayidx8.7, align 4, !tbaa !6
  %mul.7 = fmul float %31, %32
  %arrayidx10.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.673
  %33 = load float, float* %arrayidx10.7, align 4, !tbaa !6
  %add11.7 = fadd float %33, %mul.7
  store float %add11.7, float* %arrayidx10.7, align 4, !tbaa !6
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !130

rolled.pre:                                       ; preds = %for.inc.thread, %for.inc
...
rolled.loop:                                      ; preds = %rolled.pre, %rolled.loop
  %34 = phi i8 [ 0, %rolled.pre ], [ %45, %rolled.loop ]
  %35 = icmp eq i8 %34, 0
  %36 = select i1 %35, i64 %indvars.iv.next.14348, i64 %indvars.iv.next.250
  %37 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %36
  %38 = load float, float* %37, align 1
  %39 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %36
  %40 = load float, float* %39, align 1
  %41 = fmul float %38, %40
  %42 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %36
  %43 = load float, float* %42, align 1
  %44 = fadd float %43, %41
  store float %44, float* %42, align 1
  %45 = add i8 %34, 1
  br i1 %35, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %46 = or i64 %indvars.iv, 4
  %47 = or i64 %indvars.iv, 5
...
if.end:                                           ; preds = %for.body5
  ...
  %arrayidx13 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv
  %2 = load float, float* %arrayidx13, align 4, !tbaa !6
  %arrayidx15 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv
  %3 = load float, float* %arrayidx15, align 4, !tbaa !6
...
L30:                                              ; preds = %if.end11, %if.end
  ...
  %4 = load float, float* %arrayidx23, align 4, !tbaa !6
  ...
  store float %add25, float* %arrayidx28, align 4, !tbaa !6
  br label %for.inc
...
if.end.1:                                         ; preds = %for.inc
  ...
  %7 = load float, float* %arrayidx8.1, align 4, !tbaa !6
...
L30.1:                                            ; preds = %if.end11.1, %if.end.1
  ...
  %10 = load float, float* %arrayidx23.1, align 4, !tbaa !6
  ...
  store float %add25.1, float* %arrayidx28.1, align 4, !tbaa !6
  br label %for.inc.1
...
for.inc.1:                                        ; preds = %L30.1, %for.inc.for.inc.1_crit_edge
  ...
  %12 = load float, float* %arrayidx.2, align 4, !tbaa !6
...
if.end.2:                                         ; preds = %for.inc.1
  ...
  %13 = load float, float* %arrayidx8.2, align 4, !tbaa !6
...
L30.2:                                            ; preds = %if.end11.2, %if.end.2
  ...
  %16 = load float, float* %arrayidx23.2, align 4, !tbaa !6
  ...
  store float %add25.2, float* %arrayidx28.2, align 4, !tbaa !6
  br label %for.inc.2
...
for.inc.2:                                        ; preds = %L30.2, %for.inc.1.for.inc.2_crit_edge
  ...
  %18 = load float, float* %arrayidx.3, align 4, !tbaa !6
...
if.end.3:                                         ; preds = %for.inc.2
  ...
  %19 = load float, float* %arrayidx8.3, align 4, !tbaa !6
...
L30.3:                                            ; preds = %if.end11.3, %if.end.3
  ...
  %22 = load float, float* %arrayidx23.3, align 4, !tbaa !6
  ...
  store float %add25.3, float* %arrayidx28.3, align 4, !tbaa !6
  br label %for.inc.3
...
for.inc.3:                                        ; preds = %L30.3, %for.inc.2.for.inc.3_crit_edge
  ...
  %24 = load float, float* %arrayidx.4, align 4, !tbaa !6
...
if.end.4:                                         ; preds = %for.inc.3
  ...
  %25 = load float, float* %arrayidx8.4, align 4, !tbaa !6
...
L30.4:                                            ; preds = %if.end11.4, %if.end.4
  ...
  %28 = load float, float* %arrayidx23.4, align 4, !tbaa !6
  ...
  store float %add25.4, float* %arrayidx28.4, align 4, !tbaa !6
  br label %for.inc.4
...
for.inc.4:                                        ; preds = %L30.4, %for.inc.3.for.inc.4_crit_edge
  ...
  %30 = load float, float* %arrayidx.5, align 4, !tbaa !6
...
if.end.5:                                         ; preds = %for.inc.4
  ...
  %31 = load float, float* %arrayidx8.5, align 4, !tbaa !6
...
L30.5:                                            ; preds = %if.end11.5, %if.end.5
  ...
  %34 = load float, float* %arrayidx23.5, align 4, !tbaa !6
  ...
  store float %add25.5, float* %arrayidx28.5, align 4, !tbaa !6
  br label %for.inc.5
...
for.inc.5:                                        ; preds = %L30.5, %for.inc.4.for.inc.5_crit_edge
  ...
  %36 = load float, float* %arrayidx.6, align 4, !tbaa !6
...
if.end.6:                                         ; preds = %for.inc.5
  ...
  %37 = load float, float* %arrayidx8.6, align 4, !tbaa !6
...
L30.6:                                            ; preds = %if.end11.6, %if.end.6
  ...
  %40 = load float, float* %arrayidx23.6, align 4, !tbaa !6
  ...
  store float %add25.6, float* %arrayidx28.6, align 4, !tbaa !6
  br label %for.inc.6
...
for.inc.6:                                        ; preds = %L30.6, %for.inc.5.for.inc.6_crit_edge
  ...
  %exitcond.6.not = icmp eq i64 %indvars.iv.next.6.pre-phi, 31999
  br i1 %exitcond.6.not, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !131

for.body5.7:                                      ; preds = %for.inc.6
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6.pre-phi
  %42 = load float, float* %arrayidx.7, align 4, !tbaa !6
...
L30.7:                                            ; preds = %if.end11.7, %if.end.7
  ...
  %46 = load float, float* %arrayidx23.7, align 4, !tbaa !6
  ...
  store float %add25.7, float* %arrayidx28.7, align 4, !tbaa !6
  br label %for.body5.backedge
}
...
rolled.reg.loop:                                  ; preds = %for.body5, %rolled.reg.bb2
  %0 = phi i8 [ 0, %for.body5 ], [ %21, %rolled.reg.bb2 ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  %4 = load float, float* %3, align 32
  %5 = fcmp ogt float %4, 0.000000e+00
  br i1 %5, label %rolled.reg.bb1, label %rolled.reg.bb3
...
rolled.reg.bb1:                                   ; preds = %rolled.reg.loop
  ...
  %8 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %9 = load float, float* %8, align 32
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %2
  %11 = load float, float* %10, align 32
  %12 = fmul float %9, %11
  %13 = fsub float %12, %7
  store float %13, float* %6, align 32
  %14 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %15 = load float, float* %14, align 32
  br label %rolled.reg.bb2

rolled.reg.bb2:                                   ; preds = %rolled.reg.bb3, %rolled.reg.bb1
  %16 = phi float [ %13, %rolled.reg.bb1 ], [ %32, %rolled.reg.bb3 ]
  %17 = phi float [ %9, %rolled.reg.bb1 ], [ %26, %rolled.reg.bb3 ]
  %18 = phi float [ %15, %rolled.reg.bb1 ], [ %30, %rolled.reg.bb3 ]
  %19 = fmul float %16, %17
  %20 = fadd float %18, %19
  store float %20, float* %3, align 32
  %21 = add i8 %0, 1
  %22 = icmp ne i8 %21, 5
  br i1 %22, label %rolled.reg.loop, label %rolled.reg.exit

rolled.reg.bb3:                                   ; preds = %rolled.reg.loop
  %23 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %24 = load float, float* %23, align 32
  %25 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %26 = load float, float* %25, align 32
  %27 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %2
  %28 = load float, float* %27, align 32
  %29 = fmul float %26, %28
  %30 = fsub float %29, %24
  store float %30, float* %23, align 32
  %31 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %32 = load float, float* %31, align 32
  br label %rolled.reg.bb2

rolled.reg.exit:                                  ; preds = %rolled.reg.bb2
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !133
}
...
rolled.reg.bb1:                                   ; preds = %rolled.reg.loop
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %7 = load float, float* %6, align 32
  %8 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %2
  %9 = load float, float* %8, align 32
  %10 = fmul float %9, %9
  %11 = fsub float %10, %7
  store float %11, float* %6, align 32
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %13 = load float, float* %12, align 32
  %14 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %15 = load float, float* %14, align 32
  br label %rolled.reg.bb2

rolled.reg.bb2:                                   ; preds = %rolled.reg.bb5, %rolled.reg.bb4, %rolled.reg.bb1
  %16 = phi float [ %37, %rolled.reg.bb5 ], [ %11, %rolled.reg.bb1 ], [ %35, %rolled.reg.bb4 ]
  %17 = phi float [ %26, %rolled.reg.bb5 ], [ %15, %rolled.reg.bb1 ], [ %26, %rolled.reg.bb4 ]
  %18 = phi float [ %28, %rolled.reg.bb5 ], [ %13, %rolled.reg.bb1 ], [ %28, %rolled.reg.bb4 ]
  %19 = fmul float %16, %17
  %20 = fadd float %18, %19
  store float %20, float* %3, align 32
  %21 = add i8 %0, 1
...
rolled.reg.bb3:                                   ; preds = %rolled.reg.loop
  ...
  %27 = fmul float %26, %26
  %28 = fsub float %27, %24
  store float %28, float* %23, align 32
  %29 = fcmp ugt float %28, %4
  br i1 %29, label %rolled.reg.bb4, label %rolled.reg.bb5

rolled.reg.bb4:                                   ; preds = %rolled.reg.bb3
  %30 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %2
  %31 = load float, float* %30, align 32
  %32 = fmul float %26, %31
  %33 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %34 = load float, float* %33, align 32
  %35 = fadd float %34, %32
  store float %35, float* %33, align 32
  br label %rolled.reg.bb2

rolled.reg.bb5:                                   ; preds = %rolled.reg.bb3
  %36 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %37 = load float, float* %36, align 32
  br label %rolled.reg.bb2

rolled.reg.exit:                                  ; preds = %rolled.reg.bb2
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !134
}
...
rolled.reg.loop:                                  ; preds = %for.body5, %rolled.reg.latch
  %0 = phi i8 [ 0, %for.body5 ], [ %17, %rolled.reg.latch ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  %4 = load float, float* %3, align 32
...
rolled.reg.bb1:                                   ; preds = %rolled.reg.loop
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %7 = load float, float* %6, align 32
  %8 = fcmp ogt float %7, %4
  br i1 %8, label %rolled.reg.bb2, label %rolled.reg.latch

rolled.reg.bb2:                                   ; preds = %rolled.reg.bb1
  %9 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %10 = load float, float* %9, align 32
  %11 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %2
  %12 = load float, float* %11, align 32
  %13 = fmul float %10, %12
  %14 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %15 = load float, float* %14, align 32
  %16 = fadd float %15, %13
  store float %16, float* %14, align 32
  br label %rolled.reg.latch

rolled.reg.latch:                                 ; preds = %rolled.reg.loop, %rolled.reg.bb1, %rolled.reg.bb2
  %17 = add i8 %0, 1
  %18 = icmp ne i8 %17, 5
  br i1 %18, label %rolled.reg.loop, label %rolled.reg.exit

rolled.reg.exit:                                  ; preds = %rolled.reg.latch
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !135
}
...
rolled.reg.loop:                                  ; preds = %for.body5, %rolled.reg.latch
  %3 = phi i8 [ 0, %for.body5 ], [ %31, %rolled.reg.latch ]
  %4 = zext i8 %3 to i64
  %5 = or i64 %indvars.iv, %4
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %5
  %7 = load float, float* %6, align 32
  %8 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %5
  %9 = load float, float* %8, align 32
...
rolled.reg.bb1:                                   ; preds = %rolled.reg.loop
  ...
  %13 = fmul float %9, %12
  %14 = fadd float %7, %13
  store float %14, float* %6, align 32
  %15 = fmul float %12, %12
  %16 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %5
  %17 = load float, float* %16, align 32
  %18 = fadd float %15, %17
  store float %18, float* %16, align 32
  br label %rolled.reg.latch
...
rolled.reg.bb3:                                   ; preds = %rolled.reg.loop
  %19 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %5
  %20 = load float, float* %19, align 32
  %21 = fmul float %20, %20
  %22 = fadd float %7, %21
  store float %22, float* %8, align 32
  br i1 %cmp33, label %rolled.reg.bb4, label %rolled.reg.bb5

rolled.reg.bb4:                                   ; preds = %rolled.reg.bb3
  %23 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %5
  %24 = load float, float* %23, align 32
  %25 = fmul float %24, %24
  %26 = fadd float %7, %25
  %27 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %5
  store float %26, float* %27, align 32
  br label %rolled.reg.latch

rolled.reg.bb5:                                   ; preds = %rolled.reg.bb3
  %28 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %5
  %29 = load float, float* %28, align 32
  %30 = fadd float %21, %29
  store float %30, float* %28, align 32
  br label %rolled.reg.latch

rolled.reg.latch:                                 ; preds = %rolled.reg.bb1, %rolled.reg.bb4, %rolled.reg.bb5
  %31 = add i8 %3, 1
  %32 = icmp ne i8 %31, 7
  br i1 %32, label %rolled.reg.loop, label %rolled.reg.exit

rolled.reg.exit:                                  ; preds = %rolled.reg.latch
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !136
}
...
rolled.reg.exit:                                  ; preds = %rolled.reg.latch
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !137
}
...
rolled.reg.bb1:                                   ; preds = %rolled.reg.loop
  %8 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %9 = load float, float* %8, align 32
  %10 = fmul float %6, %9
  %11 = fadd float %4, %10
  store float %11, float* %3, align 32
...
rolled.reg.exit:                                  ; preds = %rolled.reg.latch
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !138
}
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  ...
  %9 = load float, float* %8, align 1
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %7
  %11 = load float, float* %10, align 1
  %12 = fmul float %9, %11
  %13 = fadd float %6, %12
  %14 = fadd float %13, -1.000000e+00
  %15 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %7
  store float %14, float* %15, align 1
  store float %13, float* %8, align 1
  %16 = add i8 %0, 1
  %17 = icmp ne i8 %16, 8
  br i1 %17, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %18 = add nuw nsw i64 %indvars.iv, 8
  %19 = icmp eq i64 %18, 32000
  br i1 %19, label %for.cond.cleanup4, label %for.body5, !llvm.loop !139
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %20, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %18, %rolled.loop ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %4 = load float, float* %3, align 1
  ...
  %12 = fmul float %9, %11
  %13 = fadd float %7, %12
  %14 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %2
  %15 = load float, float* %14, align 1
  %16 = fadd float %15, %13
  %17 = fadd float %16, -1.000000e+00
  store float %17, float* %8, align 1
  store float %16, float* %3, align 1
  %18 = add i8 %0, 1
  %19 = icmp ne i8 %18, 8
  br i1 %19, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  br i1 %21, label %for.cond.cleanup4, label %for.body5, !llvm.loop !140
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %31, %rolled.exit ]
  %im1.025 = phi i64 [ 31999, %for.cond2.preheader ], [ %30, %rolled.exit ]
  %2 = alloca i64, i8 8, align 8
  %3 = getelementptr i64, i64* %2, i8 0
  store i64 %im1.025, i64* %3, align 8
  %4 = getelementptr i64, i64* %2, i8 1
  store i64 %indvars.iv, i64* %4, align 8
  %5 = getelementptr i64, i64* %2, i8 2
  store i64 %indvars.iv, i64* %5, align 8
  %6 = getelementptr i64, i64* %2, i8 3
  store i64 %indvars.iv, i64* %6, align 8
  %7 = getelementptr i64, i64* %2, i8 4
  store i64 %indvars.iv, i64* %7, align 8
  %8 = getelementptr i64, i64* %2, i8 5
  store i64 %indvars.iv, i64* %8, align 8
  %9 = getelementptr i64, i64* %2, i8 6
  store i64 %indvars.iv, i64* %9, align 8
  %10 = getelementptr i64, i64* %2, i8 7
  store i64 %indvars.iv, i64* %10, align 8
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %11 = phi i8 [ 0, %for.body5 ], [ %28, %rolled.loop ]
  %12 = zext i8 %11 to i64
  %13 = or i64 %indvars.iv, %12
  %14 = getelementptr i64, i64* %0, i8 %11
  store i64 %13, i64* %14, align 8
  %15 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %13
  %16 = load float, float* %15, align 1
  %17 = getelementptr i64, i64* %2, i8 %11
  %18 = load i64, i64* %17, align 8
  %19 = getelementptr [8 x i64], [8 x i64]* @2, i8 0, i8 %11
  ...
  %27 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %13
  store float %26, float* %27, align 1
  %28 = add i8 %11, 1
  %29 = icmp ne i8 %28, 8
  br i1 %29, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %31 = add nuw nsw i64 %indvars.iv, 8
  %32 = icmp eq i64 %31, 32000
  br i1 %32, label %for.cond.cleanup4, label %for.body5, !llvm.loop !141
}
...
entry:
  ...
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  %2 = getelementptr i64, i64* %1, i8 7
  %3 = getelementptr float, float* %0, i8 7
  br label %for.cond2.preheader

for.cond2.preheader:                              ; preds = %for.cond.cleanup4, %entry
  %nl.034 = phi i32 [ 0, %entry ], [ %inc15, %for.cond.cleanup4 ]
  %.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 31998), align 8, !tbaa !6
  br label %for.body5
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %4 = phi float [ %.pre, %for.cond2.preheader ], [ %37, %rolled.exit ]
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %38, %rolled.exit ]
  %im1.031 = phi i64 [ 31999, %for.cond2.preheader ], [ %36, %rolled.exit ]
  %5 = alloca i64, i8 8, align 8
  %6 = getelementptr i64, i64* %5, i8 0
  store i64 %im1.031, i64* %6, align 8
  %7 = getelementptr i64, i64* %5, i8 1
  store i64 %indvars.iv, i64* %7, align 8
  %8 = getelementptr i64, i64* %5, i8 2
  store i64 %indvars.iv, i64* %8, align 8
  %9 = getelementptr i64, i64* %5, i8 3
  store i64 %indvars.iv, i64* %9, align 8
  %10 = getelementptr i64, i64* %5, i8 4
  store i64 %indvars.iv, i64* %10, align 8
  %11 = getelementptr i64, i64* %5, i8 5
  store i64 %indvars.iv, i64* %11, align 8
  %12 = getelementptr i64, i64* %5, i8 6
  store i64 %indvars.iv, i64* %12, align 8
  %13 = getelementptr i64, i64* %5, i8 7
  store i64 %indvars.iv, i64* %13, align 8
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %14 = phi i8 [ 0, %for.body5 ], [ %34, %rolled.loop ]
  %15 = phi float [ %4, %for.body5 ], [ %28, %rolled.loop ]
  %16 = zext i8 %14 to i64
  %17 = or i64 %indvars.iv, %16
  %18 = getelementptr i64, i64* %1, i8 %14
  store i64 %17, i64* %18, align 8
  %19 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %17
  %20 = load float, float* %19, align 1
  %21 = getelementptr i64, i64* %5, i8 %14
  %22 = load i64, i64* %21, align 8
  %23 = getelementptr [8 x i64], [8 x i64]* @3, i8 0, i8 %14
  %24 = load i64, i64* %23, align 8
  %25 = or i64 %22, %24
  %26 = and i64 %25, %24
  %27 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %26
  %28 = load float, float* %27, align 1
  %29 = getelementptr float, float* %0, i8 %14
  store float %28, float* %29, align 4
  %30 = fadd float %20, %28
  %31 = fadd float %30, %15
  %32 = fmul float %31, 0x3FD54FDF40000000
  %33 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %17
  store float %32, float* %33, align 1
  %34 = add i8 %14, 1
  %35 = icmp ne i8 %34, 8
  br i1 %35, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %38 = add nuw nsw i64 %indvars.iv, 8
  %39 = icmp eq i64 %38, 32000
  br i1 %39, label %for.cond.cleanup4, label %for.body5, !llvm.loop !142
}
...
for.body5:                                        ; preds = %for.body5, %for.cond2.preheader
  ...
  %0 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !6
  %arrayidx = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  store float %0, float* %arrayidx, align 32, !tbaa !6
  %indvars.iv.next = or i64 %indvars.iv, 1
  %1 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !6
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  store float %1, float* %arrayidx.1, align 4, !tbaa !6
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.1
  store float %1, float* %arrayidx.2, align 8, !tbaa !6
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  %2 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !6
  %arrayidx.3 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.2
  store float %2, float* %arrayidx.3, align 4, !tbaa !6
  %indvars.iv.next.3 = or i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.3
  store float %2, float* %arrayidx.4, align 16, !tbaa !6
  %indvars.iv.next.4 = or i64 %indvars.iv, 5
  %3 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !6
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.4
  store float %3, float* %arrayidx.5, align 4, !tbaa !6
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.5
  store float %3, float* %arrayidx.6, align 8, !tbaa !6
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
  %4 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !6
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6
  store float %4, float* %arrayidx.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !143
}
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  ...
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 %2, i64 %2
  %4 = load float, float* %3, align 1
  %5 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 %2, i64 %2
  %6 = load float, float* %5, align 1
  %7 = fmul float %4, %6
  %8 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %2, i64 %2
  %9 = load float, float* %8, align 1
  %10 = fadd float %9, %7
  store float %10, float* %8, align 1
  %11 = add i8 %0, 1
  %12 = icmp ne i8 %11, 8
  br i1 %12, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %13 = add nuw nsw i64 %indvars.iv, 8
  %14 = icmp eq i64 %13, 256
  br i1 %14, label %for.cond.cleanup4, label %for.body5, !llvm.loop !144
}
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond41.not, label %for.cond.cleanup, label %for.cond2.preheader

for.cond.cleanup8:                                ; preds = %rolled.exit
  %arrayidx15 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv39, i64 %indvars.iv39
  store float 1.000000e+00, float* %arrayidx15, align 4, !tbaa !6
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next40, 256
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.cond6.preheader

for.body9:                                        ; preds = %rolled.exit, %for.cond6.preheader
  %indvars.iv = phi i64 [ 0, %for.cond6.preheader ], [ %6, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body9, %rolled.loop
  %0 = phi i8 [ 0, %for.body9 ], [ %4, %rolled.loop ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %2, i64 %indvars.iv39
  store float 0.000000e+00, float* %3, align 1
  %4 = add i8 %0, 1
  %5 = icmp ne i8 %4, 8
  br i1 %5, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %6 = add nuw nsw i64 %indvars.iv, 8
  %7 = icmp eq i64 %6, 256
  br i1 %7, label %for.cond.cleanup8, label %for.body9, !llvm.loop !145
}
...
for.body9:                                        ; preds = %for.body9.7, %for.cond6.preheader
  ...
  %2 = load float, float* %arrayidx16, align 4, !tbaa !6
  %add = fadd float %1, %2
  ...
  store float %conv17.6, float* %arrayidx21.6, align 4, !tbaa !6
  %indvars.iv.next.6 = add nuw nsw i64 %indvars.iv, 7
  %exitcond.6.not = icmp eq i64 %indvars.iv.next.6, 256
  br i1 %exitcond.6.not, label %for.cond.cleanup8, label %for.body9.7, !llvm.loop !146
...
for.body9.7:                                      ; preds = %for.body9
  ...
  %9 = load float, float* %arrayidx16.7, align 4, !tbaa !6
  ...
  store float %conv17.7, float* %arrayidx21.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body9, !llvm.loop !147
}
...
for.cond.cleanup4:                                ; preds = %rolled.exit
  %.lcssa.lcssa = phi float [ %.lcssa, %rolled.exit ]
  %call6 = tail call i32 @dummy(float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @d, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @e, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 0), float %.lcssa.lcssa) #11
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %9, %rolled.exit ]
  %sum.020 = phi float [ 0.000000e+00, %for.cond2.preheader ], [ %.lcssa, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %7, %rolled.loop ]
  %1 = phi float [ %6, %rolled.loop ], [ %sum.020, %for.body5 ]
  %2 = zext i8 %0 to i64
  %3 = or i64 %indvars.iv, %2
  %4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %3
  %5 = load float, float* %4, align 1
  %6 = fadd float %1, %5
  %7 = add i8 %0, 1
  %8 = icmp ne i8 %7, 8
...
rolled.exit:                                      ; preds = %rolled.loop
  %.lcssa = phi float [ %6, %rolled.loop ]
  %9 = add nuw nsw i64 %indvars.iv, 8
  %10 = icmp eq i64 %9, 32000
  br i1 %10, label %for.cond.cleanup4, label %for.body5, !llvm.loop !148
}
...
for.body.i:                                       ; preds = %for.body.i, %for.body.i.preheader
  ...
  %0 = load float, float* %arrayidx.i, align 4, !tbaa !6
  %add.i = fadd float %s.06.i, %0
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 4
  br i1 %exitcond.not.i, label %for.body.i86.preheader, label %for.body.i
...
for.body.i86:                                     ; preds = %for.body.i86.preheader, %for.body.i86
  ...
  %1 = load float, float* %arrayidx.i82, align 4, !tbaa !6
  ...
  br i1 %exitcond.not.i85, label %test.exit87, label %for.body.i86
...
for.body.i78:                                     ; preds = %for.body.i78, %test.exit87
  ...
  %2 = load float, float* %arrayidx.i74, align 4, !tbaa !6
  ...
  br i1 %exitcond.not.i77, label %test.exit79, label %for.body.i78
...
for.body.i70:                                     ; preds = %for.body.i70, %test.exit79
  ...
  %3 = load float, float* %arrayidx.i66, align 4, !tbaa !6
  ...
  br i1 %exitcond.not.i69, label %test.exit71, label %for.body.i70
...
for.body.i62:                                     ; preds = %for.body.i62, %test.exit71
  ...
  %4 = load float, float* %arrayidx.i58, align 4, !tbaa !6
  ...
  br i1 %exitcond.not.i61, label %test.exit63, label %for.body.i62
...
for.body.i54:                                     ; preds = %for.body.i54, %test.exit63
  ...
  %5 = load float, float* %arrayidx.i50, align 4, !tbaa !6
  ...
  br i1 %exitcond.not.i53, label %test.exit55, label %for.body.i54
...
for.body.i46:                                     ; preds = %for.body.i46, %test.exit55
  ...
  %6 = load float, float* %arrayidx.i42, align 4, !tbaa !6
  ...
  br i1 %exitcond.not.i45, label %test.exit47, label %for.body.i46
...
for.body.i38:                                     ; preds = %for.body.i38, %test.exit47
  ...
  %7 = load float, float* %arrayidx.i34, align 4, !tbaa !6
  ...
  br i1 %exitcond.not.i37, label %test.exit39, label %for.body.i38
...
test.exit39:                                      ; preds = %for.body.i38
  ...
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body.i.preheader, !llvm.loop !149
}
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup4
  %.lcssa.lcssa.lcssa = phi float [ %.lcssa.lcssa, %for.cond.cleanup4 ]
  %t2 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 1
  %call10 = tail call i32 @gettimeofday(%struct.timeval* nonnull %t2, i8* null) #11
  ret float %.lcssa.lcssa.lcssa
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %9, %rolled.exit ]
  %prod.120 = phi float [ 1.000000e+00, %for.cond2.preheader ], [ %.lcssa, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %7, %rolled.loop ]
  %1 = phi float [ %6, %rolled.loop ], [ %prod.120, %for.body5 ]
  %2 = zext i8 %0 to i64
  %3 = or i64 %indvars.iv, %2
  %4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %3
  %5 = load float, float* %4, align 1
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %9 = add nuw nsw i64 %indvars.iv, 8
  %10 = icmp eq i64 %9, 32000
  br i1 %10, label %for.cond.cleanup4, label %for.body5, !llvm.loop !150
}
...
for.cond.cleanup4:                                ; preds = %rolled.exit
  %.lcssa.lcssa = phi float [ %.lcssa, %rolled.exit ]
  %call8 = tail call i32 @dummy(float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @d, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @e, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 0), float %.lcssa.lcssa) #11
  %inc10 = add nuw nsw i32 %nl.025, 1
  %exitcond.not = icmp eq i32 %inc10, 500000
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.cond2.preheader

for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %12, %rolled.exit ]
  %dot.123 = phi float [ 0.000000e+00, %for.cond2.preheader ], [ %.lcssa, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %10, %rolled.loop ]
  %1 = phi float [ %9, %rolled.loop ], [ %dot.123, %for.body5 ]
  %2 = zext i8 %0 to i64
  %3 = or i64 %indvars.iv, %2
  %4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %3
  %5 = load float, float* %4, align 1
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %3
  %7 = load float, float* %6, align 1
  %8 = fmul float %5, %7
  %9 = fadd float %1, %8
  %10 = add i8 %0, 1
...
rolled.exit:                                      ; preds = %rolled.loop
  %.lcssa = phi float [ %9, %rolled.loop ]
  %12 = add nuw nsw i64 %indvars.iv, 8
  %13 = icmp eq i64 %12, 32000
  br i1 %13, label %for.cond.cleanup4, label %for.body5, !llvm.loop !151
}
...
for.cond.cleanup4:                                ; preds = %rolled.exit
  %.lcssa.lcssa = phi float [ %.lcssa, %rolled.exit ]
  %call9 = tail call i32 @dummy(float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @d, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @e, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 0), float %.lcssa.lcssa) #11
...
for.body5:                                        ; preds = %for.body5.for.body5_crit_edge, %for.body
  ...
  %indvars.iv = phi i64 [ 0, %for.body ], [ %14, %for.body5.for.body5_crit_edge ]
  %x.124 = phi float [ %0, %for.body ], [ %.lcssa, %for.body5.for.body5_crit_edge ]
  %cmp6 = fcmp ogt float %1, %x.124
  %x.2 = select i1 %cmp6, float %1, float %x.124
  br label %rolled.loop

for.body5.for.body5_crit_edge:                    ; preds = %rolled.exit
  %arrayidx.phi.trans.insert = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %14
  %.pre = load float, float* %arrayidx.phi.trans.insert, align 32, !tbaa !6
  br label %for.body5

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %2 = phi i8 [ 0, %for.body5 ], [ %12, %rolled.loop ]
  %3 = phi float [ %11, %rolled.loop ], [ %x.2, %for.body5 ]
  %4 = zext i8 %2 to i64
  %5 = mul i64 %4, -1
  %6 = add i64 %5, 7
  %7 = or i64 %indvars.iv, %6
  ...
  %9 = load float, float* %8, align 1
  %10 = fcmp ogt float %9, %3
  %11 = select i1 %10, float %9, float %3
  %12 = add i8 %2, 1
  %13 = icmp ne i8 %12, 7
  br i1 %13, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %.lcssa = phi float [ %11, %rolled.loop ]
  %14 = add nuw nsw i64 %indvars.iv, 8
  %15 = icmp eq i64 %14, 32000
  br i1 %15, label %for.cond.cleanup4, label %for.body5.for.body5_crit_edge, !llvm.loop !152
}
...
for.body:                                         ; preds = %for.body, %entry
  ...
  br i1 %exitcond57.not, label %for.body6.preheader, label %for.body
...
for.body12:                                       ; preds = %for.body12.for.body12_crit_edge, %for.body6
  ...
  %15 = load float, float* %arrayidx14.6, align 8, !tbaa !6
  ...
  %17 = load float, float* %arrayidx14.7, align 4, !tbaa !6
  ...
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup11, label %for.body12.for.body12_crit_edge, !llvm.loop !153
...
for.body12.for.body12_crit_edge:                  ; preds = %for.body12
  ...
  %.pre = load float, float* %arrayidx14.phi.trans.insert, align 32, !tbaa !6
  br label %for.body12
}
...
for.body5:                                        ; preds = %for.body5.7, %for.body
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.1
  %3 = load float, float* %arrayidx.2, align 4, !tbaa !6
  ...
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.3
  %5 = load float, float* %arrayidx.4, align 4, !tbaa !6
  ...
  %indvars.iv.next.5 = add nuw nsw i64 %indvars.iv, 6
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.5
  %7 = load float, float* %arrayidx.6, align 4, !tbaa !6
  %cmp6.6 = fcmp olt float %7, %x.2.5
  %x.2.6 = select i1 %cmp6.6, float %7, float %x.2.5
  %indvars.iv.next.6 = add nuw nsw i64 %indvars.iv, 7
  %exitcond.6.not = icmp eq i64 %indvars.iv.next.6, 32000
  br i1 %exitcond.6.not, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !154
...
for.body5.7:                                      ; preds = %for.body5
  ...
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !155
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %i.020 = phi i32 [ 0, %for.cond2.preheader ], [ %5, %rolled.exit ]
  %q.119 = phi float [ 1.000000e+00, %for.cond2.preheader ], [ %.lcssa, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %3, %rolled.loop ]
  %1 = phi float [ %2, %rolled.loop ], [ %q.119, %for.body5 ]
...
rolled.exit:                                      ; preds = %rolled.loop
  %.lcssa = phi float [ %2, %rolled.loop ]
  %5 = add nuw nsw i32 %i.020, 8
  %6 = icmp eq i32 %5, 16000
  br i1 %6, label %for.cond.cleanup4, label %for.body5, !llvm.loop !156
}
...
for.body:                                         ; preds = %for.cond.cleanup4, %entry
  ...
  %6 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !6
...
for.body5:                                        ; preds = %for.body5.7, %for.body
  %indvars.iv = phi i64 [ %5, %for.body ], [ %indvars.iv.next.7, %for.body5.7 ]
  %i.042 = phi i32 [ 1, %for.body ], [ %inc10.7, %for.body5.7 ]
  %max.140 = phi float [ %7, %for.body ], [ %max.2.7, %for.body5.7 ]
  %index.139 = phi i32 [ 0, %for.body ], [ %index.2.7, %for.body5.7 ]
  %arrayidx = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  %8 = load float, float* %arrayidx, align 4, !tbaa !6
  %9 = tail call float @llvm.fabs.f32(float %8)
  %cmp6 = fcmp ugt float %9, %max.140
  %index.2 = select i1 %cmp6, i32 %i.042, i32 %index.139
  %max.2 = select i1 %cmp6, float %9, float %max.140
  %indvars.iv.next = add i64 %indvars.iv, %5
  %inc10 = add nuw nsw i32 %i.042, 1
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  %10 = load float, float* %arrayidx.1, align 4, !tbaa !6
  %11 = tail call float @llvm.fabs.f32(float %10)
  %cmp6.1 = fcmp ugt float %11, %max.2
  %index.2.1 = select i1 %cmp6.1, i32 %inc10, i32 %index.2
  %max.2.1 = select i1 %cmp6.1, float %11, float %max.2
  %indvars.iv.next.1 = add i64 %indvars.iv.next, %5
  %inc10.1 = add nuw nsw i32 %i.042, 2
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.1
  %12 = load float, float* %arrayidx.2, align 4, !tbaa !6
  %13 = tail call float @llvm.fabs.f32(float %12)
  %cmp6.2 = fcmp ugt float %13, %max.2.1
  %index.2.2 = select i1 %cmp6.2, i32 %inc10.1, i32 %index.2.1
  %max.2.2 = select i1 %cmp6.2, float %13, float %max.2.1
  %indvars.iv.next.2 = add i64 %indvars.iv.next.1, %5
  %inc10.2 = add nuw nsw i32 %i.042, 3
  %arrayidx.3 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.2
  %14 = load float, float* %arrayidx.3, align 4, !tbaa !6
  %15 = tail call float @llvm.fabs.f32(float %14)
  %cmp6.3 = fcmp ugt float %15, %max.2.2
  %index.2.3 = select i1 %cmp6.3, i32 %inc10.2, i32 %index.2.2
  %max.2.3 = select i1 %cmp6.3, float %15, float %max.2.2
  %indvars.iv.next.3 = add i64 %indvars.iv.next.2, %5
  %inc10.3 = add nuw nsw i32 %i.042, 4
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.3
  %16 = load float, float* %arrayidx.4, align 4, !tbaa !6
  %17 = tail call float @llvm.fabs.f32(float %16)
  %cmp6.4 = fcmp ugt float %17, %max.2.3
  %index.2.4 = select i1 %cmp6.4, i32 %inc10.3, i32 %index.2.3
  %max.2.4 = select i1 %cmp6.4, float %17, float %max.2.3
  %indvars.iv.next.4 = add i64 %indvars.iv.next.3, %5
  %inc10.4 = add nuw nsw i32 %i.042, 5
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.4
  %18 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %19 = tail call float @llvm.fabs.f32(float %18)
  %cmp6.5 = fcmp ugt float %19, %max.2.4
  %index.2.5 = select i1 %cmp6.5, i32 %inc10.4, i32 %index.2.4
  %max.2.5 = select i1 %cmp6.5, float %19, float %max.2.4
  %indvars.iv.next.5 = add i64 %indvars.iv.next.4, %5
  %inc10.5 = add nuw nsw i32 %i.042, 6
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.5
  %20 = load float, float* %arrayidx.6, align 4, !tbaa !6
  %21 = tail call float @llvm.fabs.f32(float %20)
  %cmp6.6 = fcmp ugt float %21, %max.2.5
  %index.2.6 = select i1 %cmp6.6, i32 %inc10.5, i32 %index.2.5
  %max.2.6 = select i1 %cmp6.6, float %21, float %max.2.5
  %indvars.iv.next.6 = add i64 %indvars.iv.next.5, %5
  %inc10.6 = add nuw nsw i32 %i.042, 7
  %exitcond.6.not = icmp eq i32 %inc10.6, 32000
  br i1 %exitcond.6.not, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !157

for.body5.7:                                      ; preds = %for.body5
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6
  %22 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %23 = tail call float @llvm.fabs.f32(float %22)
  %cmp6.7 = fcmp ugt float %23, %max.2.6
  %index.2.7 = select i1 %cmp6.7, i32 %inc10.6, i32 %index.2.6
  %max.2.7 = select i1 %cmp6.7, float %23, float %max.2.6
  %indvars.iv.next.7 = add i64 %indvars.iv.next.6, %5
  %inc10.7 = add nuw nsw i32 %i.042, 8
  br label %for.body5, !llvm.loop !158
}
...
entry:
  %0 = alloca float, i8 8, align 4
  %1 = alloca float, i8 8, align 4
  %call = tail call i32 @initialise_arrays(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.s319, i64 0, i64 0)) #11
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  %2 = getelementptr float, float* %1, i8 0
  %3 = getelementptr float, float* %1, i8 1
  %4 = getelementptr float, float* %1, i8 2
  %5 = getelementptr float, float* %1, i8 3
  %6 = getelementptr float, float* %1, i8 4
  %7 = getelementptr float, float* %1, i8 5
  %8 = getelementptr float, float* %1, i8 6
  %9 = getelementptr float, float* %1, i8 7
  %10 = getelementptr float, float* %0, i8 0
  %11 = getelementptr float, float* %0, i8 1
  %12 = getelementptr float, float* %0, i8 2
  %13 = getelementptr float, float* %0, i8 3
  %14 = getelementptr float, float* %0, i8 4
  %15 = getelementptr float, float* %0, i8 5
  %16 = getelementptr float, float* %0, i8 6
  %17 = getelementptr float, float* %0, i8 7
  br label %for.cond2.preheader
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup4
  %.lcssa.lcssa = phi float [ %.lcssa, %for.cond.cleanup4 ]
  %t2 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 1
  %call27 = tail call i32 @gettimeofday(%struct.timeval* nonnull %t2, i8* null) #11
  ret float %.lcssa.lcssa

for.cond.cleanup4:                                ; preds = %rolled.exit
  %.lcssa = phi float [ %66, %rolled.exit ]
  %call23 = tail call i32 @dummy(float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @d, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @e, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 0), float %.lcssa) #11
  %inc25 = add nuw nsw i32 %nl.047, 1
  %exitcond.not = icmp eq i32 %inc25, 200000
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.cond2.preheader

for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %67, %rolled.exit ]
  %sum.145 = phi float [ 0.000000e+00, %for.cond2.preheader ], [ %66, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %18 = phi i8 [ 0, %for.body5 ], [ %33, %rolled.loop ]
  %19 = zext i8 %18 to i64
  %20 = or i64 %indvars.iv, %19
  %21 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %20
  %22 = load float, float* %21, align 1
  %23 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %20
  %24 = load float, float* %23, align 1
  %25 = fadd float %22, %24
  %26 = getelementptr float, float* %1, i8 %18
  store float %25, float* %26, align 4
  %27 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %20
  store float %25, float* %27, align 1
  %28 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %20
  %29 = load float, float* %28, align 1
  %30 = fadd float %22, %29
  %31 = getelementptr float, float* %0, i8 %18
  store float %30, float* %31, align 4
  %32 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %20
  store float %30, float* %32, align 1
  %33 = add i8 %18, 1
  %34 = icmp ne i8 %33, 8
  br i1 %34, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  br i1 %68, label %for.cond.cleanup4, label %for.body5, !llvm.loop !159
}

; Function Attrs: nounwind optsize uwtable
define dso_local float @s3110(%struct.args_t* nocapture %func_args) #0 {
entry:
  %0 = alloca float, i8 2, align 4
...
for.body:                                         ; preds = %for.cond.cleanup4, %entry
  ...
  %1 = load float, float* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0, i64 0), align 64, !tbaa !6
  br label %for.cond6.preheader
...
for.cond6.preheader:                              ; preds = %for.cond.cleanup8, %for.body
  ...
  %max.159 = phi float [ %1, %for.body ], [ %max.3.7.lcssa, %for.cond.cleanup8 ]
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond65.not, label %for.cond.cleanup, label %for.body
...
for.body9:                                        ; preds = %for.body9, %for.cond6.preheader
  ...
  %3 = load float, float* %arrayidx11, align 32, !tbaa !6
  %cmp12 = fcmp ogt float %3, %max.255
  %4 = trunc i64 %indvars.iv to i32
  %yindex.3 = select i1 %cmp12, i32 %4, i32 %yindex.254
  %max.3 = select i1 %cmp12, float %3, float %max.255
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx11.1 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv63, i64 %indvars.iv.next
  %5 = load float, float* %arrayidx11.1, align 4, !tbaa !6
  %cmp12.1 = fcmp ogt float %5, %max.3
  %6 = trunc i64 %indvars.iv.next to i32
  %yindex.3.1 = select i1 %cmp12.1, i32 %6, i32 %yindex.3
  %max.3.1 = select i1 %cmp12.1, float %5, float %max.3
  %7 = or i1 %cmp12.1, %cmp12
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  %arrayidx11.2 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv63, i64 %indvars.iv.next.1
  %8 = load float, float* %arrayidx11.2, align 8, !tbaa !6
  %cmp12.2 = fcmp ogt float %8, %max.3.1
  %9 = trunc i64 %indvars.iv.next.1 to i32
  %yindex.3.2 = select i1 %cmp12.2, i32 %9, i32 %yindex.3.1
  %max.3.2 = select i1 %cmp12.2, float %8, float %max.3.1
  %10 = or i1 %cmp12.2, %7
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  %arrayidx11.3 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv63, i64 %indvars.iv.next.2
  %11 = load float, float* %arrayidx11.3, align 4, !tbaa !6
  %cmp12.3 = fcmp ogt float %11, %max.3.2
  %12 = trunc i64 %indvars.iv.next.2 to i32
  %yindex.3.3 = select i1 %cmp12.3, i32 %12, i32 %yindex.3.2
  %max.3.3 = select i1 %cmp12.3, float %11, float %max.3.2
  %13 = or i1 %cmp12.3, %10
  %indvars.iv.next.3 = or i64 %indvars.iv, 4
  %arrayidx11.4 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv63, i64 %indvars.iv.next.3
  %14 = load float, float* %arrayidx11.4, align 16, !tbaa !6
  %cmp12.4 = fcmp ogt float %14, %max.3.3
  %15 = trunc i64 %indvars.iv.next.3 to i32
  %yindex.3.4 = select i1 %cmp12.4, i32 %15, i32 %yindex.3.3
  %max.3.4 = select i1 %cmp12.4, float %14, float %max.3.3
  %16 = or i1 %cmp12.4, %13
  %indvars.iv.next.4 = or i64 %indvars.iv, 5
  %arrayidx11.5 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv63, i64 %indvars.iv.next.4
  %17 = load float, float* %arrayidx11.5, align 4, !tbaa !6
  %cmp12.5 = fcmp ogt float %17, %max.3.4
  %18 = trunc i64 %indvars.iv.next.4 to i32
  %yindex.3.5 = select i1 %cmp12.5, i32 %18, i32 %yindex.3.4
  %max.3.5 = select i1 %cmp12.5, float %17, float %max.3.4
  %19 = or i1 %cmp12.5, %16
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
  %arrayidx11.6 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv63, i64 %indvars.iv.next.5
  %20 = load float, float* %arrayidx11.6, align 8, !tbaa !6
  %cmp12.6 = fcmp ogt float %20, %max.3.5
  %21 = trunc i64 %indvars.iv.next.5 to i32
  %yindex.3.6 = select i1 %cmp12.6, i32 %21, i32 %yindex.3.5
  %max.3.6 = select i1 %cmp12.6, float %20, float %max.3.5
  %22 = or i1 %cmp12.6, %19
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
  %arrayidx11.7 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv63, i64 %indvars.iv.next.6
  %23 = load float, float* %arrayidx11.7, align 4, !tbaa !6
  %cmp12.7 = fcmp ogt float %23, %max.3.6
  %24 = trunc i64 %indvars.iv.next.6 to i32
  ...
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 256
  br i1 %exitcond.7.not, label %for.cond.cleanup8, label %for.body9, !llvm.loop !160
}
...
for.body9:                                        ; preds = %for.body9, %for.cond6.preheader
  ...
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 256
  br i1 %exitcond.7.not, label %for.cond.cleanup8, label %for.body9, !llvm.loop !161
}
...
for.body5:                                        ; preds = %for.body5, %for.cond2.preheader
  ...
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !162
}
...
for.cond.cleanup4:                                ; preds = %rolled.exit
  %.lcssa = phi float [ %13, %rolled.exit ]
  %call8 = tail call i32 @dummy(float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @d, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @e, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 0), float %.lcssa) #11
  %inc10 = add nuw nsw i32 %nl.026, 1
  %exitcond.not = icmp eq i32 %inc10, 100000
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.cond2.preheader

for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %14, %rolled.exit ]
  %sum.124 = phi float [ 0.000000e+00, %for.cond2.preheader ], [ %13, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %2 = phi i8 [ 0, %for.body5 ], [ %11, %rolled.loop ]
  %3 = phi float [ %sum.124, %for.body5 ], [ %8, %rolled.loop ]
  %4 = zext i8 %2 to i64
  %5 = or i64 %indvars.iv, %4
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %5
  %7 = load float, float* %6, align 1
  %8 = fadd float %3, %7
  %9 = getelementptr float, float* %0, i8 %2
  store float %8, float* %9, align 4
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %5
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %14 = add nuw nsw i64 %indvars.iv, 8
  %15 = icmp eq i64 %14, 32000
  br i1 %15, label %for.cond.cleanup4, label %for.body5, !llvm.loop !163
}
...
for.body5:                                        ; preds = %for.body5.for.body5_crit_edge, %for.body
  ...
  %indvars.iv = phi i64 [ 0, %for.body ], [ %17, %for.body5.for.body5_crit_edge ]
  %max.124 = phi float [ %1, %for.body ], [ %.lcssa, %for.body5.for.body5_crit_edge ]
...
for.body5.for.body5_crit_edge:                    ; preds = %rolled.exit
  %arrayidx.phi.trans.insert = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %17
  %.pre = load float, float* %arrayidx.phi.trans.insert, align 32, !tbaa !6
  br label %for.body5

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %4 = phi i8 [ 0, %for.body5 ], [ %15, %rolled.loop ]
  %5 = phi float [ %14, %rolled.loop ], [ %max.2, %for.body5 ]
  %6 = zext i8 %4 to i64
  %7 = mul i64 %6, -1
  %8 = add i64 %7, 7
  %9 = or i64 %indvars.iv, %8
  ...
  %13 = fcmp ogt float %12, %5
  %14 = select i1 %13, float %12, float %5
  %15 = add i8 %4, 1
  %16 = icmp ne i8 %15, 7
  br i1 %16, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %.lcssa = phi float [ %14, %rolled.loop ]
  %17 = add nuw nsw i64 %indvars.iv, 8
  %18 = icmp eq i64 %17, 32000
  br i1 %18, label %for.cond.cleanup4, label %for.body5.for.body5_crit_edge, !llvm.loop !164
}
...
for.body5:                                        ; preds = %for.body5.7, %for.cond2.preheader
  %2 = phi float [ %.pre, %for.cond2.preheader ], [ %add.7, %for.body5.7 ]
  %indvars.iv = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next.7, %for.body5.7 ]
  br label %rolled.loop

for.body5.7:                                      ; preds = %rolled.exit
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %19
  %3 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %mul.7 = fmul float %18, %3
  %arrayidx9.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %19
  %4 = load float, float* %arrayidx9.7, align 4, !tbaa !6
  %add.7 = fadd float %4, %mul.7
  store float %add.7, float* %arrayidx9.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !165

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %5 = phi i8 [ 0, %for.body5 ], [ %16, %rolled.loop ]
  %6 = phi float [ %2, %for.body5 ], [ %14, %rolled.loop ]
  %7 = zext i8 %5 to i64
  %8 = add nuw nsw i64 %indvars.iv, %7
  %9 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %8
  %10 = load float, float* %9, align 1
  %11 = fmul float %6, %10
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %8
  %13 = load float, float* %12, align 1
  %14 = fadd float %13, %11
  %15 = getelementptr float, float* %0, i8 %5
  store float %14, float* %15, align 4
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  br i1 %20, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !166
}
...
for.cond2.preheader:                              ; preds = %for.cond.cleanup4, %entry
  ...
  %.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 1), align 4, !tbaa !6
  %.pre40 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !6
  br label %for.body5
...
for.body5:                                        ; preds = %for.body5.6, %for.cond2.preheader
  %2 = phi float [ %.pre40, %for.cond2.preheader ], [ %add16.6, %for.body5.6 ]
  %3 = phi float [ %.pre, %for.cond2.preheader ], [ %add16.7, %for.body5.6 ]
  %indvars.iv = phi i64 [ 2, %for.cond2.preheader ], [ %indvars.iv.next.7, %for.body5.6 ]
  %arrayidx = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  %4 = load float, float* %arrayidx, align 8, !tbaa !6
  %arrayidx9 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  %5 = load float, float* %arrayidx9, align 8, !tbaa !6
  %mul = fmul float %3, %5
  %add = fadd float %4, %mul
  %arrayidx14 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv
  %6 = load float, float* %arrayidx14, align 8, !tbaa !6
  %mul15 = fmul float %2, %6
  %add16 = fadd float %add, %mul15
  store float %add16, float* %arrayidx, align 8, !tbaa !6
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  %7 = load float, float* %arrayidx.1, align 4, !tbaa !6
  %arrayidx9.1 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next
  %8 = load float, float* %arrayidx9.1, align 4, !tbaa !6
  %mul.1 = fmul float %add16, %8
  %add.1 = fadd float %7, %mul.1
  %9 = add nsw i64 %indvars.iv, -1
  %arrayidx12.1 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %9
  %10 = load float, float* %arrayidx12.1, align 4, !tbaa !6
  %arrayidx14.1 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next
  %11 = load float, float* %arrayidx14.1, align 4, !tbaa !6
  %mul15.1 = fmul float %10, %11
  %add16.1 = fadd float %add.1, %mul15.1
  store float %add16.1, float* %arrayidx.1, align 4, !tbaa !6
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.1
  %12 = load float, float* %arrayidx.2, align 8, !tbaa !6
  %arrayidx9.2 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.1
  %13 = load float, float* %arrayidx9.2, align 8, !tbaa !6
  %mul.2 = fmul float %add16.1, %13
  %add.2 = fadd float %12, %mul.2
  %arrayidx14.2 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.1
  %14 = load float, float* %arrayidx14.2, align 8, !tbaa !6
  %mul15.2 = fmul float %add16, %14
  %add16.2 = fadd float %add.2, %mul15.2
  store float %add16.2, float* %arrayidx.2, align 8, !tbaa !6
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %arrayidx.3 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.2
  %15 = load float, float* %arrayidx.3, align 4, !tbaa !6
  %arrayidx9.3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.2
  %16 = load float, float* %arrayidx9.3, align 4, !tbaa !6
  %mul.3 = fmul float %add16.2, %16
  %add.3 = fadd float %15, %mul.3
  %arrayidx14.3 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.2
  %17 = load float, float* %arrayidx14.3, align 4, !tbaa !6
  %mul15.3 = fmul float %add16.1, %17
  %add16.3 = fadd float %add.3, %mul15.3
  store float %add16.3, float* %arrayidx.3, align 4, !tbaa !6
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.3
  %18 = load float, float* %arrayidx.4, align 8, !tbaa !6
  %arrayidx9.4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.3
  %19 = load float, float* %arrayidx9.4, align 8, !tbaa !6
  %mul.4 = fmul float %add16.3, %19
  %add.4 = fadd float %18, %mul.4
  %arrayidx14.4 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.3
  %20 = load float, float* %arrayidx14.4, align 8, !tbaa !6
  %mul15.4 = fmul float %add16.2, %20
  %add16.4 = fadd float %add.4, %mul15.4
  store float %add16.4, float* %arrayidx.4, align 8, !tbaa !6
  %indvars.iv.next.4 = add nuw nsw i64 %indvars.iv, 5
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.4
  %21 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %arrayidx9.5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.4
  %22 = load float, float* %arrayidx9.5, align 4, !tbaa !6
  %mul.5 = fmul float %add16.4, %22
  %add.5 = fadd float %21, %mul.5
  %arrayidx14.5 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.4
  %23 = load float, float* %arrayidx14.5, align 4, !tbaa !6
  %mul15.5 = fmul float %add16.3, %23
  %add16.5 = fadd float %add.5, %mul15.5
  store float %add16.5, float* %arrayidx.5, align 4, !tbaa !6
  %indvars.iv.next.5 = add nuw nsw i64 %indvars.iv, 6
  %exitcond.5.not = icmp eq i64 %indvars.iv.next.5, 32000
  br i1 %exitcond.5.not, label %for.cond.cleanup4, label %for.body5.6, !llvm.loop !167
...
for.body5.6:                                      ; preds = %for.body5
  ...
  %add.6 = fadd float %24, %mul.6
  %arrayidx14.6 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.5
  %26 = load float, float* %arrayidx14.6, align 8, !tbaa !6
  %mul15.6 = fmul float %add16.4, %26
  %add16.6 = fadd float %add.6, %mul15.6
  store float %add16.6, float* %arrayidx.6, align 8, !tbaa !6
  %indvars.iv.next.6 = add nuw nsw i64 %indvars.iv, 7
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6
  %27 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx9.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  %28 = load float, float* %arrayidx9.7, align 4, !tbaa !6
  %mul.7 = fmul float %add16.6, %28
  %add.7 = fadd float %27, %mul.7
  %arrayidx14.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.6
  %29 = load float, float* %arrayidx14.7, align 4, !tbaa !6
  %mul15.7 = fmul float %add16.5, %29
  %add16.7 = fadd float %add.7, %mul15.7
  store float %add16.7, float* %arrayidx.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !168
}
...
for.body5:                                        ; preds = %for.body5.7, %for.cond2.preheader
  ...
  %3 = load float, float* %arrayidx17, align 4, !tbaa !6
  ...
  store float %add19, float* %arrayidx21, align 4, !tbaa !6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx7.1 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next
  %4 = load float, float* %arrayidx7.1, align 4, !tbaa !6
  %arrayidx9.1 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next
  ...
  %6 = load float, float* %arrayidx17.1, align 4, !tbaa !6
  ...
  store float %add19.1, float* %arrayidx21.1, align 4, !tbaa !6
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx7.2 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.1
  %7 = load float, float* %arrayidx7.2, align 4, !tbaa !6
  %arrayidx9.2 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.1
  %8 = load float, float* %arrayidx9.2, align 4, !tbaa !6
  %mul.2 = fmul float %7, %8
  ...
  %9 = load float, float* %arrayidx17.2, align 4, !tbaa !6
  ...
  store float %add19.2, float* %arrayidx21.2, align 4, !tbaa !6
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %arrayidx7.3 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.2
  %10 = load float, float* %arrayidx7.3, align 4, !tbaa !6
  %arrayidx9.3 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.2
  ...
  %12 = load float, float* %arrayidx17.3, align 4, !tbaa !6
  ...
  store float %add19.3, float* %arrayidx21.3, align 4, !tbaa !6
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %arrayidx7.4 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.3
  %13 = load float, float* %arrayidx7.4, align 4, !tbaa !6
  %arrayidx9.4 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.3
  %14 = load float, float* %arrayidx9.4, align 4, !tbaa !6
  %mul.4 = fmul float %13, %14
  ...
  %15 = load float, float* %arrayidx17.4, align 4, !tbaa !6
  ...
  store float %add19.4, float* %arrayidx21.4, align 4, !tbaa !6
  %indvars.iv.next.4 = add nuw nsw i64 %indvars.iv, 5
  %arrayidx7.5 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.4
  %16 = load float, float* %arrayidx7.5, align 4, !tbaa !6
  %arrayidx9.5 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.4
  ...
  %18 = load float, float* %arrayidx17.5, align 4, !tbaa !6
  ...
  store float %add19.5, float* %arrayidx21.5, align 4, !tbaa !6
  %indvars.iv.next.5 = add nuw nsw i64 %indvars.iv, 6
  %arrayidx7.6 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.5
  %19 = load float, float* %arrayidx7.6, align 4, !tbaa !6
  %arrayidx9.6 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.5
  %20 = load float, float* %arrayidx9.6, align 4, !tbaa !6
  %mul.6 = fmul float %19, %20
  ...
  %21 = load float, float* %arrayidx17.6, align 4, !tbaa !6
  ...
  store float %add19.6, float* %arrayidx21.6, align 4, !tbaa !6
  %indvars.iv.next.6 = add nuw nsw i64 %indvars.iv, 7
  %exitcond.6.not = icmp eq i64 %indvars.iv.next.6, 32000
  br i1 %exitcond.6.not, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !169

for.body5.7:                                      ; preds = %for.body5
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.6
  %22 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %arrayidx9.7 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.next.6
  %23 = load float, float* %arrayidx9.7, align 4, !tbaa !6
  ...
  %24 = load float, float* %arrayidx17.7, align 4, !tbaa !6
  %mul18.7 = fmul float %22, %24
  %add19.7 = fadd float %add.7, %mul18.7
  %arrayidx21.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  store float %add19.7, float* %arrayidx21.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !170
}
...
for.body5:                                        ; preds = %for.body5, %for.cond2.preheader
  ...
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !171
}
...
for.body5:                                        ; preds = %for.inc.7, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next.7, %for.inc.7 ]
  %arrayidx = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  %3 = load float, float* %arrayidx, align 32, !tbaa !6
...
L20:                                              ; preds = %L20.loopexit, %L20.split.loop.exit58, %L20.split.loop.exit55, %L20.split.loop.exit52, %L20.split.loop.exit49, %L20.split.loop.exit46, %L20.split.loop.exit43, %L20.split.loop.exit40, %L20.split.loop.exit37
  ...
  %exitcond.not = icmp eq i32 %inc13, 100000
  br i1 %exitcond.not, label %cleanup14, label %for.cond2.preheader
...
for.inc.1:                                        ; preds = %for.inc
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  %arrayidx.2 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.1
  %13 = load float, float* %arrayidx.2, align 8, !tbaa !6
...
for.inc.3:                                        ; preds = %for.inc.2
  %indvars.iv.next.3 = or i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.3
  %15 = load float, float* %arrayidx.4, align 16, !tbaa !6
...
for.inc.4:                                        ; preds = %for.inc.3
  %indvars.iv.next.4 = or i64 %indvars.iv, 5
  %arrayidx.5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.4
  %16 = load float, float* %arrayidx.5, align 4, !tbaa !6
...
for.inc.5:                                        ; preds = %for.inc.4
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
  %arrayidx.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.5
  %17 = load float, float* %arrayidx.6, align 8, !tbaa !6
...
for.inc.7:                                        ; preds = %for.inc.6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %L20.loopexit, label %for.body5, !llvm.loop !172
}
...
if.then:                                          ; preds = %for.body5
  ...
  store float %0, float* %arrayidx10, align 4, !tbaa !6
  br label %for.inc
...
if.then.1:                                        ; preds = %for.inc
  ...
  store float %1, float* %arrayidx10.1, align 4, !tbaa !6
  br label %for.inc.1
...
if.then.2:                                        ; preds = %for.inc.1
  ...
  store float %2, float* %arrayidx10.2, align 4, !tbaa !6
  br label %for.inc.2
...
if.then.3:                                        ; preds = %for.inc.2
  ...
  store float %3, float* %arrayidx10.3, align 4, !tbaa !6
  br label %for.inc.3
...
if.then.4:                                        ; preds = %for.inc.3
  ...
  store float %4, float* %arrayidx10.4, align 4, !tbaa !6
  br label %for.inc.4
...
if.then.5:                                        ; preds = %for.inc.4
  ...
  store float %5, float* %arrayidx10.5, align 4, !tbaa !6
  br label %for.inc.5
...
if.then.6:                                        ; preds = %for.inc.5
  ...
  store float %6, float* %arrayidx10.6, align 4, !tbaa !6
  br label %for.inc.6
...
if.then.7:                                        ; preds = %for.inc.6
  ...
  store float %7, float* %arrayidx10.7, align 4, !tbaa !6
  br label %for.inc.7
...
for.inc.7:                                        ; preds = %if.then.7, %for.inc.6
  ...
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !173
}
...
if.then:                                          ; preds = %for.body5
  ...
  %1 = load float, float* %arrayidx8, align 4, !tbaa !6
  store float %1, float* %arrayidx, align 32, !tbaa !6
  br label %for.inc
...
if.then.1:                                        ; preds = %for.inc
  ...
  %3 = load float, float* %arrayidx8.1, align 4, !tbaa !6
  store float %3, float* %arrayidx.1, align 4, !tbaa !6
  br label %for.inc.1
...
if.then.2:                                        ; preds = %for.inc.1
  ...
  %5 = load float, float* %arrayidx8.2, align 4, !tbaa !6
  store float %5, float* %arrayidx.2, align 8, !tbaa !6
  br label %for.inc.2
...
if.then.3:                                        ; preds = %for.inc.2
  ...
  %7 = load float, float* %arrayidx8.3, align 4, !tbaa !6
  store float %7, float* %arrayidx.3, align 4, !tbaa !6
  br label %for.inc.3
...
if.then.4:                                        ; preds = %for.inc.3
  ...
  %9 = load float, float* %arrayidx8.4, align 4, !tbaa !6
  store float %9, float* %arrayidx.4, align 16, !tbaa !6
  br label %for.inc.4
...
if.then.5:                                        ; preds = %for.inc.4
  ...
  %11 = load float, float* %arrayidx8.5, align 4, !tbaa !6
  store float %11, float* %arrayidx.5, align 4, !tbaa !6
  br label %for.inc.5
...
if.then.6:                                        ; preds = %for.inc.5
  ...
  %13 = load float, float* %arrayidx8.6, align 4, !tbaa !6
  store float %13, float* %arrayidx.6, align 8, !tbaa !6
  br label %for.inc.6
...
if.then.7:                                        ; preds = %for.inc.6
  ...
  %15 = load float, float* %arrayidx8.7, align 4, !tbaa !6
  store float %15, float* %arrayidx.7, align 4, !tbaa !6
  br label %for.inc.7
...
for.inc.7:                                        ; preds = %if.then.7, %for.inc.6
  ...
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !174
}
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond49.not, label %for.cond.cleanup, label %for.cond2.preheader
...
if.then:                                          ; preds = %for.body9
  ...
  %1 = load float, float* %arrayidx16, align 4, !tbaa !6
  ...
  store float %1, float* %arrayidx18, align 4, !tbaa !6
  br label %for.inc
...
for.inc:                                          ; preds = %if.then, %for.body9
  ...
  %2 = load float, float* %arrayidx11.1, align 4, !tbaa !6
...
if.then.1:                                        ; preds = %for.inc
  ...
  store float %3, float* %arrayidx18.1, align 4, !tbaa !6
  br label %for.inc.1
...
for.inc.1:                                        ; preds = %if.then.1, %for.inc
  ...
  %4 = load float, float* %arrayidx11.2, align 4, !tbaa !6
...
if.then.2:                                        ; preds = %for.inc.1
  ...
  %5 = load float, float* %arrayidx16.2, align 4, !tbaa !6
  ...
  store float %5, float* %arrayidx18.2, align 4, !tbaa !6
  br label %for.inc.2
...
for.inc.2:                                        ; preds = %if.then.2, %for.inc.1
  ...
  %6 = load float, float* %arrayidx11.3, align 4, !tbaa !6
...
if.then.3:                                        ; preds = %for.inc.2
  ...
  %7 = load float, float* %arrayidx16.3, align 4, !tbaa !6
  ...
  store float %7, float* %arrayidx18.3, align 4, !tbaa !6
  br label %for.inc.3
...
for.inc.3:                                        ; preds = %if.then.3, %for.inc.2
  ...
  %8 = load float, float* %arrayidx11.4, align 4, !tbaa !6
...
if.then.4:                                        ; preds = %for.inc.3
  ...
  %9 = load float, float* %arrayidx16.4, align 4, !tbaa !6
  ...
  store float %9, float* %arrayidx18.4, align 4, !tbaa !6
  br label %for.inc.4
...
for.inc.4:                                        ; preds = %if.then.4, %for.inc.3
  ...
  %10 = load float, float* %arrayidx11.5, align 4, !tbaa !6
...
if.then.5:                                        ; preds = %for.inc.4
  ...
  %11 = load float, float* %arrayidx16.5, align 4, !tbaa !6
  ...
  store float %11, float* %arrayidx18.5, align 4, !tbaa !6
  br label %for.inc.5
...
for.inc.5:                                        ; preds = %if.then.5, %for.inc.4
  ...
  %12 = load float, float* %arrayidx11.6, align 4, !tbaa !6
...
if.then.6:                                        ; preds = %for.inc.5
  ...
  %13 = load float, float* %arrayidx16.6, align 4, !tbaa !6
  ...
  store float %13, float* %arrayidx18.6, align 4, !tbaa !6
  br label %for.inc.6
...
for.inc.6:                                        ; preds = %if.then.6, %for.inc.5
  ...
  %14 = load float, float* %arrayidx11.7, align 4, !tbaa !6
...
if.then.7:                                        ; preds = %for.inc.6
  ...
  %15 = load float, float* %arrayidx16.7, align 4, !tbaa !6
  ...
  store float %15, float* %arrayidx18.7, align 4, !tbaa !6
  br label %for.inc.7
...
for.inc.7:                                        ; preds = %if.then.7, %for.inc.6
  ...
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 256
  br i1 %exitcond.7.not, label %for.cond.cleanup8, label %for.body9, !llvm.loop !175
}
...
entry:
  ...
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  %0 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), align 64, !tbaa !6
  br label %for.cond2.preheader
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %1 = phi i8 [ 0, %for.body5 ], [ %10, %rolled.loop ]
  %2 = zext i8 %1 to i64
  %3 = add nuw nsw i64 %indvars.iv, %2
  %4 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %3
  %5 = load float, float* %4, align 1
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %13 = icmp ult i64 %indvars.iv, 31995
  br i1 %13, label %for.body5, label %for.cond.cleanup4, !llvm.loop !176
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %i.028 = phi i32 [ 0, %for.cond2.preheader ], [ %13, %rolled.exit ]
  %C.027 = phi float* [ getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), %for.cond2.preheader ], [ %12, %rolled.exit ]
  %B.026 = phi float* [ getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 0), %for.cond2.preheader ], [ %11, %rolled.exit ]
  %A.025 = phi float* [ getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), %for.cond2.preheader ], [ %10, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %8, %rolled.loop ]
  %1 = zext i8 %0 to i64
  %2 = getelementptr float, float* %B.026, i64 %1
  %3 = load float, float* %2, align 1
  %4 = getelementptr float, float* %C.027, i64 %1
  %5 = load float, float* %4, align 1
  %6 = fadd float %3, %5
  %7 = getelementptr float, float* %A.025, i64 %1
  store float %6, float* %7, align 1
  %8 = add i8 %0, 1
  %9 = icmp ne i8 %8, 8
  br i1 %9, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %10 = getelementptr inbounds float, float* %A.025, i64 8
  %11 = getelementptr inbounds float, float* %B.026, i64 8
  %12 = getelementptr inbounds float, float* %C.027, i64 8
  %13 = add nuw nsw i32 %i.028, 8
  %14 = icmp eq i32 %13, 32000
  br i1 %14, label %for.cond.cleanup4, label %for.body5, !llvm.loop !177
}
...
for.cond.cleanup4:                                ; preds = %rolled.exit
  %.lcssa.lcssa = phi float [ %.lcssa, %rolled.exit ]
  %call41 = tail call i32 @dummy(float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @d, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @e, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 0), float %.lcssa.lcssa) #11
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %12, %rolled.exit ]
  %dot.163 = phi float [ 0.000000e+00, %for.cond2.preheader ], [ %.lcssa, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %10, %rolled.loop ]
  %1 = phi float [ %9, %rolled.loop ], [ %dot.163, %for.body5 ]
  %2 = zext i8 %0 to i64
  %3 = add nuw nsw i64 %indvars.iv, %2
  %4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %3
  %5 = load float, float* %4, align 1
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %12 = add nuw nsw i64 %indvars.iv, 5
  %13 = icmp ult i64 %indvars.iv, 31995
  br i1 %13, label %for.body5, label %for.cond.cleanup4, !llvm.loop !178
}
...
entry:
  ...
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  %2 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), align 64, !tbaa !6
  br label %for.cond2.preheader
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %3 = phi i8 [ 0, %for.body5 ], [ %15, %rolled.loop ]
  %4 = zext i8 %3 to i64
  %5 = add nuw nsw i64 %indvars.iv, %4
  ...
  %10 = load float, float* %9, align 1
  %11 = fmul float %2, %10
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %5
  %13 = load float, float* %12, align 1
  %14 = fadd float %13, %11
  store float %14, float* %12, align 1
  %15 = add i8 %3, 1
...
rolled.exit:                                      ; preds = %rolled.loop
  %17 = add nuw nsw i64 %indvars.iv, 5
  %18 = icmp ult i64 %indvars.iv, 31995
  br i1 %18, label %for.body5, label %for.cond.cleanup4, !llvm.loop !179
}
...
entry:
  ...
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  store float* getelementptr inbounds ([65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 0), float** @xx, align 8, !tbaa !180
  %2 = getelementptr i64, i64* %1, i8 6
  %3 = getelementptr float*, float** %0, i8 6
  br label %for.body
...
for.body:                                         ; preds = %for.cond.cleanup4.for.body_crit_edge, %entry
  %4 = phi float* [ getelementptr inbounds ([65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 0), %entry ], [ %.pre, %for.cond.cleanup4.for.body_crit_edge ]
  %nl.026 = phi i32 [ 0, %entry ], [ %inc13, %for.cond.cleanup4.for.body_crit_edge ]
  store float* %4, float** @yy, align 8, !tbaa !180
  br label %for.body5
...
for.cond.cleanup4:                                ; preds = %rolled.exit
  ...
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.cond.cleanup4.for.body_crit_edge

for.cond.cleanup4.for.body_crit_edge:             ; preds = %for.cond.cleanup4
  %.pre = load float*, float** @xx, align 8, !tbaa !180
  br label %for.body
...
for.body5.7:                                      ; preds = %rolled.exit
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %arrayidx.7 = getelementptr inbounds float, float* %4, i64 %indvars.iv.next.7
  %5 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %22
  %6 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %add8.7 = fadd float %5, %6
  store float %add8.7, float* %23, align 4, !tbaa !6
  br label %for.body5, !llvm.loop !181

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %7 = phi i8 [ 0, %for.body5 ], [ %20, %rolled.loop ]
  %8 = zext i8 %7 to i64
  %9 = add i64 %8, 1
  %10 = or i64 %indvars.iv, %9
  %11 = getelementptr i64, i64* %1, i8 %7
  store i64 %10, i64* %11, align 8
  %12 = getelementptr inbounds float, float* %4, i64 %10
  %13 = getelementptr float*, float** %0, i8 %7
  store float* %12, float** %13, align 8
  %14 = load float, float* %12, align 1
  %15 = or i64 %indvars.iv, %8
  %16 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %15
  %17 = load float, float* %16, align 1
  %18 = fadd float %14, %17
  %19 = getelementptr inbounds float, float* %4, i64 %15
  store float %18, float* %19, align 1
  %20 = add i8 %7, 1
  %21 = icmp ne i8 %20, 7
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %24 = icmp eq i64 %22, 31999
  br i1 %24, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !182
}
...
entry:
  ...
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  store float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 16000), float** @xx, align 8, !tbaa !180
  br label %for.cond2.preheader
...
for.cond.cleanup4:                                ; preds = %rolled.exit
  ...
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.cond.cleanup4.for.cond2.preheader_crit_edge
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  ...
  %5 = load float, float* %4, align 1
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %3
  %7 = load float, float* %6, align 1
  %8 = fadd float %5, %7
  %9 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %3
  store float %8, float* %9, align 1
  %10 = add i8 %1, 1
  %11 = icmp ne i8 %10, 8
  br i1 %11, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %12 = add nuw nsw i64 %indvars.iv, 8
  %13 = icmp eq i64 %12, 16000
  br i1 %13, label %for.cond.cleanup4, label %for.body5, !llvm.loop !183
}
...
entry:
  ...
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  store float* getelementptr inbounds ([65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 4), float** @xx, align 8, !tbaa !180
  br label %for.cond2.preheader
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %1 = phi i8 [ 0, %for.body5 ], [ %12, %rolled.loop ]
  %2 = zext i8 %1 to i64
  %3 = add i64 %2, 8
  %4 = add nuw nsw i64 %indvars.iv, %3
  %5 = getelementptr inbounds [65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 %4
  %6 = load float, float* %5, align 1
...
rolled.exit:                                      ; preds = %rolled.loop
  %14 = add nuw nsw i64 %indvars.iv, 8
  %15 = icmp eq i64 %14, 32000
  br i1 %15, label %for.cond.cleanup4, label %for.body5, !llvm.loop !184
}
...
entry:
  %0 = alloca i64, i8 7, align 8
  store float* getelementptr inbounds ([65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 64), float** @xx, align 8, !tbaa !180
...
for.cond2.preheader:                              ; preds = %for.cond.cleanup4, %entry
  %nl.027 = phi i32 [ 0, %entry ], [ %inc13, %for.cond.cleanup4 ]
  %2 = load float*, float** @xx, align 8, !tbaa !180
  br label %for.body5
...
for.body5.7:                                      ; preds = %rolled.exit
  %arrayidx.7 = getelementptr inbounds float, float* %2, i64 %19
  %3 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %19
  %4 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %add.7 = fadd float %3, %4
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %arrayidx10.7 = getelementptr inbounds [65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 %indvars.iv.next.7
  store float %add.7, float* %arrayidx10.7, align 32, !tbaa !6
  br label %for.body5, !llvm.loop !185

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %5 = phi i8 [ 0, %for.body5 ], [ %17, %rolled.loop ]
  %6 = zext i8 %5 to i64
  %7 = or i64 %indvars.iv, %6
  %8 = getelementptr inbounds float, float* %2, i64 %7
  %9 = load float, float* %8, align 1
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %7
  %11 = load float, float* %10, align 1
  %12 = fadd float %9, %11
  %13 = add i64 %6, 1
  %14 = or i64 %indvars.iv, %13
  %15 = getelementptr i64, i64* %0, i8 %5
  store i64 %14, i64* %15, align 8
  %16 = getelementptr inbounds [65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 %14
  store float %12, float* %16, align 1
  %17 = add i8 %5, 1
  %18 = icmp ne i8 %17, 7
  br i1 %18, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %19 = load i64, i64* %1, align 8
  %20 = icmp eq i64 %19, 31999
  br i1 %20, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !186
}
...
entry:
  %0 = alloca i64, i8 7, align 8
  store float* getelementptr inbounds ([65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 63), float** @xx, align 8, !tbaa !180
...
for.body5.7:                                      ; preds = %rolled.exit
  %arrayidx.7 = getelementptr inbounds [65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 %19
  %3 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %19
  %4 = load float, float* %arrayidx7.7, align 4, !tbaa !6
  %add.7 = fadd float %3, %4
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %arrayidx10.7 = getelementptr inbounds float, float* %2, i64 %indvars.iv.next.7
  store float %add.7, float* %arrayidx10.7, align 4, !tbaa !6
  br label %for.body5, !llvm.loop !187

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %5 = phi i8 [ 0, %for.body5 ], [ %17, %rolled.loop ]
  %6 = zext i8 %5 to i64
  %7 = or i64 %indvars.iv, %6
  %8 = getelementptr inbounds [65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 %7
  %9 = load float, float* %8, align 1
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %7
  %11 = load float, float* %10, align 1
  %12 = fadd float %9, %11
...
rolled.exit:                                      ; preds = %rolled.loop
  %19 = load i64, i64* %1, align 8
  %20 = icmp eq i64 %19, 31999
  br i1 %20, label %for.cond.cleanup4, label %for.body5.7, !llvm.loop !188
}
...
rolled.exit:                                      ; preds = %rolled.loop
  %10 = add nuw nsw i64 %indvars.iv, 8
  %11 = icmp eq i64 %10, 32000
  br i1 %11, label %for.cond.cleanup4, label %for.body5, !llvm.loop !189
}
...
rolled.reg.loop:                                  ; preds = %for.body5, %rolled.reg.bb2
  %0 = phi i8 [ 0, %for.body5 ], [ %15, %rolled.reg.bb2 ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %4 = load float, float* %3, align 32
...
rolled.reg.bb2:                                   ; preds = %rolled.reg.bb5, %rolled.reg.bb4, %rolled.reg.bb1
  %11 = phi float [ %10, %rolled.reg.bb1 ], [ %23, %rolled.reg.bb5 ], [ %20, %rolled.reg.bb4 ]
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  %13 = load float, float* %12, align 32
  %14 = fadd float %13, %11
  store float %14, float* %12, align 32
...
rolled.reg.bb3:                                   ; preds = %rolled.reg.loop
  %17 = fcmp oeq float %4, 0.000000e+00
  br i1 %17, label %rolled.reg.bb4, label %rolled.reg.bb5

rolled.reg.bb4:                                   ; preds = %rolled.reg.bb3
  %18 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %19 = load float, float* %18, align 32
  %20 = fmul float %19, %19
  br label %rolled.reg.bb2

rolled.reg.bb5:                                   ; preds = %rolled.reg.bb3
  %21 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %22 = load float, float* %21, align 32
  %23 = fmul float %22, %22
  br label %rolled.reg.bb2
...
rolled.reg.exit:                                  ; preds = %rolled.reg.bb2
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !190
}
...
for.body5:                                        ; preds = %for.inc.7, %for.cond2.preheader
  ...
  %0 = load i32, i32* %arrayidx, align 32, !tbaa !57
...
for.inc:                                          ; preds = %L40, %L30, %L20, %L15
  ...
  %arrayidx14 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  %5 = load float, float* %arrayidx14, align 32, !tbaa !6
  %add = fadd float %5, %mul.sink
  store float %add, float* %arrayidx14, align 32, !tbaa !6
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds [32000 x i32], [32000 x i32]* @indx, i64 0, i64 %indvars.iv.next
  %6 = load i32, i32* %arrayidx.1, align 4, !tbaa !57
...
L30.1:                                            ; preds = %for.inc
  ...
  %7 = load float, float* %arrayidx24.1, align 4, !tbaa !6
...
L40.1:                                            ; preds = %for.inc
  ...
  %9 = load float, float* %arrayidx32.1, align 4, !tbaa !6
...
for.inc.1:                                        ; preds = %L15.1, %L40.1, %L20.1, %L30.1
  ...
  %12 = load i32, i32* %arrayidx.2, align 8, !tbaa !57
...
L40.2:                                            ; preds = %for.inc.1
  ...
  %15 = load float, float* %arrayidx32.2, align 8, !tbaa !6
...
L15.2:                                            ; preds = %for.inc.1
  ...
  %16 = load float, float* %arrayidx10.2, align 8, !tbaa !6
...
for.inc.2:                                        ; preds = %L15.2, %L40.2, %L20.2, %L30.2
  ...
  %arrayidx14.2 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.1
  %17 = load float, float* %arrayidx14.2, align 8, !tbaa !6
  %add.2 = fadd float %17, %mul.2.sink
  store float %add.2, float* %arrayidx14.2, align 8, !tbaa !6
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  %arrayidx.3 = getelementptr inbounds [32000 x i32], [32000 x i32]* @indx, i64 0, i64 %indvars.iv.next.2
  %18 = load i32, i32* %arrayidx.3, align 4, !tbaa !57
...
L40.3:                                            ; preds = %for.inc.2
  ...
  %21 = load float, float* %arrayidx32.3, align 4, !tbaa !6
...
L15.3:                                            ; preds = %for.inc.2
  ...
  %22 = load float, float* %arrayidx10.3, align 4, !tbaa !6
...
L40.4:                                            ; preds = %for.inc.3
  ...
  %27 = load float, float* %arrayidx32.4, align 16, !tbaa !6
...
L15.4:                                            ; preds = %for.inc.3
  ...
  %28 = load float, float* %arrayidx10.4, align 16, !tbaa !6
...
for.inc.4:                                        ; preds = %L15.4, %L40.4, %L20.4, %L30.4
  ...
  %arrayidx14.4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.3
  %29 = load float, float* %arrayidx14.4, align 16, !tbaa !6
  %add.4 = fadd float %29, %mul.4.sink
  store float %add.4, float* %arrayidx14.4, align 16, !tbaa !6
  %indvars.iv.next.4 = or i64 %indvars.iv, 5
  %arrayidx.5 = getelementptr inbounds [32000 x i32], [32000 x i32]* @indx, i64 0, i64 %indvars.iv.next.4
  %30 = load i32, i32* %arrayidx.5, align 4, !tbaa !57
...
L40.5:                                            ; preds = %for.inc.4
  ...
  %33 = load float, float* %arrayidx32.5, align 4, !tbaa !6
...
L15.5:                                            ; preds = %for.inc.4
  ...
  %34 = load float, float* %arrayidx10.5, align 4, !tbaa !6
...
L40.6:                                            ; preds = %for.inc.5
  ...
  %39 = load float, float* %arrayidx32.6, align 8, !tbaa !6
...
L15.6:                                            ; preds = %for.inc.5
  ...
  %40 = load float, float* %arrayidx10.6, align 8, !tbaa !6
...
for.inc.6:                                        ; preds = %L15.6, %L40.6, %L20.6, %L30.6
  ...
  %arrayidx14.6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.5
  %41 = load float, float* %arrayidx14.6, align 8, !tbaa !6
  %add.6 = fadd float %41, %mul.6.sink
  store float %add.6, float* %arrayidx14.6, align 8, !tbaa !6
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
  %arrayidx.7 = getelementptr inbounds [32000 x i32], [32000 x i32]* @indx, i64 0, i64 %indvars.iv.next.6
  %42 = load i32, i32* %arrayidx.7, align 4, !tbaa !57
...
L30.7:                                            ; preds = %for.inc.6
  ...
  %43 = load float, float* %arrayidx24.7, align 4, !tbaa !6
...
L20.7:                                            ; preds = %for.inc.6
  ...
  %44 = load float, float* %arrayidx16.7, align 4, !tbaa !6
...
L40.7:                                            ; preds = %for.inc.6
  ...
  %45 = load float, float* %arrayidx32.7, align 4, !tbaa !6
...
L15.7:                                            ; preds = %for.inc.6
  ...
  %46 = load float, float* %arrayidx10.7, align 4, !tbaa !6
...
for.inc.7:                                        ; preds = %L15.7, %L40.7, %L20.7, %L30.7
  ...
  %arrayidx14.7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next.6
  %47 = load float, float* %arrayidx14.7, align 4, !tbaa !6
  %add.7 = fadd float %47, %mul.7.sink
  store float %add.7, float* %arrayidx14.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !191
}
...
rolled.reg.loop:                                  ; preds = %for.body5, %rolled.reg.bb1
  %0 = phi i8 [ 0, %for.body5 ], [ %13, %rolled.reg.bb1 ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %4 = load float, float* %3, align 32
  ...
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %7 = load float, float* %6, align 32
  br i1 %5, label %rolled.reg.bb1, label %rolled.reg.bb2

rolled.reg.bb1:                                   ; preds = %rolled.reg.bb2, %rolled.reg.loop
  %8 = phi float [ %16, %rolled.reg.bb2 ], [ %7, %rolled.reg.loop ]
  %9 = fmul float %7, %8
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  %11 = load float, float* %10, align 32
  %12 = fadd float %11, %9
  store float %12, float* %10, align 32
  %13 = add i8 %0, 1
  %14 = icmp ne i8 %13, 4
  br i1 %14, label %rolled.reg.loop, label %rolled.reg.exit

rolled.reg.bb2:                                   ; preds = %rolled.reg.loop
  %15 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %16 = load float, float* %15, align 32
  br label %rolled.reg.bb1

rolled.reg.exit:                                  ; preds = %rolled.reg.bb1
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  ...
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %4 = load float, float* %3, align 1
  %5 = tail call float @sinf(float %4) #11
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %7 = load float, float* %6, align 1
  %8 = tail call float @cosf(float %7) #11
  %9 = fadd float %5, %8
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  store float %9, float* %10, align 1
  %11 = add i8 %0, 1
  %12 = icmp ne i8 %11, 8
  br i1 %12, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %13 = add nuw nsw i64 %indvars.iv, 8
  %14 = icmp eq i64 %13, 32000
  br i1 %14, label %for.cond.cleanup4, label %for.body5, !llvm.loop !193
}
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %2 = phi i8 [ 0, %for.body5 ], [ %19, %rolled.loop ]
  %3 = zext i8 %2 to i64
  %4 = or i64 %indvars.iv, %3
  %5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %4
  %6 = load float, float* %5, align 1
  %7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %4
  %8 = load float, float* %7, align 1
  %9 = getelementptr [8 x i64], [8 x i64]* @4, i8 0, i8 %2
  %10 = load i64, i64* %9, align 8
  %11 = add nuw nsw i64 %indvars.iv, %10
  %12 = getelementptr i64, i64* %0, i8 %2
  store i64 %11, i64* %12, align 8
  %13 = or i64 %11, %10
  ...
  %16 = fmul float %8, %15
  %17 = fadd float %6, %16
  %18 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %4
  store float %17, float* %18, align 1
  %19 = add i8 %2, 1
  %20 = icmp ne i8 %19, 8
  br i1 %20, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  br i1 %22, label %for.cond.cleanup4, label %for.body5, !llvm.loop !194
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %15, %rolled.exit ]
  %s.023 = phi float [ 0.000000e+00, %for.cond2.preheader ], [ %14, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %2 = phi i8 [ 0, %for.body5 ], [ %12, %rolled.loop ]
  %3 = phi float [ %s.023, %for.body5 ], [ %4, %rolled.loop ]
  %4 = fadd float %3, 2.000000e+00
  %5 = getelementptr float, float* %0, i8 %2
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %15 = add nuw nsw i64 %indvars.iv, 8
  %16 = icmp eq i64 %15, 32000
  br i1 %16, label %for.cond.cleanup4, label %for.body5, !llvm.loop !195
}
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  ...
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %4 = load float, float* %3, align 1
  %5 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %6 = load float, float* %5, align 1
  %7 = fmul float %6, %6
  %8 = fadd float %4, %7
  %9 = getelementptr inbounds [32000 x float], [32000 x float]* @x, i64 0, i64 %2
  store float %8, float* %9, align 1
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %2
  %11 = load float, float* %10, align 1
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %2
  %13 = load float, float* %12, align 1
  %14 = fmul float %6, %13
  %15 = fadd float %11, %14
  store float %15, float* %3, align 1
  %16 = add i8 %0, 1
  %17 = icmp ne i8 %16, 8
  br i1 %17, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %18 = add nuw nsw i64 %indvars.iv, 8
  %19 = icmp eq i64 %18, 32000
  br i1 %19, label %for.cond.cleanup4, label %for.body5, !llvm.loop !196
}
...
if.end:                                           ; preds = %for.body5
  %arrayidx8 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  %1 = load float, float* %arrayidx8, align 32, !tbaa !6
  ...
  store float %add, float* %arrayidx12, align 32, !tbaa !6
  %indvars.iv.next = or i64 %indvars.iv, 1
...
if.end.1:                                         ; preds = %if.end
  ...
  %5 = load float, float* %arrayidx8.1, align 4, !tbaa !6
  ...
  %7 = load float, float* %arrayidx12.1, align 4, !tbaa !6
  %add.1 = fadd float %7, %mul.1
  store float %add.1, float* %arrayidx12.1, align 4, !tbaa !6
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
...
if.end.2:                                         ; preds = %if.end.1
  ...
  %9 = load float, float* %arrayidx8.2, align 8, !tbaa !6
  ...
  %11 = load float, float* %arrayidx12.2, align 8, !tbaa !6
  %add.2 = fadd float %11, %mul.2
  store float %add.2, float* %arrayidx12.2, align 8, !tbaa !6
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
...
if.end.3:                                         ; preds = %if.end.2
  ...
  %15 = load float, float* %arrayidx12.3, align 4, !tbaa !6
  %add.3 = fadd float %15, %mul.3
  store float %add.3, float* %arrayidx12.3, align 4, !tbaa !6
  %indvars.iv.next.3 = or i64 %indvars.iv, 4
...
if.end.4:                                         ; preds = %if.end.3
  ...
  %17 = load float, float* %arrayidx8.4, align 16, !tbaa !6
  ...
  store float %add.4, float* %arrayidx12.4, align 16, !tbaa !6
  %indvars.iv.next.4 = or i64 %indvars.iv, 5
...
if.end.5:                                         ; preds = %if.end.4
  ...
  %21 = load float, float* %arrayidx8.5, align 4, !tbaa !6
  ...
  store float %add.5, float* %arrayidx12.5, align 4, !tbaa !6
  %indvars.iv.next.5 = or i64 %indvars.iv, 6
...
if.end.6:                                         ; preds = %if.end.5
  ...
  %25 = load float, float* %arrayidx8.6, align 8, !tbaa !6
  ...
  store float %add.6, float* %arrayidx12.6, align 8, !tbaa !6
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
...
if.end.7:                                         ; preds = %if.end.6
  ...
  %29 = load float, float* %arrayidx8.7, align 4, !tbaa !6
  ...
  store float %add.7, float* %arrayidx12.7, align 4, !tbaa !6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !197
}
...
for.cond2:                                        ; preds = %for.body5
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next
  %0 = load float, float* %arrayidx.1, align 4, !tbaa !6
  %arrayidx7.1 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next
  %1 = load float, float* %arrayidx7.1, align 4, !tbaa !6
  %mul.1 = fmul float %0, %1
  %arrayidx9.1 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  %2 = load float, float* %arrayidx9.1, align 4, !tbaa !6
...
for.body5:                                        ; preds = %for.cond2.7, %for.cond2.preheader
  ...
  %3 = load float, float* %arrayidx, align 32, !tbaa !6
  %arrayidx7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv
  %4 = load float, float* %arrayidx7, align 32, !tbaa !6
  %mul = fmul float %3, %4
  %arrayidx9 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  %5 = load float, float* %arrayidx9, align 32, !tbaa !6
...
for.cond2.6:                                      ; preds = %for.cond2.5
  %indvars.iv.next.6 = or i64 %indvars.iv, 7
  %arrayidx.7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.next.6
  %21 = load float, float* %arrayidx.7, align 4, !tbaa !6
  %arrayidx7.7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv.next.6
  %22 = load float, float* %arrayidx7.7, align 4, !tbaa !6
...
for.cond2.7:                                      ; preds = %for.cond2.6
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %cleanup, label %for.body5, !llvm.loop !198
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %19, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %2 = phi i8 [ 0, %for.body5 ], [ %17, %rolled.loop ]
  %3 = zext i8 %2 to i64
  %4 = or i64 %indvars.iv, %3
  %5 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %4
  %6 = load float, float* %5, align 1
  %7 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %4
  %8 = load float, float* %7, align 1
  %9 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %4
  %10 = load float, float* %9, align 1
  %11 = fmul float %8, %10
  %12 = fadd float %6, %11
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %20 = icmp eq i64 %19, 32000
  br i1 %20, label %for.cond.cleanup4, label %for.body5, !llvm.loop !199
}
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %4 = phi i8 [ 0, %for.body5 ], [ %16, %rolled.loop ]
  %5 = zext i8 %4 to i64
  %6 = or i64 %indvars.iv, %5
  ...
  %14 = load float, float* %13, align 1
  %15 = fadd float %14, %12
  store float %15, float* %13, align 1
  %16 = add i8 %4, 1
  %17 = icmp ne i8 %16, 8
  br i1 %17, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %18 = add nuw nsw i64 %indvars.iv, 8
  %19 = icmp eq i64 %18, 32000
  br i1 %19, label %for.cond.cleanup4, label %for.body5, !llvm.loop !203
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %16, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %2 = phi i8 [ 0, %for.body5 ], [ %14, %rolled.loop ]
  %3 = zext i8 %2 to i64
  %4 = or i64 %indvars.iv, %3
  ...
  %8 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %7
  %9 = load float, float* %8, align 1
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %4
  %11 = load float, float* %10, align 1
  %12 = fadd float %9, %11
  %13 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %7
  store float %12, float* %13, align 1
  %14 = add i8 %2, 1
  %15 = icmp ne i8 %14, 8
  br i1 %15, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  br i1 %17, label %for.cond.cleanup4, label %for.body5, !llvm.loop !204
}
...
for.body5.prol:                                   ; preds = %for.body5.prol.preheader, %for.body5.prol
  ...
  %12 = load i32, i32* %arrayidx.prol, align 4, !tbaa !57
  %arrayidx7.prol = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv.prol
  %13 = load float, float* %arrayidx7.prol, align 4, !tbaa !6
  ...
  %14 = load float, float* %arrayidx11.prol, align 4, !tbaa !6
  %arrayidx13.prol = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv.prol
  %15 = load float, float* %arrayidx13.prol, align 4, !tbaa !6
  ...
  store float %add14.prol, float* %arrayidx16.prol, align 4, !tbaa !6
  %indvars.iv.next.prol = add nsw i64 %indvars.iv.prol, 1
  %prol.iter.sub = add i32 %prol.iter, -1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.sub, 0
  br i1 %prol.iter.cmp.not, label %for.body5.prol.loopexit.loopexit, label %for.body5.prol, !llvm.loop !208
...
for.cond.cleanup4.loopexit:                       ; preds = %rolled.exit
  br label %for.cond.cleanup4
...
for.body5:                                        ; preds = %for.body5.preheader1, %rolled.exit
  %indvars.iv = phi i64 [ %34, %rolled.exit ], [ %indvars.iv.unr, %for.body5.preheader1 ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %16 = phi i8 [ 0, %for.body5 ], [ %32, %rolled.loop ]
  %17 = zext i8 %16 to i64
  %18 = add nsw i64 %indvars.iv, %17
  %19 = getelementptr inbounds i32, i32* %2, i64 %18
  %20 = load i32, i32* %19, align 1
  %21 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %18
  %22 = load float, float* %21, align 1
  %23 = sub i32 31999, %20
  %24 = sext i32 %23 to i64
  %25 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %24
  %26 = load float, float* %25, align 1
  %27 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %18
  %28 = load float, float* %27, align 1
  %29 = fmul float %26, %28
  %30 = fadd float %22, %29
  %31 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %18
  store float %30, float* %31, align 1
  %32 = add i8 %16, 1
  %33 = icmp ne i8 %32, 8
  br i1 %33, label %rolled.loop, label %rolled.exit

rolled.exit:                                      ; preds = %rolled.loop
  %34 = add nsw i64 %indvars.iv, 8
  %35 = icmp slt i64 %indvars.iv, 31992
  br i1 %35, label %for.body5, label %for.cond.cleanup4.loopexit, !llvm.loop !209
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %17, %rolled.exit ]
  %sum.126 = phi float [ 0.000000e+00, %for.cond2.preheader ], [ %.lcssa, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %2 = phi i8 [ 0, %for.body5 ], [ %15, %rolled.loop ]
  %3 = phi float [ %14, %rolled.loop ], [ %sum.126, %for.body5 ]
  %4 = zext i8 %2 to i64
  %5 = or i64 %indvars.iv, %4
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %5
  %7 = load float, float* %6, align 1
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %17 = add nuw nsw i64 %indvars.iv, 8
  %18 = icmp eq i64 %17, 32000
  br i1 %18, label %for.cond.cleanup4, label %for.body5, !llvm.loop !210
}
...
for.body5:                                        ; preds = %for.body5.7, %for.cond2.preheader
  ...
  %7 = load float, float* %arrayidx, align 4, !tbaa !6
  %arrayidx9 = getelementptr inbounds i32, i32* %2, i64 %indvars.iv
  %8 = load i32, i32* %arrayidx9, align 4, !tbaa !57
  ...
  %11 = load float, float* %arrayidx.1, align 4, !tbaa !6
  %arrayidx9.1 = getelementptr inbounds i32, i32* %2, i64 %indvars.iv.next
  %12 = load i32, i32* %arrayidx9.1, align 4, !tbaa !57
  ...
  %13 = load float, float* %arrayidx11.1, align 4, !tbaa !6
  ...
  %16 = load i32, i32* %arrayidx9.2, align 4, !tbaa !57
  ...
  %17 = load float, float* %arrayidx11.2, align 4, !tbaa !6
  ...
  %19 = load float, float* %arrayidx.3, align 4, !tbaa !6
  %arrayidx9.3 = getelementptr inbounds i32, i32* %2, i64 %indvars.iv.next.2
  %20 = load i32, i32* %arrayidx9.3, align 4, !tbaa !57
  ...
  %21 = load float, float* %arrayidx11.3, align 4, !tbaa !6
  ...
  %23 = load float, float* %arrayidx.4, align 4, !tbaa !6
  %arrayidx9.4 = getelementptr inbounds i32, i32* %2, i64 %indvars.iv.next.3
  %24 = load i32, i32* %arrayidx9.4, align 4, !tbaa !57
  ...
  %25 = load float, float* %arrayidx11.4, align 4, !tbaa !6
  ...
  %27 = load float, float* %arrayidx.5, align 4, !tbaa !6
  %arrayidx9.5 = getelementptr inbounds i32, i32* %2, i64 %indvars.iv.next.4
  %28 = load i32, i32* %arrayidx9.5, align 4, !tbaa !57
  ...
  %29 = load float, float* %arrayidx11.5, align 4, !tbaa !6
  ...
  %31 = load float, float* %arrayidx.6, align 4, !tbaa !6
  %arrayidx9.6 = getelementptr inbounds i32, i32* %2, i64 %indvars.iv.next.5
  %32 = load i32, i32* %arrayidx9.6, align 4, !tbaa !57
...
for.body5.7:                                      ; preds = %for.body5
  ...
  %37 = load float, float* %arrayidx11.7, align 4, !tbaa !6
  %mul.7 = fmul float %35, %37
  %add12.7 = fadd float %add12.6, %mul.7
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  br label %for.body5, !llvm.loop !216
}
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %17, %rolled.loop ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %4 = load float, float* %3, align 1
  %5 = getelementptr [8 x i64], [8 x i64]* @5, i8 0, i8 %0
  ...
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %9
  %11 = load float, float* %10, align 1
  %12 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %2
  %13 = load float, float* %12, align 1
  %14 = fmul float %11, %13
  %15 = fadd float %4, %14
  %16 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  store float %15, float* %16, align 1
  %17 = add i8 %0, 1
  %18 = icmp ne i8 %17, 8
  br i1 %18, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %19 = add nuw nsw i64 %indvars.iv, 8
  %20 = icmp eq i64 %19, 32000
  br i1 %20, label %for.cond.cleanup4, label %for.body5, !llvm.loop !217
}
...
rolled.exit:                                      ; preds = %rolled.loop
  %13 = add nuw nsw i64 %indvars.iv, 8
  %14 = icmp eq i64 %13, 32000
  br i1 %14, label %for.cond.cleanup4, label %for.body5, !llvm.loop !218
}
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  ...
  %8 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %7
  %9 = load float, float* %8, align 1
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %4
  store float %9, float* %10, align 1
  %11 = add i8 %2, 1
  %12 = icmp ne i8 %11, 8
  br i1 %12, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %13 = add nuw nsw i64 %indvars.iv, 8
  %14 = icmp eq i64 %13, 32000
  br i1 %14, label %for.cond.cleanup4, label %for.body5, !llvm.loop !219
}
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  ...
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %9
  store float %6, float* %10, align 1
  %11 = add i8 %2, 1
  %12 = icmp ne i8 %11, 8
  br i1 %12, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %13 = add nuw nsw i64 %indvars.iv, 8
  %14 = icmp eq i64 %13, 32000
  br i1 %14, label %for.cond.cleanup4, label %for.body5, !llvm.loop !220
}
...
rolled.reg.loop:                                  ; preds = %for.body5, %rolled.reg.latch
  %0 = phi i8 [ 0, %for.body5 ], [ %7, %rolled.reg.latch ]
  %1 = zext i8 %0 to i64
  %2 = or i64 %indvars.iv, %1
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %4 = load float, float* %3, align 32
...
rolled.reg.bb1:                                   ; preds = %rolled.reg.loop
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  store float %4, float* %6, align 32
  br label %rolled.reg.latch

rolled.reg.latch:                                 ; preds = %rolled.reg.loop, %rolled.reg.bb1
  %7 = add i8 %0, 1
  %8 = icmp ne i8 %7, 4
  br i1 %8, label %rolled.reg.loop, label %rolled.reg.exit

rolled.reg.exit:                                  ; preds = %rolled.reg.latch
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %exitcond.7.not = icmp eq i64 %indvars.iv.next.7, 32000
  br i1 %exitcond.7.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !221
}
...
rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  ...
  %3 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %2
  %4 = load float, float* %3, align 1
  %5 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %2
  %6 = load float, float* %5, align 1
  %7 = fadd float %4, %6
  store float %7, float* %5, align 1
  %8 = add i8 %0, 1
  %9 = icmp ne i8 %8, 8
  br i1 %9, label %rolled.loop, label %rolled.exit
...
rolled.exit:                                      ; preds = %rolled.loop
  %10 = add nuw nsw i64 %indvars.iv, 8
  %11 = icmp eq i64 %10, 32000
  br i1 %11, label %for.cond.cleanup4, label %for.body5, !llvm.loop !222
}
...
rolled.exit:                                      ; preds = %rolled.loop
  %10 = add nuw nsw i64 %indvars.iv, 8
  %11 = icmp eq i64 %10, 32000
  br i1 %11, label %for.cond.cleanup4, label %for.body5, !llvm.loop !223
}
...
rolled.exit:                                      ; preds = %rolled.loop
  %13 = add nuw nsw i64 %indvars.iv, 8
  %14 = icmp eq i64 %13, 32000
  br i1 %14, label %for.cond.cleanup4, label %for.body5, !llvm.loop !224
}
...
for.cond.cleanup6:                                ; preds = %rolled.exit
  %call10 = tail call i32 @dummy(float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @d, i64 0, i64 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @e, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @bb, i64 0, i64 0), [256 x float]* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @cc, i64 0, i64 0), float 0.000000e+00) #11
  %inc12 = add nuw nsw i32 %nl.026, 1
  %exitcond.not = icmp eq i32 %inc12, 100000
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.cond3.preheader

for.body7:                                        ; preds = %rolled.exit, %for.cond3.preheader
  %indvars.iv = phi i64 [ 0, %for.cond3.preheader ], [ %14, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body7, %rolled.loop
  %3 = phi i8 [ 0, %for.body7 ], [ %12, %rolled.loop ]
  %4 = zext i8 %3 to i64
  %5 = or i64 %indvars.iv, %4
  %6 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %5
  %7 = load float, float* %6, align 1
...
rolled.exit:                                      ; preds = %rolled.loop
  %14 = add nuw nsw i64 %indvars.iv, 8
  %15 = icmp eq i64 %14, 32000
  br i1 %15, label %for.cond.cleanup6, label %for.body7, !llvm.loop !225
}
...
rolled.exit:                                      ; preds = %rolled.loop
  %13 = add nuw nsw i64 %indvars.iv, 8
  %14 = icmp eq i64 %13, 32000
  br i1 %14, label %for.cond.cleanup4, label %for.body5, !llvm.loop !226
}
...
rolled.exit:                                      ; preds = %rolled.loop
  %13 = add nuw nsw i64 %indvars.iv, 8
  %14 = icmp eq i64 %13, 32000
  br i1 %14, label %for.cond.cleanup4, label %for.body5, !llvm.loop !227
}
...
for.body5:                                        ; preds = %rolled.exit, %for.cond2.preheader
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %9, %rolled.exit ]
  %sum.120 = phi float [ 0.000000e+00, %for.cond2.preheader ], [ %.lcssa, %rolled.exit ]
  br label %rolled.loop

rolled.loop:                                      ; preds = %for.body5, %rolled.loop
  %0 = phi i8 [ 0, %for.body5 ], [ %7, %rolled.loop ]
  %1 = phi float [ %6, %rolled.loop ], [ %sum.120, %for.body5 ]
  %2 = zext i8 %0 to i64
  %3 = or i64 %indvars.iv, %2
  %4 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %3
  %5 = load float, float* %4, align 1
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %9 = add nuw nsw i64 %indvars.iv, 8
  %10 = icmp eq i64 %9, 32000
  br i1 %10, label %for.cond.cleanup4, label %for.body5, !llvm.loop !228
}
...
rolled.exit:                                      ; preds = %rolled.loop
  ...
  %12 = add nuw nsw i64 %indvars.iv, 8
  %13 = icmp eq i64 %12, 32000
  br i1 %13, label %for.cond.cleanup4, label %for.body5, !llvm.loop !229
}
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond159.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.body5, %for.cond2.preheader
  ...
  %2 = load float, float* %arrayidx9, align 4, !tbaa !6
  %arrayidx11 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv
  %3 = load float, float* %arrayidx11, align 4, !tbaa !6
  ...
  %5 = load float, float* %arrayidx15, align 4, !tbaa !6
  %mul = fmul float %0, %1
  ...
  store float %mul72, float* %arrayidx74, align 4, !tbaa !6
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 256
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5, !llvm.loop !230
}
...
entry:
  ...
  store i8* %arg_info, i8** %arg_info1, align 8, !tbaa !26
...
entry:
  ...
  store i32 1, i32* %n1, align 4, !tbaa !57
  ...
  %5 = load i32, i32* %n1, align 4, !tbaa !57
  store i32 %5, i32* %a2, align 4, !tbaa !31
  %b3 = getelementptr inbounds %struct.anon.6, %struct.anon.6* %.compoundliteral1, i64 0, i32 1
  store i32 1, i32* %b3, align 4, !tbaa !34
  ...
  store i32 16000, i32* %a5, align 4, !tbaa !235
  ...
  %8 = load float, float* %s1, align 4, !tbaa !6
  store float %8, float* %a7, align 4, !tbaa !95
  %b8 = getelementptr inbounds %struct.anon.8, %struct.anon.8* %.compoundliteral6, i64 0, i32 1
  %9 = load float, float* %s2, align 4, !tbaa !6
  store float %9, float* %b8, align 4, !tbaa !97
  ...
  %12 = load i8*, i8** %11, align 8, !tbaa !180
  ...
  %13 = load i8*, i8** %11, align 8, !tbaa !180
  ...
  %14 = load i32*, i32** %ip, align 8, !tbaa !180
  store i32* %14, i32** %a10, align 8, !tbaa !200
  %b11 = getelementptr inbounds %struct.anon.9, %struct.anon.9* %.compoundliteral9, i64 0, i32 1
  %15 = load float, float* %s1, align 4, !tbaa !6
  store float %15, float* %b11, align 8, !tbaa !202
  ...
  %17 = load i8*, i8** %11, align 8, !tbaa !180
  ...
  %18 = load i32*, i32** %ip, align 8, !tbaa !180
  store i32* %18, i32** %a13, align 8, !tbaa !205
  %b14 = getelementptr inbounds %struct.anon.10, %struct.anon.10* %.compoundliteral12, i64 0, i32 1
  %19 = load i32, i32* %n1, align 4, !tbaa !57
  store i32 %19, i32* %b14, align 8, !tbaa !207
  ...
  %21 = load i8*, i8** %11, align 8, !tbaa !180
  ...
  %22 = load i32*, i32** %ip, align 8, !tbaa !180
  store i32* %22, i32** %a16, align 8, !tbaa !211
  %b17 = getelementptr inbounds %struct.anon.11, %struct.anon.11* %.compoundliteral15, i64 0, i32 1
  store i32 128, i32* %b17, align 8, !tbaa !213
  %c = getelementptr inbounds %struct.anon.11, %struct.anon.11* %.compoundliteral15, i64 0, i32 2
  %23 = load i32, i32* %n1, align 4, !tbaa !57
  store i32 %23, i32* %c, align 4, !tbaa !214
  ...
  %25 = load i8*, i8** %11, align 8, !tbaa !180
  call void @time_function(float (%struct.args_t*)* nonnull @vag, i8* %25) #12
  %26 = load i8*, i8** %11, align 8, !tbaa !180
...
!10 = distinct !{!10, !3}
!11 = distinct !{!11, !12}
!12 = !{!"llvm.loop.unroll.count", i32 8}
!13 = distinct !{!13, !3}
!14 = distinct !{!14, !3}
!15 = distinct !{!15, !12}
!16 = distinct !{!16, !3}
...
!25 = distinct !{!25, !12}
!26 = !{!27, !30, i64 32}
!27 = !{!"args_t", !28, i64 0, !28, i64 16, !30, i64 32}
...
!199 = distinct !{!199, !3}
!200 = !{!201, !30, i64 0}
!201 = !{!"", !30, i64 0, !7, i64 8}
!202 = !{!201, !7, i64 8}
!203 = distinct !{!203, !3}
!204 = distinct !{!204, !3}
!205 = !{!206, !30, i64 0}
!206 = !{!"", !30, i64 0, !33, i64 8}
!207 = !{!206, !33, i64 8}
!208 = distinct !{!208, !3}
!209 = distinct !{!209, !3}
!210 = distinct !{!210, !3}
!211 = !{!212, !30, i64 0}
!212 = !{!"", !30, i64 0, !33, i64 8, !33, i64 12}
!213 = !{!212, !33, i64 8}
!214 = !{!212, !33, i64 12}
!215 = distinct !{!215, !12}
!216 = distinct !{!216, !3}
