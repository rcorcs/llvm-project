...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond23.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond59.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %add30, float* %arrayidx33, align 8, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  %indvars.iv = phi i64 [ 1, %for.cond2.preheader ], [ %indvars.iv.next, %for.body5 ]
  %0 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !2
  %arrayidx = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  %1 = load float, float* %arrayidx, align 4, !tbaa !2
  %add = fadd float %0, %1
  %arrayidx7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next, %for.body5 ]
  %0 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 16000), align 64, !tbaa !2
  %arrayidx = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  %1 = load float, float* %arrayidx, align 4, !tbaa !2
  %add = fadd float %0, %1
  %arrayidx7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
...
for.body9:                                        ; preds = %for.cond6.preheader, %for.body9
  ...
  %0 = load float, float* %arrayidx11, align 4, !tbaa !2
...
for.cond2.loopexit:                               ; preds = %for.body9, %for.body5
  ...
  br i1 %exitcond45.not, label %for.cond.cleanup4, label %for.body5
...
for.cond.cleanup4:                                ; preds = %for.cond2.loopexit
  ...
  br i1 %exitcond46.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body9:                                        ; preds = %for.body9.lr.ph, %for.body9
  ...
  %0 = load float, float* %arrayidx11, align 4, !tbaa !2
  %1 = load float, float* %arrayidx13, align 4, !tbaa !2
  %mul = fmul float %0, %1
  ...
  store float %sub, float* %arrayidx15, align 4, !tbaa !2
  %indvars.iv.next42 = add nuw nsw i64 %indvars.iv41, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next42, 256
  br i1 %exitcond.not, label %for.cond2.loopexit, label %for.body9
}
...
for.cond.cleanup8:                                ; preds = %for.body9
  ...
  br i1 %exitcond53.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.body9:                                        ; preds = %for.cond6.preheader, %for.body9
  ...
  %2 = load float, float* %arrayidx19, align 4, !tbaa !2
...
for.cond2.preheader:                              ; preds = %entry, %for.cond.cleanup4
  ...
  %.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !2
  br label %for.body5
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %mul46, float* %arrayidx32, align 4, !tbaa !2
...
for.cond6.preheader:                              ; preds = %for.cond2.preheader, %for.cond.cleanup8
  ...
  %.pre = load float, float* %arrayidx17, align 4, !tbaa !2
  br label %for.body9
...
for.body9:                                        ; preds = %for.cond6.preheader, %for.body9
  ...
  %4 = load float, float* %arrayidx15, align 4, !tbaa !2
  %mul = fmul float %1, %4
  %add = fadd float %0, %mul
  store float %add, float* %arrayidx17, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.body9:                                        ; preds = %for.cond6.preheader, %for.body9
  ...
  store float %add, float* %arrayidx20, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 256
  br i1 %exitcond.not, label %for.cond.cleanup8, label %for.body9
}
...
for.cond.cleanup8:                                ; preds = %for.body9
  ...
  br i1 %exitcond48.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond28.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %add8, float* %arrayidx10, align 4, !tbaa !2
...
for.body5:                                        ; preds = %for.body, %for.body5
  ...
  %9 = load float, float* %arrayidx8, align 4, !tbaa !2
  %add9 = fadd float %8, %9
...
for.cond.cleanup4:                                ; preds = %for.inc
  ...
  br i1 %exitcond52.not, label %for.cond.cleanup, label %for.cond2.preheader
...
if.then:                                          ; preds = %for.body5
  ...
  store float %add23, float* %arrayidx25, align 4, !tbaa !2
  br label %for.inc
...
if.else:                                          ; preds = %for.body5
  ...
  %1 = load float, float* %arrayidx17, align 4, !tbaa !2
  br label %for.inc
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond57.not, label %for.cond.cleanup, label %for.cond2.preheader

for.cond.cleanup8:                                ; preds = %for.body9
  %indvars.iv.next55 = add nuw nsw i64 %indvars.iv54, 1
  %exitcond56.not = icmp eq i64 %indvars.iv.next55, 256
  br i1 %exitcond56.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.body9:                                        ; preds = %for.cond6.preheader, %for.body9
  ...
  %3 = load float, float* %arrayidx19, align 4, !tbaa !2
  %mul = fmul float %2, %3
...
for.cond6.preheader:                              ; preds = %for.cond2.preheader, %for.cond.cleanup8
  ...
  %.pre = load float, float* %arrayidx11.phi.trans.insert, align 4, !tbaa !2
  br label %for.body9
...
for.cond.cleanup8:                                ; preds = %for.body9
  ...
  br i1 %exitcond61.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %add20, float* %arrayidx22, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 16000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond43.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.cond2.preheader:                              ; preds = %entry, %for.cond.cleanup4
  ...
  %0 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 1), align 4, !tbaa !2
  br label %for.body5
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond36.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.cond2.loopexit:                               ; preds = %for.body13
  ...
  br i1 %exitcond54.not, label %for.cond.cleanup4, label %for.body13.lr.ph
...
for.body13:                                       ; preds = %for.body13.lr.ph, %for.body13
  ...
  %3 = load float, float* %arrayidx15, align 4, !tbaa !2
...
for.body.i:                                       ; preds = %for.body.i.preheader, %for.body.i
  ...
  store float %add3.i, float* %arrayidx5.i, align 4, !tbaa !2
  %exitcond.not.i = icmp eq i64 %0, 31999
  br i1 %exitcond.not.i, label %s151s.exit, label %for.body.i
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %mul = fmul float %0, %1
  %arrayidx9 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  store float %mul, float* %arrayidx9, align 4, !tbaa !2
  ...
  %3 = load float, float* %arrayidx4.i, align 4, !tbaa !2
  %add.i = fadd float %3, %mul.i
  store float %add.i, float* %arrayidx4.i, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
L20:                                              ; preds = %for.body5
  ...
  %4 = load float, float* %arrayidx16, align 4, !tbaa !2
  %arrayidx18 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv
  %5 = load float, float* %arrayidx18, align 4, !tbaa !2
  ...
  store float %add22, float* %arrayidx25, align 4, !tbaa !2
  br label %for.inc
...
if.end:                                           ; preds = %for.body5
  %arrayidx10 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv
  %1 = load float, float* %arrayidx10, align 4, !tbaa !2
  %arrayidx12 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv
  %2 = load float, float* %arrayidx12, align 4, !tbaa !2
  %mul = fmul float %1, %2
  br label %for.inc
...
if.end:                                           ; preds = %for.body6, %for.body
  ...
  br i1 %exitcond35.not, label %for.cond.cleanup, label %for.body
}
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond27.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %6 = load float, float* %arrayidx7, align 4, !tbaa !2
  %add = fadd float %4, %6
  store float %add, float* %arrayidx7, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
...
entry:
  ...
  %1 = load %struct.anon.0*, %struct.anon.0** %0, align 8, !tbaa !6
...
for.body5:                                        ; preds = %for.body, %for.body5
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body5 ], [ %5, %for.body ]
  %arrayidx = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  %7 = load float, float* %arrayidx, align 4, !tbaa !2
  %arrayidx7 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  %8 = load float, float* %arrayidx7, align 4, !tbaa !2
  %add = fadd float %7, %8
  store float %add, float* %arrayidx7, align 4, !tbaa !2
  %indvars.iv.next = add i64 %indvars.iv, %6
  %cmp3 = icmp slt i64 %indvars.iv.next, 32000
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond29.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.cond6.preheader:                              ; preds = %for.cond2.preheader, %for.cond.cleanup8
  ...
  %1 = load float, float* %arrayidx12, align 4, !tbaa !2
  br label %for.body9
...
for.cond.cleanup8:                                ; preds = %for.body9
  ...
  br i1 %exitcond45.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.cond2.preheader:                              ; preds = %entry, %for.cond.cleanup4
  ...
  %.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 0), align 64, !tbaa !2
  br label %for.body5
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %sub20, float* %arrayidx22, align 4, !tbaa !2
  %exitcond.not = icmp eq i64 %indvars.iv.next, 31999
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond34.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond37.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %mul, float* %arrayidx16, align 4, !tbaa !2
  %exitcond.not = icmp eq i64 %indvars.iv.next, 31999
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond2.preheader:                              ; preds = %entry, %for.cond.cleanup4
  ...
  %.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @e, i64 0, i64 0), align 64, !tbaa !2
  br label %for.body5
...
for.cond6.preheader:                              ; preds = %for.cond2.preheader, %for.cond.cleanup8
  ...
  %.pre = load float, float* %arrayidx11.phi.trans.insert, align 64, !tbaa !2
  br label %for.body9
...
for.body9:                                        ; preds = %for.cond6.preheader, %for.body9
  ...
  %1 = load float, float* %arrayidx20, align 4, !tbaa !2
...
for.cond.cleanup8:                                ; preds = %for.body9
  ...
  br i1 %exitcond50.not, label %for.cond.cleanup4, label %for.body9.lr.ph
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup23
  ...
  br i1 %exitcond84.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body9:                                        ; preds = %for.cond6.preheader, %for.body9
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 256
  br i1 %exitcond.not, label %for.cond21.preheader, label %for.body9

for.cond.cleanup23:                               ; preds = %for.body24
  %indvars.iv.next81 = add nuw nsw i64 %indvars.iv80, 1
  %exitcond83.not = icmp eq i64 %indvars.iv.next81, 256
  br i1 %exitcond83.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.body24:                                       ; preds = %for.cond21.preheader, %for.body24
  ...
  store float %add34, float* %arrayidx38, align 4, !tbaa !2
  %indvars.iv.next78 = add nuw nsw i64 %indvars.iv77, 1
  %exitcond79.not = icmp eq i64 %indvars.iv.next78, 256
  br i1 %exitcond79.not, label %for.cond.cleanup23, label %for.body24
}
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup12
  ...
  br i1 %exitcond63.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.cond.cleanup12
  ...
  %.pre = load float, float* %arrayidx17.phi.trans.insert, align 4, !tbaa !2
  br label %for.body13

for.cond.cleanup12:                               ; preds = %for.body13
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %exitcond62.not = icmp eq i64 %indvars.iv.next61, 256
  br i1 %exitcond62.not, label %for.cond.cleanup4, label %for.body5
...
for.body13:                                       ; preds = %for.body5, %for.body13
  ...
  %4 = load float, float* %arrayidx21, align 4, !tbaa !2
  ...
  store float %add25, float* %arrayidx29, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 256
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond44.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %mul10, float* %arrayidx12, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  ...
  store float %mul20, float* %arrayidx, align 4, !tbaa !2
  %exitcond.not = icmp eq i64 %indvars.iv.next, 31999
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond42.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %arrayidx14 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv
  %7 = load float, float* %arrayidx14, align 4, !tbaa !2
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %add19, float* %arrayidx, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx26 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  %4 = load float, float* %arrayidx26, align 4, !tbaa !2
  %mul29 = fmul float %2, %4
  %add30 = fadd float %add19, %mul29
  store float %add30, float* %arrayidx11, align 4, !tbaa !2
  %exitcond.not = icmp eq i64 %indvars.iv.next, 31999
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %add16, float* %arrayidx, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx23 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv.next
  %3 = load float, float* %arrayidx23, align 4, !tbaa !2
  %mul26 = fmul float %2, %3
  %add27 = fadd float %add16, %mul26
  store float %add27, float* %arrayidx23, align 4, !tbaa !2
  %exitcond.not = icmp eq i64 %indvars.iv.next, 31999
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %2 = load float, float* %arrayidx14, align 4, !tbaa !2
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond40.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %add12, float* %arrayidx, align 4, !tbaa !2
  %arrayidx16 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv
  %4 = load float, float* %arrayidx16, align 4, !tbaa !2
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %mul, float* %arrayidx7, align 4, !tbaa !2
  %arrayidx9 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  %1 = load float, float* %arrayidx9, align 4, !tbaa !2
  %arrayidx11 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv
  ...
  store float %add16, float* %arrayidx9, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond30.not, label %for.cond.cleanup, label %for.cond2.preheader
...
if.then:                                          ; preds = %for.body5
  ...
  store float %sub, float* %arrayidx, align 4, !tbaa !2
  br label %for.inc
...
for.cond2.preheader:                              ; preds = %entry, %for.cond.cleanup4
  %nl.027 = phi i32 [ 0, %entry ], [ %inc12, %for.cond.cleanup4 ]
  %x.0.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 31999), align 4, !tbaa !2
  br label %for.body5
...
for.body:                                         ; preds = %entry, %for.cond.cleanup4
  ...
  %0 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 31998), align 8, !tbaa !2
  %x.031.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 31999), align 4, !tbaa !2
  br label %for.body5
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond33.not, label %for.cond.cleanup, label %for.body
...
for.body5:                                        ; preds = %for.body, %for.body5
  ...
  %arrayidx8 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  store float %mul, float* %arrayidx8, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup8:                                ; preds = %for.body9
  ...
  br i1 %exitcond55.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.body9:                                        ; preds = %for.cond6.preheader, %for.body9
  ...
  %2 = load float, float* %arrayidx20, align 4, !tbaa !2
  %mul = fmul float %1, %2
...
for.cond6.preheader:                              ; preds = %for.cond2.preheader, %for.cond.cleanup8
  ...
  %.pre = load float, float* %arrayidx13, align 4, !tbaa !2
  br label %for.body9
...
for.cond.cleanup8:                                ; preds = %for.body9
  store float %sub14, float* %arrayidx16, align 4, !tbaa !2
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1
  %exitcond58.not = icmp eq i64 %indvars.iv.next56, 256
  br i1 %exitcond58.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.body9:                                        ; preds = %for.cond6.preheader, %for.body9
  ...
  %2 = load float, float* %arrayidx22, align 4, !tbaa !2
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %arrayidx13 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv
  %2 = load float, float* %arrayidx13, align 4, !tbaa !2
  ...
  store float %add, float* %arrayidx18, align 4, !tbaa !2
...
for.cond2.preheader:                              ; preds = %entry, %for.cond.cleanup4
  %nl.040 = phi i32 [ 0, %entry ], [ %inc21, %for.cond.cleanup4 ]
  %.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), align 64, !tbaa !2
  br label %for.body5
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %4 = load float, float* %arrayidx16, align 4, !tbaa !2
  %mul = fmul float %3, %4
  store float %mul, float* %arrayidx14, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
if.then:                                          ; preds = %for.body5
  ...
  %2 = load float, float* %arrayidx12, align 4, !tbaa !2
  %add = fadd float %2, %mul
  store float %add, float* %arrayidx12, align 4, !tbaa !2
  br label %for.inc
...
if.then:                                          ; preds = %for.body5
  ...
  %mul = fmul float %4, %5
  %arrayidx13 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  %6 = load float, float* %arrayidx13, align 4, !tbaa !2
  %add = fadd float %6, %mul
  store float %add, float* %arrayidx13, align 4, !tbaa !2
  %mul18 = fmul float %4, %4
  %arrayidx20 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  %7 = load float, float* %arrayidx20, align 4, !tbaa !2
  %add21 = fadd float %mul18, %7
  store float %add21, float* %arrayidx20, align 4, !tbaa !2
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body5
  ...
  %4 = load float, float* %arrayidx27, align 4, !tbaa !2
  %add28 = fadd float %mul25, %4
  store float %add28, float* %arrayidx27, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
if.then:                                          ; preds = %for.body5
  ...
  store float %add19, float* %arrayidx18, align 4, !tbaa !2
  br label %for.inc

if.else:                                          ; preds = %for.body5
  store float %mul, float* %arrayidx11, align 4, !tbaa !2
  br label %for.inc
...
for.body10:                                       ; preds = %for.body5, %for.body10
  ...
  store float %add, float* %arrayidx26, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 256
...
for.inc27:                                        ; preds = %for.body10, %for.body5
  ...
  br i1 %exitcond58.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup8:                                ; preds = %for.body9
  ...
  store float %add31, float* %arrayidx33, align 4, !tbaa !2
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %add11, float* %arrayidx10, align 4, !tbaa !2
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
L30:                                              ; preds = %if.end, %if.end11
  ...
  %4 = load float, float* %arrayidx23, align 4, !tbaa !2
  ...
  store float %add25, float* %arrayidx28, align 4, !tbaa !2
  br label %for.inc
...
if.end:                                           ; preds = %for.body5
  ...
  %.pre63 = load float, float* %arrayidx29.phi.trans.insert, align 4, !tbaa !2
  br label %L30
...
L20:                                              ; preds = %for.body5
  ...
  %6 = load float, float* %arrayidx21, align 4, !tbaa !2
  %mul22 = fmul float %5, %6
  %add23 = fsub float %mul22, %4
  store float %add23, float* %arrayidx16, align 4, !tbaa !2
  %arrayidx27.phi.trans.insert = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  %.pre = load float, float* %arrayidx27.phi.trans.insert, align 4, !tbaa !2
  br label %L30
...
L30:                                              ; preds = %L20, %if.end
  ...
  store float %add33, float* %arrayidx, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup4:                                ; preds = %L30
  ...
  br i1 %exitcond82.not, label %for.cond.cleanup, label %for.cond2.preheader
...
if.end.L30_crit_edge:                             ; preds = %if.end
  ...
  %.pre83 = load float, float* %arrayidx44.phi.trans.insert, align 4, !tbaa !2
  br label %L30

if.end21:                                         ; preds = %if.end
  %arrayidx25 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv
  %3 = load float, float* %arrayidx25, align 4, !tbaa !2
  %mul26 = fmul float %2, %3
...
L30:                                              ; preds = %if.end.L30_crit_edge, %L20, %if.end21
  ...
  store float %add48, float* %arrayidx, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup4:                                ; preds = %for.inc
  ...
  br i1 %exitcond39.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.cond.cleanup4:                                ; preds = %for.inc
  ...
  br i1 %exitcond91.not, label %for.cond.cleanup, label %for.cond2.preheader
...
if.then:                                          ; preds = %for.body5
  ...
  %5 = load float, float* %arrayidx12, align 4, !tbaa !2
  %mul = fmul float %4, %5
  %add = fadd float %3, %mul
  store float %add, float* %arrayidx, align 4, !tbaa !2
  ...
  store float %add22, float* %arrayidx21, align 4, !tbaa !2
  br label %for.inc

if.else:                                          ; preds = %for.body5
  %arrayidx26 = getelementptr inbounds [32000 x float], [32000 x float]* @e, i64 0, i64 %indvars.iv
  %7 = load float, float* %arrayidx26, align 4, !tbaa !2
  %mul29 = fmul float %7, %7
  %add30 = fadd float %3, %mul29
  store float %add30, float* %arrayidx7, align 4, !tbaa !2
...
if.then35:                                        ; preds = %if.else
  ...
  %8 = load float, float* %arrayidx39, align 4, !tbaa !2
  ...
  store float %add43, float* %arrayidx45, align 4, !tbaa !2
  br label %for.inc

if.else46:                                        ; preds = %if.else
  %arrayidx53 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv
  %9 = load float, float* %arrayidx53, align 4, !tbaa !2
  %add54 = fadd float %mul29, %9
  store float %add54, float* %arrayidx53, align 4, !tbaa !2
  br label %for.inc
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %arrayidx10 = getelementptr inbounds [32000 x float], [32000 x float]* @c, i64 0, i64 %indvars.iv
  %3 = load float, float* %arrayidx10, align 4, !tbaa !2
  %mul = fmul float %2, %3
  %add = fadd float %1, %mul
  %sub11 = fadd float %add, -1.000000e+00
  %arrayidx13 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  store float %sub11, float* %arrayidx13, align 4, !tbaa !2
  store float %add, float* %arrayidx8, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
...
for.cond2.preheader:                              ; preds = %entry, %for.cond.cleanup4
  ...
  %.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 31998), align 8, !tbaa !2
  br label %for.body5
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond35.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %arrayidx12 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  store float %mul, float* %arrayidx12, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond20.not, label %for.cond.cleanup, label %for.cond2.preheader

for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  %indvars.iv = phi i64 [ 0, %for.cond2.preheader ], [ %indvars.iv.next, %for.body5 ]
  %0 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !2
  %arrayidx = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  store float %0, float* %arrayidx, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %2 = load float, float* %arrayidx15, align 4, !tbaa !2
  %add = fadd float %2, %mul
  store float %add, float* %arrayidx15, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 256
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup8:                                ; preds = %for.body9
  ...
  store float 1.000000e+00, float* %arrayidx15, align 4, !tbaa !2
  %indvars.iv.next40 = add nuw nsw i64 %indvars.iv39, 1
  %exitcond41.not = icmp eq i64 %indvars.iv.next40, 256
  br i1 %exitcond41.not, label %for.cond.cleanup4, label %for.cond6.preheader

for.body9:                                        ; preds = %for.cond6.preheader, %for.body9
  %indvars.iv = phi i64 [ 0, %for.cond6.preheader ], [ %indvars.iv.next, %for.body9 ]
  %arrayidx11 = getelementptr inbounds [256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 %indvars.iv, i64 %indvars.iv39
  store float 0.000000e+00, float* %arrayidx11, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 256
  br i1 %exitcond.not, label %for.cond.cleanup8, label %for.body9
}
...
for.cond.cleanup8:                                ; preds = %for.body9
  ...
  br i1 %exitcond51.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.body9:                                        ; preds = %for.cond6.preheader, %for.body9
  ...
  %2 = load float, float* %arrayidx16, align 4, !tbaa !2
  %add = fadd float %1, %2
  ...
  store float %conv17, float* %arrayidx21, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 256
  br i1 %exitcond.not, label %for.cond.cleanup8, label %for.body9
}
...
for.body.i:                                       ; preds = %for.body.i.preheader, %for.body.i
  ...
  %0 = load float, float* %arrayidx.i, align 4, !tbaa !2
  %add.i = fadd float %s.06.i, %0
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 4
  br i1 %exitcond.not.i, label %for.body.i86, label %for.body.i
...
for.body.i86:                                     ; preds = %for.body.i, %for.body.i86
  ...
  %1 = load float, float* %arrayidx.i82, align 4, !tbaa !2
...
for.body.i78:                                     ; preds = %for.body.i78, %test.exit87
  ...
  %2 = load float, float* %arrayidx.i74, align 4, !tbaa !2
...
for.body.i70:                                     ; preds = %for.body.i70, %test.exit79
  ...
  %3 = load float, float* %arrayidx.i66, align 4, !tbaa !2
...
for.body.i62:                                     ; preds = %for.body.i62, %test.exit71
  ...
  %4 = load float, float* %arrayidx.i58, align 4, !tbaa !2
...
for.body.i54:                                     ; preds = %for.body.i54, %test.exit63
  ...
  %5 = load float, float* %arrayidx.i50, align 4, !tbaa !2
...
for.body.i46:                                     ; preds = %for.body.i46, %test.exit55
  ...
  %6 = load float, float* %arrayidx.i42, align 4, !tbaa !2
...
for.body.i38:                                     ; preds = %for.body.i38, %test.exit47
  ...
  %7 = load float, float* %arrayidx.i34, align 4, !tbaa !2
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond26.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.cond.cleanup4:                                ; preds = %for.body5.for.body5_crit_edge
  ...
  br i1 %exitcond27.not, label %for.cond.cleanup, label %for.body
...
for.body5.for.body5_crit_edge:                    ; preds = %for.body, %for.body5.for.body5_crit_edge
  ...
  %.pre = load float, float* %arrayidx.phi.trans.insert, align 4, !tbaa !2
  %cmp6 = fcmp ogt float %.pre, %x.229
  %x.2 = select i1 %cmp6, float %.pre, float %x.229
  %indvars.iv.next = add nuw nsw i64 %indvars.iv.next30, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5.for.body5_crit_edge
}
...
for.body:                                         ; preds = %entry, %for.body
  ...
  br i1 %exitcond58.not, label %for.body6, label %for.body
...
for.body6:                                        ; preds = %for.body, %for.cond.cleanup11
  ...
  %2 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !2
...
for.cond.cleanup11:                               ; preds = %for.body12.for.body12_crit_edge
  ...
  br i1 %exitcond54.not, label %for.cond.cleanup5, label %for.body6
...
for.body12.for.body12_crit_edge:                  ; preds = %for.body6, %for.body12.for.body12_crit_edge
  ...
  %.pre = load float, float* %arrayidx14.phi.trans.insert, align 4, !tbaa !2
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup11, label %for.body12.for.body12_crit_edge
}
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond22.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body:                                         ; preds = %entry, %for.cond.cleanup4
  ...
  %4 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 0), align 64, !tbaa !2
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond44.not, label %for.cond.cleanup, label %for.body
...
for.body:                                         ; preds = %entry, %for.cond.cleanup4
  ...
  %0 = load float, float* getelementptr inbounds ([256 x [256 x float]], [256 x [256 x float]]* @aa, i64 0, i64 0, i64 0), align 64, !tbaa !2
  br label %for.cond6.preheader
...
for.cond.cleanup4:                                ; preds = %for.cond.cleanup8
  ...
  br i1 %exitcond66.not, label %for.cond.cleanup, label %for.body

for.cond.cleanup8:                                ; preds = %for.body9
  %indvars.iv.next64 = add nuw nsw i64 %indvars.iv63, 1
  %exitcond65.not = icmp eq i64 %indvars.iv.next64, 256
  br i1 %exitcond65.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
for.cond2.preheader:                              ; preds = %entry, %for.cond.cleanup4
  ...
  %.pre = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @a, i64 0, i64 1), align 4, !tbaa !2
  br label %for.body5
...
for.inc:                                          ; preds = %for.body5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %L20, label %for.body5
...
L20:                                              ; preds = %for.inc, %L20.split.loop.exit38
  ...
  br i1 %exitcond37.not, label %cleanup14, label %for.cond2.preheader
...
if.then:                                          ; preds = %for.body5
  ...
  store float %0, float* %arrayidx10, align 4, !tbaa !2
  br label %for.inc
...
for.cond.cleanup8:                                ; preds = %for.inc
  ...
  br i1 %exitcond49.not, label %for.cond.cleanup4, label %for.cond6.preheader
...
if.then:                                          ; preds = %for.body9
  ...
  %1 = load float, float* %arrayidx16, align 4, !tbaa !2
  ...
  store float %1, float* %arrayidx18, align 4, !tbaa !2
  br label %for.inc
...
entry:
  ...
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  %0 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), align 64, !tbaa !2
  br label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %0 = load float, float* %B.026, align 4, !tbaa !2
  %1 = load float, float* %C.027, align 4, !tbaa !2
  %add = fadd float %0, %1
  store float %add, float* %A.025, align 4, !tbaa !2
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %4 = load float, float* %arrayidx13, align 4, !tbaa !2
  ...
  %7 = load float, float* %arrayidx21, align 4, !tbaa !2
  ...
  %9 = load float, float* %arrayidx26, align 4, !tbaa !2
  %arrayidx29 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %8
  %10 = load float, float* %arrayidx29, align 4, !tbaa !2
  ...
  %12 = load float, float* %arrayidx34, align 4, !tbaa !2
  %arrayidx37 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %11
  %13 = load float, float* %arrayidx37, align 4, !tbaa !2
...
entry:
  ...
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  %2 = load float, float* getelementptr inbounds ([32000 x float], [32000 x float]* @c, i64 0, i64 0), align 64, !tbaa !2
  br label %for.cond2.preheader
...
entry:
  ...
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  store float* getelementptr inbounds ([65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 0), float** @xx, align 8, !tbaa !19
  br label %for.body
...
for.body:                                         ; preds = %for.cond.cleanup4.for.body_crit_edge, %entry
  ...
  store float* %0, float** @yy, align 8, !tbaa !19
  br label %for.body5
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond27.not, label %for.cond.cleanup, label %for.cond.cleanup4.for.body_crit_edge

for.cond.cleanup4.for.body_crit_edge:             ; preds = %for.cond.cleanup4
  %.pre = load float*, float** @xx, align 8, !tbaa !19
  br label %for.body
...
entry:
  ...
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  store float* getelementptr inbounds ([32000 x float], [32000 x float]* @b, i64 0, i64 16000), float** @xx, align 8, !tbaa !19
  br label %for.cond2.preheader
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond26.not, label %for.cond.cleanup, label %for.cond.cleanup4.for.cond2.preheader_crit_edge
...
entry:
  ...
  %t1 = getelementptr inbounds %struct.args_t, %struct.args_t* %func_args, i64 0, i32 0
  %call1 = tail call i32 @gettimeofday(%struct.timeval* %t1, i8* null) #11
  store float* getelementptr inbounds ([65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 4), float** @xx, align 8, !tbaa !19
  br label %for.cond2.preheader
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond28.not, label %for.cond.cleanup, label %for.cond.cleanup4.for.cond2.preheader_crit_edge
...
entry:
  store float* getelementptr inbounds ([65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 64), float** @xx, align 8, !tbaa !19
...
for.cond2.preheader:                              ; preds = %entry, %for.cond.cleanup4
  %nl.027 = phi i32 [ 0, %entry ], [ %inc13, %for.cond.cleanup4 ]
  %0 = load float*, float** @xx, align 8, !tbaa !19
  br label %for.body5
...
entry:
  store float* getelementptr inbounds ([65536 x float], [65536 x float]* @flat_2d_array, i64 0, i64 63), float** @xx, align 8, !tbaa !19
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %1 = load float, float* %arrayidx7, align 4, !tbaa !2
  %add8 = fadd float %0, %1
  store float %add8, float* %arrayidx, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup4:                                ; preds = %for.inc
  ...
  br i1 %exitcond65.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %add20, float* %arrayidx, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup4:                                ; preds = %for.body5
  ...
  br i1 %exitcond33.not, label %for.cond.cleanup, label %for.cond2.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %5 = load i32, i32* %arrayidx11, align 4, !tbaa !15
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %mul = fmul float %3, %5
  %arrayidx9 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  %6 = load float, float* %arrayidx9, align 4, !tbaa !2
  %add = fadd float %6, %mul
  store float %add, float* %arrayidx9, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
...
for.body5:                                        ; preds = %for.body, %for.body5
  ...
  %arrayidx7 = getelementptr inbounds [32000 x float], [32000 x float]* @b, i64 0, i64 %indvars.iv
  %7 = load float, float* %arrayidx7, align 4, !tbaa !2
  ...
  %8 = load float, float* %arrayidx11, align 4, !tbaa !2
  %arrayidx13 = getelementptr inbounds [32000 x float], [32000 x float]* @d, i64 0, i64 %indvars.iv
  %9 = load float, float* %arrayidx13, align 4, !tbaa !2
  %mul = fmul float %8, %9
  %add14 = fadd float %7, %mul
  %arrayidx16 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  store float %add14, float* %arrayidx16, align 4, !tbaa !2
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %8 = load i32, i32* %arrayidx9, align 4, !tbaa !15
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %3 = load float, float* %arrayidx7, align 4, !tbaa !2
  %arrayidx9 = getelementptr inbounds [32000 x float], [32000 x float]* @a, i64 0, i64 %indvars.iv
  store float %3, float* %arrayidx9, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %2, float* %arrayidx9, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.cond.cleanup6:                                ; preds = %for.body7
  ...
  %inc12 = add nuw nsw i32 %nl.026, 1
  %exitcond27.not = icmp eq i32 %inc12, 100000
  br i1 %exitcond27.not, label %for.cond.cleanup, label %for.cond3.preheader
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %add10, float* %arrayidx9, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  %2 = load float, float* %arrayidx9, align 4, !tbaa !2
  %mul10 = fmul float %mul, %2
  store float %mul10, float* %arrayidx, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  ...
  store float %mul72, float* %arrayidx74, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 256
  br i1 %exitcond.not, label %for.cond.cleanup4, label %for.body5
}
...
entry:
  ...
  store i8* %arg_info, i8** %arg_info1, align 8, !tbaa !6
...
entry:
  ...
  store i32 1, i32* %n1, align 4, !tbaa !15
  ...
  store i32 1, i32* %a, align 4, !tbaa !11
  ...
  %5 = load i32, i32* %n1, align 4, !tbaa !15
  store i32 %5, i32* %a2, align 4, !tbaa !11
  %b3 = getelementptr inbounds %struct.anon.6, %struct.anon.6* %.compoundliteral1, i64 0, i32 1
  store i32 1, i32* %b3, align 4, !tbaa !14
  ...
  store i32 16000, i32* %a5, align 4, !tbaa !34
  ...
  %8 = load float, float* %s1, align 4, !tbaa !2
  store float %8, float* %a7, align 4, !tbaa !16
  %b8 = getelementptr inbounds %struct.anon.8, %struct.anon.8* %.compoundliteral6, i64 0, i32 1
  %9 = load float, float* %s2, align 4, !tbaa !2
  store float %9, float* %b8, align 4, !tbaa !18
  ...
  %13 = load i8*, i8** %11, align 8, !tbaa !19
  ...
  %14 = load i32*, i32** %ip, align 8, !tbaa !19
  store i32* %14, i32** %a10, align 8, !tbaa !20
  %b11 = getelementptr inbounds %struct.anon.9, %struct.anon.9* %.compoundliteral9, i64 0, i32 1
  %15 = load float, float* %s1, align 4, !tbaa !2
  store float %15, float* %b11, align 8, !tbaa !22
  ...
  %17 = load i8*, i8** %11, align 8, !tbaa !19
  ...
  %18 = load i32*, i32** %ip, align 8, !tbaa !19
  store i32* %18, i32** %a13, align 8, !tbaa !23
  %b14 = getelementptr inbounds %struct.anon.10, %struct.anon.10* %.compoundliteral12, i64 0, i32 1
  %19 = load i32, i32* %n1, align 4, !tbaa !15
  store i32 %19, i32* %b14, align 8, !tbaa !25
  ...
  %21 = load i8*, i8** %11, align 8, !tbaa !19
  ...
  %22 = load i32*, i32** %ip, align 8, !tbaa !19
  store i32* %22, i32** %a16, align 8, !tbaa !26
  %b17 = getelementptr inbounds %struct.anon.11, %struct.anon.11* %.compoundliteral15, i64 0, i32 1
  store i32 128, i32* %b17, align 8, !tbaa !28
  %c = getelementptr inbounds %struct.anon.11, %struct.anon.11* %.compoundliteral15, i64 0, i32 2
  %23 = load i32, i32* %n1, align 4, !tbaa !15
  store i32 %23, i32* %c, align 4, !tbaa !29
  ...
  %25 = load i8*, i8** %11, align 8, !tbaa !19
  call void @time_function(float (%struct.args_t*)* nonnull @vag, i8* %25) #14
  %26 = load i8*, i8** %11, align 8, !tbaa !19
...
!5 = !{!"Simple C/C++ TBAA"}
!6 = !{!7, !10, i64 32}
!7 = !{!"args_t", !8, i64 0, !8, i64 16, !10, i64 32}
...
!22 = !{!21, !3, i64 8}
!23 = !{!24, !10, i64 0}
!24 = !{!"", !10, i64 0, !13, i64 8}
!25 = !{!24, !13, i64 8}
!26 = !{!27, !10, i64 0}
!27 = !{!"", !10, i64 0, !13, i64 8, !13, i64 12}
!28 = !{!27, !13, i64 8}
!29 = !{!27, !13, i64 12}
!30 = !{!7, !9, i64 0}
!31 = !{!7, !9, i64 8}
