...
rolled.reg.bb:                                    ; preds = %rolled.reg.loop
  ...
  %5 = getelementptr i32, i32* %B, i64 %2
  %6 = load i32, i32* %5, align 4
  %7 = icmp sgt i32 %6, 0
  br i1 %7, label %rolled.reg.bb1, label %rolled.reg.bb2

rolled.reg.bb1:                                   ; preds = %rolled.reg.bb
  %8 = tail call i32 @foo(i32 %6) #2
  br label %rolled.reg.bb2

rolled.reg.bb2:                                   ; preds = %rolled.reg.bb1, %rolled.reg.bb
  %9 = phi i32 [ %8, %rolled.reg.bb1 ], [ %4, %rolled.reg.bb ]
  %10 = getelementptr i32, i32* %0, i8 %1
  store i32 %9, i32* %10, align 4
  tail call void @dummy(i32 %9) #2
