; ModuleID = 'region-23.c.ll'
source_filename = "region-23.c"
...
declare dso_local void @before(...) local_unnamed_addr #1

; Function Attrs: optsize
declare dso_local void @after(...) local_unnamed_addr #1
